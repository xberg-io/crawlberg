...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/crawlberg/releases/download/v1.0.5/Crawlberg-rs.artifactbundle.zip",
      checksum: "706fbbba46d7f741cd1b8444402354f717efabb44a7d6a131ccfe5b362120dc6"
    ),
