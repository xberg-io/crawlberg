...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/crawlberg/releases/download/v1.1.1/Crawlberg-rs.artifactbundle.zip",
      checksum: "255b21a6f795d17cde874dc6bc3d68c48bae298c8492290a16cc67d3ebf47598"
    ),
