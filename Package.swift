...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/crawlberg/releases/download/v1.7.2/Crawlberg-rs.artifactbundle.zip",
      checksum: "af002a4836dd8c05c84f1ed7ac09adf37efe0f5cab744b1daa843e8e58212a68"
    ),
