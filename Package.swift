...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/crawlberg/releases/download/v1.0.10/Crawlberg-rs.artifactbundle.zip",
      checksum: "d3006458a1f0f28b58aa7290c7325de09749d8acbb0bfc82e8e871fc914e1328"
    ),
