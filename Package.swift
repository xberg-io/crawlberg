...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/crawlberg/releases/download/v1.4.0/Crawlberg-rs.artifactbundle.zip",
      checksum: "8f96a60e4149e0d4c09cdc21f6d834ceeb2bc17d6054cdec04dc3275db6f63e1"
    ),
