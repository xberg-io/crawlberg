...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/crawlberg/releases/download/v1.1.4/Crawlberg-rs.artifactbundle.zip",
      checksum: "d636bcfc8c24d40d4a0af4a4e6687236372a1327e53483ba1164b097b805a1e4"
    ),
