...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/crawlberg/releases/download/v1.0.6/Crawlberg-rs.artifactbundle.zip",
      checksum: "6478d8f905f07f8f3ba5a6b81dea2d987b4a0638fa974eff77502013aae67c15"
    ),
