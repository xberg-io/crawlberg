...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/crawlberg/releases/download/v1.0.3/Crawlberg-rs.artifactbundle.zip",
      checksum: "52e10aa18c45cf40e0ec899464abc6777b177a408711ee39d7105a110469fe1c"
    ),
