...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/crawlberg/releases/download/v1.2.1/Crawlberg-rs.artifactbundle.zip",
      checksum: "209a42244fe44dce8e879b302df48584aa649a4afff82eb409c171a5dd0337e5"
    ),
