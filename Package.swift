...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/crawlberg/releases/download/v1.6.1/Crawlberg-rs.artifactbundle.zip",
      checksum: "a012c3f47dc34907b89c102e14cd8767386646645994dd0f9d630884bd304b88"
    ),
