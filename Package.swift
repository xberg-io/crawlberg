...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/crawlberg/releases/download/v1.6.4/Crawlberg-rs.artifactbundle.zip",
      checksum: "273d6bac43bdf7f6bef4eb02727b876ebf218b861b83c7942bb0630ca2a46aba"
    ),
