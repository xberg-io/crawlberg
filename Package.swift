...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/crawlberg/releases/download/v1.1.0/Crawlberg-rs.artifactbundle.zip",
      checksum: "c66aab6caa26515b941c163cbcd0f231ee53636311b07a506db7aa63c419b239"
    ),
