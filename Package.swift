...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/crawlberg/releases/download/v1.2.0/Crawlberg-rs.artifactbundle.zip",
      checksum: "67d4db04df3d9193c4d77d1a7f5c43c5b9faadfa7474e70351bb84f7bacb17db"
    ),
