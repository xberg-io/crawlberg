...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/crawlberg/releases/download/v1.0.7/Crawlberg-rs.artifactbundle.zip",
      checksum: "5e217eb83f4a4e41cdb86a042d2532cb9a0a4f7d9c1098c2305e308524b65dc7"
    ),
