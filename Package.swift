...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/crawlberg/releases/download/v1.6.3/Crawlberg-rs.artifactbundle.zip",
      checksum: "f149b83510470c5467f6479eeca109af4b3d9f527f7bd3030603e3c13ef4b3fe"
    ),
