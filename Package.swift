...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/crawlberg/releases/download/v1.5.0/Crawlberg-rs.artifactbundle.zip",
      checksum: "b4595f6bce3bf785dea88d2ec0bb4e6d84284a57b2833cfb182d75465fb28eca"
    ),
