...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/crawlberg/releases/download/v1.7.1/Crawlberg-rs.artifactbundle.zip",
      checksum: "41f2ea71d3a425aef40b64bc5aaf9fd90004582d2652c530427a27166fec45e9"
    ),
