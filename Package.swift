...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/crawlberg/releases/download/v1.3.3/Crawlberg-rs.artifactbundle.zip",
      checksum: "37ed6f489e2bc8e4fba03f76a175c14a0ad652f92209b6bc41ee479b251fe0f9"
    ),
