...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/crawlberg/releases/download/v1.0.4/Crawlberg-rs.artifactbundle.zip",
      checksum: "b5b8744c6970f14b47591925a5142aa6d3c22098856d0a1ec24f7c2026254844"
    ),
