...
<!-- alef:hash:d64b5cd16973dd8b7a0f0c5d56dae68657de097890f3948a9292566cc83cbdb7 -->
...
```dart
static SsrfPolicy default()
```

**Example:**

```dart
final result = SsrfPolicy.default();
```
...
```dart
static SsrfPolicy fromEnv()
```

**Example:**

```dart
final result = SsrfPolicy.fromEnv();
```
