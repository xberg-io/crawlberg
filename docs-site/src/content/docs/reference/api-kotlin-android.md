...
<!-- alef:hash:d86ea7fa6d1a6aa2550d52d4db1acafc0f4d3b45792d7fe69a9285153f830994 -->
<!-- To regenerate: alef docs -->
<!-- To verify freshness: alef verify -->

## Kotlin (Android) API Reference <span class="version-badge">v1.8.0</span>
...
| `retryCodes` | `List<Short>` | `[]` | HTTP status codes that should trigger a retry. When empty, every rate limit, server error, bad gateway and timeout is retried. When set, only a failure whose status is listed is retried, so a timeout without a response is not. |
