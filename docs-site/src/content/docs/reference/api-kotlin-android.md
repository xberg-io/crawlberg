...
## Kotlin (Android) API Reference <span class="version-badge">v1.2.1</span>
...
```kotlin
@JvmStatic
fun default(): SsrfPolicy
```

**Example:**

```kotlin
val result = SsrfPolicy.default()
```
...
```kotlin
@JvmStatic
fun fromEnv(): SsrfPolicy
```

**Example:**

```kotlin
val result = SsrfPolicy.fromEnv()
```
