  ...
  integrations : [
    starlight(
        xbergStarlightConfig({
          ...
          editBaseUrl :
              "https://github.com/xberg-io/crawlberg/edit/main/docs-site/",
          plugins : [
            starlightLlmsTxt({
              customSets : [
                ...
                {
                  label : "Guides",
                  paths : [ "guides/**", "cli/**", "antibot", "observability" ],
                },
                ...
                {label : "Reference", paths : [ "reference/**" ]},
                {
                  label : "More",
                  paths :
                      [ "features", "contributing", "changelog", "ecosystem" ],
                },
              ],
              optionalLinks : [
                {
              ...
              items : [
                ...
                },
                {
                  ...
                  items : [
                    ...
                    {
                      label : "Streaming Crawls",
                      slug : "guides/streaming-crawl",
                    },
                  ],
                },
                {
            ...
            },
            {
              ...
              items : [
                {label : "Architecture", slug : "concepts/architecture"},
                {
                  ...
                  slug : "concepts/content-extraction",
                },
