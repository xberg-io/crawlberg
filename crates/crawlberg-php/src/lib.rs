...
// alef:hash:c6f799a2d3a34ffac39e34f2dfacdc69e4428e89626675765aec8f0a07a1610e
...
pub struct BrowserConfig {
    ...
    #[php(prop, name = "chromePath")]
    #[serde(alias = "chromePath")]
    ...
    /// shared browser pool.
    #[php(prop, name = "chromeArgs")]
    #[serde(alias = "chromeArgs")]
...
impl BrowserConfig {
    ...
    pub fn get_chrome_path(&self) -> Option<String> {
...
impl From<BrowserConfig> for crawlberg::BrowserConfig {
    ...
    .expect("failed to throw PHP exception for invalid enum string value");
            ...
            chrome_path: val.chrome_path.map(Into::into),
