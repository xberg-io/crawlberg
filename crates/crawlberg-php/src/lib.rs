...
// alef:hash:41b746e5ce438eba992b25686630dde99bcc3d4d27bb550f2e1aae53e58cabcc
...
pub struct BrowserConfig {
    ...
    /// exit.
    #[php(prop, name = "overallTimeout")]
    #[serde(skip_serializing_if = "Option::is_none")]
    #[serde(alias = "overallTimeout")]
...
impl BrowserConfig {
    ...
    pub fn new(
        ...
        timeout: Option<i64>,
        overallTimeout: Option<i64>,
        shutdownTimeout: Option<i64>,
    ...
    pub fn get_overall_timeout(&self) -> Option<i64> {
        self.overall_timeout.clone()
    }

    pub fn get_shutdown_timeout(&self) -> Option<i64> {
...
pub struct ContentConfig {
    ...
    #[serde(default = "crate::serde_defaults::content_config_extract_metadata")]
...
pub struct CrawlConfig {
    ...
    #[php(prop, name = "pathPatternsMatchQuery")]
    #[serde(default = "crate::serde_defaults::crawl_config_path_patterns_match_query")]
    #[serde(alias = "pathPatternsMatchQuery")]
    ...
    #[php(prop, name = "pathPatternsMatchUrl")]
    #[serde(default = "crate::serde_defaults::crawl_config_path_patterns_match_url")]
    #[serde(alias = "pathPatternsMatchUrl")]
    ...
    #[php(prop, name = "dedupIncludeQuery")]
    #[serde(default = "crate::serde_defaults::crawl_config_dedup_include_query")]
    #[serde(alias = "dedupIncludeQuery")]
    ...
    #[php(prop, name = "stripTrackingParams")]
    #[serde(default = "crate::serde_defaults::crawl_config_strip_tracking_params")]
    #[serde(alias = "stripTrackingParams")]
    ...
    /// enabled.
    #[php(prop, name = "trackingParams")]
    #[serde(alias = "trackingParams")]
    ...
    #[php(prop, name = "retryInitialDelayMs")]
    #[serde(default = "crate::serde_defaults::crawl_config_retry_initial_delay_ms")]
    #[serde(alias = "retryInitialDelayMs")]
    pub retry_initial_delay_ms: i64,
    /// Upper bound, in milliseconds, on the exponential retry backoff. Defaults to 60s.
    #[php(prop, name = "retryMaxDelayMs")]
    #[serde(default = "crate::serde_defaults::crawl_config_retry_max_delay_ms")]
    #[serde(alias = "retryMaxDelayMs")]
    ...
    #[php(prop, name = "rateLimitJitterRatio")]
    #[serde(default = "crate::serde_defaults::crawl_config_rate_limit_jitter_ratio")]
    #[serde(alias = "rateLimitJitterRatio")]
...
impl CrawlConfig {
    ...
    pub fn new(
        ...
        pathPatternsMatchQuery: bool,
        pathPatternsMatchUrl: bool,
        dedupIncludeQuery: bool,
        stripTrackingParams: bool,
        trackingParams: Vec<String>,
        customHeaders: HashMap<String, String>,
        maxRedirects: i64,
        retryCount: i64,
        retryCodes: Vec<u16>,
        retryInitialDelayMs: i64,
        retryMaxDelayMs: i64,
        rateLimitJitterRatio: f64,
        cookiesEnabled: bool,
        ...
        Self {
            ...
            path_patterns_match_query: pathPatternsMatchQuery,
            path_patterns_match_url: pathPatternsMatchUrl,
            dedup_include_query: dedupIncludeQuery,
            ...
            retry_initial_delay_ms: retryInitialDelayMs,
            retry_max_delay_ms: retryMaxDelayMs,
            rate_limit_jitter_ratio: rateLimitJitterRatio,
    ...
    pub fn get_path_patterns_match_query(&self) -> bool {
        self.path_patterns_match_query.clone()
    }

    pub fn get_path_patterns_match_url(&self) -> bool {
        self.path_patterns_match_url.clone()
    }

    pub fn get_dedup_include_query(&self) -> bool {
        self.dedup_include_query.clone()
    }

    pub fn get_strip_tracking_params(&self) -> bool {
        self.strip_tracking_params.clone()
    }
    ...
    pub fn get_retry_initial_delay_ms(&self) -> i64 {
        self.retry_initial_delay_ms.clone()
    }

    pub fn get_retry_max_delay_ms(&self) -> i64 {
        self.retry_max_delay_ms.clone()
    }

    pub fn get_rate_limit_jitter_ratio(&self) -> f64 {
        self.rate_limit_jitter_ratio.clone()
    }
    ...
    ,
                ...
                path_patterns_match_query: self.path_patterns_match_query,
                path_patterns_match_url: self.path_patterns_match_url,
                dedup_include_query: self.dedup_include_query,
                ...
                retry_initial_delay_ms: self.retry_initial_delay_ms as u64,
                retry_max_delay_ms: self.retry_max_delay_ms as u64,
                rate_limit_jitter_ratio: self.rate_limit_jitter_ratio,
...
impl From<BrowserConfig> for crawlberg::BrowserConfig {
    ...
    .expect("failed to throw PHP exception for invalid enum string value");
            ...
            overall_timeout: val
                .overall_timeout
                .map(|v| std::time::Duration::from_millis(v as u64))
                .unwrap_or_else(|| crawlberg::BrowserConfig::default().overall_timeout),
            shutdown_timeout: val
                .shutdown_timeout
                .map(|v| std::time::Duration::from_millis(v as u64))
                .unwrap_or_else(|| crawlberg::BrowserConfig::default().shutdown_timeout),
...
impl From<crawlberg::BrowserConfig> for BrowserConfig {
    fn from(val: crawlberg::BrowserConfig) -> Self {
        Self {
            ...
            overall_timeout: Some(val.overall_timeout.as_millis() as u64 as i64),
            shutdown_timeout: Some(val.shutdown_timeout.as_millis() as u64 as i64),
...
,
            ...
            retry_initial_delay_ms: val.retry_initial_delay_ms as u64,
            retry_max_delay_ms: val.retry_max_delay_ms as u64,
...
impl From<crawlberg::CrawlConfig> for CrawlConfig {
    fn from(val: crawlberg::CrawlConfig) -> Self {
        Self {
            ...
            retry_codes: val.retry_codes.into_iter().collect(),
            retry_initial_delay_ms: val.retry_initial_delay_ms as i64,
            retry_max_delay_ms: val.retry_max_delay_ms as i64,
            rate_limit_jitter_ratio: val.rate_limit_jitter_ratio,
            cookies_enabled: val.cookies_enabled,
            auth: val.auth.map(Into::into),
...
mod serde_defaults {
    ...
    pub fn content_config_extract_metadata() -> bool {
        true
    }
    ...
    pub fn crawl_config_path_patterns_match_query() -> bool {
        false
    }
    pub fn crawl_config_path_patterns_match_url() -> bool {
        false
    }
    pub fn crawl_config_dedup_include_query() -> bool {
        false
    }
    pub fn crawl_config_strip_tracking_params() -> bool {
        false
    }
    ...
    pub fn crawl_config_retry_initial_delay_ms() -> i64 {
        100
    }
    pub fn crawl_config_retry_max_delay_ms() -> i64 {
        60000
    }
    pub fn crawl_config_rate_limit_jitter_ratio() -> f64 {
        0.0
    }
...
pub extern "C" fn get_module() -> *mut ::ext_php_rs::zend::ModuleEntry {
    ...
    __EXT_PHP_RS_MODULE_ENTRY.get_or_init(|| {
        let builder = ::ext_php_rs::builders::ModuleBuilder::new("crawlberg", "1.8.0")
