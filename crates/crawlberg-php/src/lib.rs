...
// alef:hash:cdf514090cafa8485854166543a4768402ed444f00ba02eceb660bbbaa0dcb7b
...
impl CrawlConfig {
    ...
    pub fn validate(&self) -> PhpResult<()> {
        ...
        let core_self = crawlberg::CrawlConfig {
            ...
            crawl_strategy: match self.crawl_strategy.as_str() {
                "bfs" => crawlberg::CrawlStrategyKind::Bfs,
                "dfs" => crawlberg::CrawlStrategyKind::Dfs,
                "best_first" => crawlberg::CrawlStrategyKind::BestFirst,
                "adaptive" => crawlberg::CrawlStrategyKind::Adaptive,
                _ => Default::default(),
            },
            content_filter: self.content_filter.as_deref().map(|s| match s {
                "bm25" => crawlberg::ContentFilterKind::Bm25,
                _ => crawlberg::ContentFilterKind::Bm25,
            }),
            ...
            document_content_encoding: self.document_content_encoding.as_deref().map(|s| match s {
                "base64" => crawlberg::DocumentContentEncoding::Base64,
                _ => crawlberg::DocumentContentEncoding::Base64,
            }),
...
impl CrawlEvent {
    ...
    pub fn _factory_error(url: String, error: String) -> Self {
        crawlberg::CrawlEvent::Error { url: url, error: error }.into()
    }
...
impl HostMatcher {
    ...
    pub fn _factory_exact(value: String) -> Self {
        crawlberg::HostMatcher::Exact { value: value }.into()
    }

    #[php(name = "suffix")]
    pub fn _factory_suffix(value: String) -> Self {
        crawlberg::HostMatcher::Suffix { value: value }.into()
    }

    #[php(name = "cidr")]
    pub fn _factory_cidr(value: String) -> Self {
        crawlberg::HostMatcher::Cidr { value: value }.into()
    }
...
impl PageAction {
    ...
    pub fn _factory_click(selector: String) -> Self {
        crawlberg::PageAction::Click { selector: selector }.into()
    }

    #[php(name = "typeText")]
    pub fn _factory_type_text(selector: String, text: String) -> Self {
        crawlberg::PageAction::TypeText {
            selector: selector,
            text: text,
        }
        .into()
    ...
    pub fn _factory_press(key: String) -> Self {
        crawlberg::PageAction::Press { key: key }.into()
    }
    ...
    pub fn _factory_execute_js(script: String) -> Self {
        crawlberg::PageAction::ExecuteJs { script: script }.into()
    }
...
impl From<CrawlConfig> for crawlberg::CrawlConfig {
    fn from(val: CrawlConfig) -> Self {
        Self {
            ...
            crawl_strategy: match val.crawl_strategy.as_str() {
                "bfs" => crawlberg::CrawlStrategyKind::Bfs,
                "dfs" => crawlberg::CrawlStrategyKind::Dfs,
                "best_first" => crawlberg::CrawlStrategyKind::BestFirst,
                "adaptive" => crawlberg::CrawlStrategyKind::Adaptive,
            ...
            content_filter: val.content_filter.as_deref().map(|s| match s {
                "bm25" => crawlberg::ContentFilterKind::Bm25,
                _ => crawlberg::ContentFilterKind::Bm25,
            }),
            ...
            document_content_encoding: val.document_content_encoding.as_deref().map(|s| match s {
                "base64" => crawlberg::DocumentContentEncoding::Base64,
                _ => crawlberg::DocumentContentEncoding::Base64,
            }),
...
pub extern "C" fn get_module() -> *mut ::ext_php_rs::zend::ModuleEntry {
    ...
    __EXT_PHP_RS_MODULE_ENTRY.get_or_init(|| {
        let builder = ::ext_php_rs::builders::ModuleBuilder::new("crawlberg", "1.4.0")
