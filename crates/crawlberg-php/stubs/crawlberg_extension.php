...
// alef:hash:fb12b5e4d6f5db50a7c04d1aa64fea4f9ce4672171b040f4a343ff10f1dfdab5
...
namespace Crawlberg {
    ...
    final class CrawlConfig
    {
        public function __construct(
             ...
             * @var bool
             */
            public readonly bool $pathPatternsMatchUrl,
            /**
        ...
        public function getPathPatternsMatchUrl(): bool
        {
            throw new \RuntimeException('Not implemented — provided by the native extension.');
        }
    ...
    final class ScrapeResult
    {
        public function __construct(
            ...
            /** @var ?string The X-Robots-Tag header values, joined with `, ` when the response sent more than one. */
