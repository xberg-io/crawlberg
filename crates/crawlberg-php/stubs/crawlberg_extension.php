...
// alef:hash:253a2217c79a7b9b5b823ea9d5408cea6119db2ca5e54f1108cac28246200da4
...
namespace Crawlberg {
    ...
    final class BrowserConfig
    {
        public function __construct(
             ...
             * @var ?int
             */
            public readonly ?int $overallTimeout = null,
            /**
    ...
    {
        public function __construct(array $networkEvents, array $cookies, ?string $evalResult = null) {}
    ...
    final class CrawlConfig
    {
        public function __construct(
             ...
             * @var bool
             */
            public readonly bool $pathPatternsMatchQuery,
            /**
             ...
             * @var bool
             */
            public readonly bool $dedupIncludeQuery,
            /**
             ...
             * @var bool
             */
            public readonly bool $stripTrackingParams,
            /**
            ...
            /** @var int Number of retry attempts for failed requests. Bounded by [`MAX_RETRY_COUNT`]. */
             ...
             * @var int
             */
            public readonly int $retryInitialDelayMs,
            /** @var int Upper bound, in milliseconds, on the exponential retry backoff. Defaults to 60s. */
             ...
             * @var float
             */
            public readonly float $rateLimitJitterRatio,
        ...
        public function getPathPatternsMatchQuery(): bool
        {
            throw new \RuntimeException('Not implemented — provided by the native extension.');
        }

        public function getDedupIncludeQuery(): bool
        {
            throw new \RuntimeException('Not implemented — provided by the native extension.');
        }

        public function getStripTrackingParams(): bool
        {
            throw new \RuntimeException('Not implemented — provided by the native extension.');
        }
        ...
        public function getRetryInitialDelayMs(): int
        {
            throw new \RuntimeException('Not implemented — provided by the native extension.');
        }
        ...
        public function getRateLimitJitterRatio(): float
        {
            throw new \RuntimeException('Not implemented — provided by the native extension.');
        }
    ...
    final class CrawlPageResult
    {
        public function __construct(
            ...
            /** @var int Redirect hops taken to reach `final_url` from `url`. */
