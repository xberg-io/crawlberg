...
// alef:hash:f81f711d94f1a3eaa33e028665db15eb5b08a47d297f878301e6df8452f3a868
...
impl WasmSsrfPolicy {
    #[allow(non_snake_case)]
    #[wasm_bindgen(constructor)]
    pub fn new(denyPrivate: Option<bool>, allowlist: Option<JsValue>, maxRedirects: Option<u8>) -> WasmSsrfPolicy {
        WasmSsrfPolicy {
