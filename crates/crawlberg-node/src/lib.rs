...
// alef:hash:60ef27b652944171d2eb3a91e4112790bb62824e497edc488f537365a6188b5d
...
pub struct JsBrowserConfig {
    ...
    /// shared browser pool.
    #[napi(js_name = "chromeArgs")]
    pub chrome_args: Option<Vec<String>>,
}
impl<'de> serde::Deserialize<'de> for JsBrowserConfig {
...
impl<'de> serde::Deserialize<'de> for JsBrowserExtras {
    fn deserialize<D>(deserializer: D) -> ::core::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
...
impl<'de> serde::Deserialize<'de> for JsContentConfig {
    fn deserialize<D>(deserializer: D) -> ::core::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
...
pub struct JsCrawlConfig {
    ...
    #[napi(js_name = "pathPatternsMatchQuery")]
    ...
    #[napi(js_name = "dedupIncludeQuery")]
    ...
    #[napi(js_name = "stripTrackingParams")]
    ...
    #[napi(js_name = "rateLimitJitterRatio")]
...
impl<'de> serde::Deserialize<'de> for JsCrawlPageResult {
    fn deserialize<D>(deserializer: D) -> ::core::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        <crawlberg::CrawlPageResult as serde::Deserialize>::deserialize(deserializer).map(Into::into)
    }
}
...
impl<'de> serde::Deserialize<'de> for JsDownloadedDocument {
    fn deserialize<D>(deserializer: D) -> ::core::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
...
impl<'de> serde::Deserialize<'de> for JsSsrfPolicy {
    fn deserialize<D>(deserializer: D) -> ::core::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
...
impl From<JsBrowserConfig> for crawlberg::BrowserConfig {
    fn from(val: JsBrowserConfig) -> Self {
        ...
        if let Some(__v) = val.overall_timeout {
            __result.overall_timeout = std::time::Duration::from_millis(__v as u64);
        }
        if let Some(__v) = val.shutdown_timeout {
            __result.shutdown_timeout = std::time::Duration::from_millis(__v as u64);
        }
        ...
        if let Some(__v) = val.chrome_args {
            __result.chrome_args = __v.into_iter().collect();
        }
        __result
    }
}
...
impl From<crawlberg::BrowserConfig> for JsBrowserConfig {
    fn from(val: crawlberg::BrowserConfig) -> Self {
        Self {
            ...
            chrome_args: Some(val.chrome_args.into_iter().collect()),
        }
    }
}
...
impl From<JsCrawlConfig> for crawlberg::CrawlConfig {
    fn from(val: JsCrawlConfig) -> Self {
        ...
        if let Some(__v) = val.path_patterns_match_query {
            __result.path_patterns_match_query = __v;
        }
        if let Some(__v) = val.dedup_include_query {
            __result.dedup_include_query = __v;
        }
        if let Some(__v) = val.strip_tracking_params {
            __result.strip_tracking_params = __v;
        }
        if let Some(__v) = val.tracking_params {
            __result.tracking_params = __v.into_iter().collect();
        }
        ...
        if let Some(__v) = val.retry_initial_delay_ms {
            __result.retry_initial_delay_ms = __v as u64;
        }
        if let Some(__v) = val.retry_max_delay_ms {
            __result.retry_max_delay_ms = __v as u64;
        }
        if let Some(__v) = val.rate_limit_jitter_ratio {
            __result.rate_limit_jitter_ratio = __v;
        }
...
impl From<crawlberg::CrawlConfig> for JsCrawlConfig {
    fn from(val: crawlberg::CrawlConfig) -> Self {
        Self {
            ...
            path_patterns_match_query: Some(val.path_patterns_match_query),
            dedup_include_query: Some(val.dedup_include_query),
            strip_tracking_params: Some(val.strip_tracking_params),
            tracking_params: Some(val.tracking_params.into_iter().collect()),
            custom_headers: Some(
                val.custom_headers
                    .into_iter()
            ...
            retry_initial_delay_ms: Some(val.retry_initial_delay_ms as i64),
            retry_max_delay_ms: Some(val.retry_max_delay_ms as i64),
            rate_limit_jitter_ratio: Some(val.rate_limit_jitter_ratio),
