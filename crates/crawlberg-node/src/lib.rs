...
// alef:hash:a2f41f625210b2bbcc38322da451840fd6dc877497784451db3efcf6d1675e28
...
pub struct JsCrawlConfig {
    ...
    #[napi(js_name = "pathPatternsMatchUrl")]
...
impl From<JsCrawlConfig> for crawlberg::CrawlConfig {
    fn from(val: JsCrawlConfig) -> Self {
        ...
        if let Some(__v) = val.path_patterns_match_url {
            __result.path_patterns_match_url = __v;
        }
...
impl From<crawlberg::CrawlConfig> for JsCrawlConfig {
    fn from(val: crawlberg::CrawlConfig) -> Self {
        Self {
            ...
            path_patterns_match_url: Some(val.path_patterns_match_url),
