...
pub struct JsCrawlConfig {
    ...
    #[napi(js_name = "documentContentEncoding")]
...
fn crawl_error_to_napi_err(e: crawlberg::CrawlError) -> napi::Error {
    ...
    match &e {
        ...
        crawlberg::CrawlError::Gone(..) => napi::Error::new(napi::Status::GenericFailure, format!("[Gone] {}", msg)),
        crawlberg::CrawlError::Connection(..) => {
            napi::Error::new(napi::Status::GenericFailure, format!("[Connection] {}", msg))
        }
        crawlberg::CrawlError::Dns(..) => napi::Error::new(napi::Status::GenericFailure, format!("[Dns] {}", msg)),
        crawlberg::CrawlError::Ssl(..) => napi::Error::new(napi::Status::GenericFailure, format!("[Ssl] {}", msg)),
        ...
        crawlberg::CrawlError::SsrfPolicyViolation { .. } => {
            napi::Error::new(napi::Status::GenericFailure, format!("[SsrfPolicyViolation] {}", msg))
        }
        crawlberg::CrawlError::Other(..) => napi::Error::new(napi::Status::GenericFailure, format!("[Other] {}", msg)),
...
fn ssrf_error_to_napi_err(e: crawlberg::SsrfError) -> napi::Error {
    ...
    match &e {
        crawlberg::SsrfError::DeniedByPolicy { .. } => {
            napi::Error::new(napi::Status::GenericFailure, format!("[DeniedByPolicy] {}", msg))
        }
        crawlberg::SsrfError::NotOnAllowlist => {
            napi::Error::new(napi::Status::GenericFailure, format!("[NotOnAllowlist] {}", msg))
        }
        crawlberg::SsrfError::InvalidCidr(..) => {
            napi::Error::new(napi::Status::GenericFailure, format!("[InvalidCidr] {}", msg))
        }
        crawlberg::SsrfError::DnsResolutionFailed(..) => {
            napi::Error::new(napi::Status::GenericFailure, format!("[DnsResolutionFailed] {}", msg))
        }
        crawlberg::SsrfError::InvalidUrl(..) => {
            napi::Error::new(napi::Status::GenericFailure, format!("[InvalidUrl] {}", msg))
        }
        crawlberg::SsrfError::DisallowedScheme(..) => {
            napi::Error::new(napi::Status::GenericFailure, format!("[DisallowedScheme] {}", msg))
        }
        crawlberg::SsrfError::TooManyRedirects => {
            napi::Error::new(napi::Status::GenericFailure, format!("[TooManyRedirects] {}", msg))
        }
        _ => napi::Error::new(napi::Status::GenericFailure, msg),
    }
}
