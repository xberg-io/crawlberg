...
// alef:hash:143755f3b58145c39d72bc8c75f5fe75ae1b34812459ce770c6cb0c9d47e7aeb
...
export declare function interact(engine: CrawlEngineHandle, url: string, actions: Array<PageAction>): Promise<InteractionResult>;
...
export declare class CrawlEngineHandle {
   ...
   * target. WASM does not expose native streaming wrappers.
   */
  batchCrawlStream(req?: BatchCrawlStreamRequest | undefined | null): Promise<AsyncGenerator<CrawlEvent, void, undefined>>
}
