# crawlberg-ffi CMake config-mode find module
#
# Defines the imported target:
#   crawlberg-ffi::crawlberg-ffi
#
# Usage:
#   find_package(crawlberg-ffi REQUIRED)
#   target_link_libraries(myapp PRIVATE crawlberg-ffi::crawlberg-ffi)

if(TARGET crawlberg-ffi::crawlberg-ffi)
  return()
endif()
...
find_library(_FFI_LIBRARY
  NAMES crawlberg_ffi libcrawlberg_ffi
  PATHS "${_FFI_PREFIX}/lib"
  NO_DEFAULT_PATH
)
if(NOT _FFI_LIBRARY)
  find_library(_FFI_LIBRARY NAMES crawlberg_ffi libcrawlberg_ffi)
endif()
...
if(NOT _FFI_INCLUDE_DIR)
  find_path(_FFI_INCLUDE_DIR NAMES crawlberg.h)
endif()

include(FindPackageHandleStandardArgs)
find_package_handle_standard_args(crawlberg-ffi
  REQUIRED_VARS _FFI_LIBRARY _FFI_INCLUDE_DIR
)

if(crawlberg_ffi_FOUND)
  ...
  add_library(crawlberg-ffi::crawlberg-ffi ${_FFI_LIB_TYPE} IMPORTED)
  set_target_properties(crawlberg-ffi::crawlberg-ffi PROPERTIES
  ...
  if(WIN32 AND _FFI_LIB_TYPE STREQUAL "SHARED")
    find_file(_FFI_DLL
      NAMES crawlberg_ffi.dll libcrawlberg_ffi.dll
  ...
  if(APPLE)
    set_property(TARGET crawlberg-ffi::crawlberg-ffi APPEND PROPERTY
