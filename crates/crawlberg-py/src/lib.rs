...
// alef:hash:74fd86ea987a973d51802bda7f5b4f4045fbd7ec815442eca6bc24697489a6ba
...
impl CrawlConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (crawl_strategy=Self::default().crawl_strategy, respect_robots_txt=Self::default().respect_robots_txt, soft_http_errors=Self::default().soft_http_errors, stay_on_domain=Self::default().stay_on_domain, allow_subdomains=Self::default().allow_subdomains, include_paths=Self::default().include_paths, exclude_paths=Self::default().exclude_paths, custom_headers=Self::default().custom_headers, request_timeout=None, max_redirects=Self::default().max_redirects, retry_count=Self::default().retry_count, retry_codes=Self::default().retry_codes, cookies_enabled=Self::default().cookies_enabled, remove_tags=Self::default().remove_tags, content=None, download_assets=Self::default().download_assets, asset_types=Self::default().asset_types, browser=None, user_agents=Self::default().user_agents, capture_screenshot=Self::default().capture_screenshot, follow_document_urls=Self::default().follow_document_urls, download_documents=Self::default().download_documents, document_mime_types=Self::default().document_mime_types, save_browser_profile=Self::default().save_browser_profile, ssrf=None, max_depth=None, max_pages=None, max_links_per_page=None, max_concurrent=None, content_filter=None, bm25_query=None, bm25_threshold=None, user_agent=None, rate_limit_ms=None, auth=None, max_body_size=None, map_limit=None, map_search=None, max_asset_size=None, proxy=None, document_url_depth=None, document_max_size=None, document_output_dir=None, document_content_encoding=None, warc_output=None, browser_profile=None, ssrf_deny_private_explicit=None))]
    #[new]
    pub fn new(
