...
// alef:hash:ea0ec44dbf0d2807e0b05f257142b5484a687146f27fd2ad0686f66ea708bc31
...
pub struct CrawlStreamIterator {
    receiver:
        Arc<tokio::sync::Mutex<tokio::sync::mpsc::Receiver<Result<crawlberg::CrawlEvent, crawlberg::CrawlError>>>>,
}
...
impl ActionResult {
    ...
    fn from_json(json_str: String) -> pyo3::PyResult<Self> {
        serde_json::from_str::<crawlberg::ActionResult>(&json_str)
            .map(Into::into)
...
impl ArticleMetadata {
    ...
    #[staticmethod]
    fn from_json(json_str: String) -> pyo3::PyResult<Self> {
        serde_json::from_str::<crawlberg::ArticleMetadata>(&json_str)
            .map(Into::into)
            .map_err(|error| pyo3::exceptions::PyValueError::new_err(error.to_string()))
    }
}
...
impl BatchCrawlResult {
    ...
    #[staticmethod]
    fn from_json(json_str: String) -> pyo3::PyResult<Self> {
        serde_json::from_str::<crawlberg::BatchCrawlResult>(&json_str)
            .map(Into::into)
            .map_err(|error| pyo3::exceptions::PyValueError::new_err(error.to_string()))
    }
}
...
impl BatchCrawlResults {
    ...
    #[staticmethod]
    fn from_json(json_str: String) -> pyo3::PyResult<Self> {
        serde_json::from_str::<crawlberg::BatchCrawlResults>(&json_str)
            .map(Into::into)
            .map_err(|error| pyo3::exceptions::PyValueError::new_err(error.to_string()))
    }
}
...
impl BatchCrawlStreamRequest {
    ...
    #[staticmethod]
    fn from_json(json_str: String) -> pyo3::PyResult<Self> {
        serde_json::from_str::<crawlberg::BatchCrawlStreamRequest>(&json_str)
            .map(Into::into)
            .map_err(|error| pyo3::exceptions::PyValueError::new_err(error.to_string()))
    }
}
...
impl BatchScrapeResult {
    ...
    #[staticmethod]
    fn from_json(json_str: String) -> pyo3::PyResult<Self> {
        serde_json::from_str::<crawlberg::BatchScrapeResult>(&json_str)
            .map(Into::into)
            .map_err(|error| pyo3::exceptions::PyValueError::new_err(error.to_string()))
    }
}
...
impl BatchScrapeResults {
    ...
    #[staticmethod]
    fn from_json(json_str: String) -> pyo3::PyResult<Self> {
        serde_json::from_str::<crawlberg::BatchScrapeResults>(&json_str)
            .map(Into::into)
            .map_err(|error| pyo3::exceptions::PyValueError::new_err(error.to_string()))
    }
}
...
impl BrowserConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (mode=Self::default().mode, backend=Self::default().backend, timeout=None, overall_timeout=None, shutdown_timeout=None, wait=Self::default().wait, block_url_patterns=Self::default().block_url_patterns, capture_network_events=Self::default().capture_network_events, session_affinity=Self::default().session_affinity, chrome_args=Self::default().chrome_args, endpoint=None, wait_selector=None, extra_wait=None, proxy=None, eval_script=None, robots_user_agent=None, chrome_path=None))]
    #[new]
    pub fn new(
        mode: BrowserMode,
    ...
    #[staticmethod]
    fn from_json(json_str: String) -> pyo3::PyResult<Self> {
        serde_json::from_str::<crawlberg::BrowserConfig>(&json_str)
            .map(Into::into)
            .map_err(|error| pyo3::exceptions::PyValueError::new_err(error.to_string()))
    }
}
...
impl BrowserExtras {
    ...
    #[staticmethod]
    fn from_json(json_str: String) -> pyo3::PyResult<Self> {
        serde_json::from_str::<crawlberg::BrowserExtras>(&json_str)
            .map(Into::into)
            .map_err(|error| pyo3::exceptions::PyValueError::new_err(error.to_string()))
    }
}
...
impl CitationReference {
    ...
    #[staticmethod]
    fn from_json(json_str: String) -> pyo3::PyResult<Self> {
        serde_json::from_str::<crawlberg::CitationReference>(&json_str)
            .map(Into::into)
            .map_err(|error| pyo3::exceptions::PyValueError::new_err(error.to_string()))
    }
}
...
impl CitationResult {
    ...
    #[staticmethod]
    fn from_json(json_str: String) -> pyo3::PyResult<Self> {
        serde_json::from_str::<crawlberg::CitationResult>(&json_str)
            .map(Into::into)
            .map_err(|error| pyo3::exceptions::PyValueError::new_err(error.to_string()))
    }
}
...
impl ContentConfig {
    ...
    #[staticmethod]
    fn from_json(json_str: String) -> pyo3::PyResult<Self> {
        serde_json::from_str::<crawlberg::ContentConfig>(&json_str)
            .map(Into::into)
            .map_err(|error| pyo3::exceptions::PyValueError::new_err(error.to_string()))
    }
}
...
impl CookieInfo {
    ...
    #[staticmethod]
    fn from_json(json_str: String) -> pyo3::PyResult<Self> {
        serde_json::from_str::<crawlberg::CookieInfo>(&json_str)
            .map(Into::into)
            .map_err(|error| pyo3::exceptions::PyValueError::new_err(error.to_string()))
    }
}
...
impl CrawlConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (crawl_strategy=Self::default().crawl_strategy, respect_robots_txt=Self::default().respect_robots_txt, soft_http_errors=Self::default().soft_http_errors, stay_on_domain=Self::default().stay_on_domain, allow_subdomains=Self::default().allow_subdomains, include_paths=Self::default().include_paths, exclude_paths=Self::default().exclude_paths, path_patterns_match_query=Self::default().path_patterns_match_query, dedup_include_query=Self::default().dedup_include_query, strip_tracking_params=Self::default().strip_tracking_params, tracking_params=Self::default().tracking_params, custom_headers=Self::default().custom_headers, request_timeout=None, max_redirects=Self::default().max_redirects, retry_count=Self::default().retry_count, retry_codes=Self::default().retry_codes, retry_initial_delay_ms=Self::default().retry_initial_delay_ms, retry_max_delay_ms=Self::default().retry_max_delay_ms, rate_limit_jitter_ratio=Self::default().rate_limit_jitter_ratio, cookies_enabled=Self::default().cookies_enabled, remove_tags=Self::default().remove_tags, content=None, download_assets=Self::default().download_assets, asset_types=Self::default().asset_types, browser=None, user_agents=Self::default().user_agents, capture_screenshot=Self::default().capture_screenshot, follow_document_urls=Self::default().follow_document_urls, download_documents=Self::default().download_documents, document_mime_types=Self::default().document_mime_types, save_browser_profile=Self::default().save_browser_profile, ssrf=None, max_depth=None, max_pages=None, max_links_per_page=None, max_concurrent=None, content_filter=None, bm25_query=None, bm25_threshold=None, user_agent=None, rate_limit_ms=None, auth=None, max_body_size=None, map_limit=None, map_search=None, max_asset_size=None, proxy=None, document_url_depth=None, document_max_size=None, document_output_dir=None, document_content_encoding=None, warc_output=None, browser_profile=None, ssrf_deny_private_explicit=None))]
    #[new]
    pub fn new(
    ...
    #[staticmethod]
    fn from_json(json_str: String) -> pyo3::PyResult<Self> {
        serde_json::from_str::<crawlberg::CrawlConfig>(&json_str)
            .map(Into::into)
            .map_err(|error| pyo3::exceptions::PyValueError::new_err(error.to_string()))
    }
}
...
impl CrawlPageResult {
    ...
    #[staticmethod]
    fn from_json(json_str: String) -> pyo3::PyResult<Self> {
        serde_json::from_str::<crawlberg::CrawlPageResult>(&json_str)
            .map(Into::into)
            .map_err(|error| pyo3::exceptions::PyValueError::new_err(error.to_string()))
    }
}
...
impl CrawlResult {
    ...
    #[staticmethod]
    fn from_json(json_str: String) -> pyo3::PyResult<Self> {
        serde_json::from_str::<crawlberg::CrawlResult>(&json_str)
            .map(Into::into)
            .map_err(|error| pyo3::exceptions::PyValueError::new_err(error.to_string()))
    }
}
...
impl CrawlStreamRequest {
    ...
    #[staticmethod]
    fn from_json(json_str: String) -> pyo3::PyResult<Self> {
        serde_json::from_str::<crawlberg::CrawlStreamRequest>(&json_str)
            .map(Into::into)
            .map_err(|error| pyo3::exceptions::PyValueError::new_err(error.to_string()))
    }
}
...
impl DownloadedAsset {
    ...
    #[staticmethod]
    fn from_json(json_str: String) -> pyo3::PyResult<Self> {
        serde_json::from_str::<crawlberg::DownloadedAsset>(&json_str)
            .map(Into::into)
            .map_err(|error| pyo3::exceptions::PyValueError::new_err(error.to_string()))
    }
}
...
impl DownloadedDocument {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (url=Self::default().url, mime_type=Self::default().mime_type, size=Self::default().size, content_hash=Self::default().content_hash, headers=Self::default().headers, truncated=Self::default().truncated, filename=None, content_path=None, content_base64=None))]
    #[new]
    pub fn new(
        url: String,
        mime_type: String,
    ...
    #[staticmethod]
    fn from_json(json_str: String) -> pyo3::PyResult<Self> {
        serde_json::from_str::<crawlberg::DownloadedDocument>(&json_str)
            .map(Into::into)
            .map_err(|error| pyo3::exceptions::PyValueError::new_err(error.to_string()))
    }
}
...
impl ExtractionMeta {
    ...
    #[staticmethod]
    fn from_json(json_str: String) -> pyo3::PyResult<Self> {
        serde_json::from_str::<crawlberg::ExtractionMeta>(&json_str)
            .map(Into::into)
            .map_err(|error| pyo3::exceptions::PyValueError::new_err(error.to_string()))
    }
}
...
impl FaviconInfo {
    ...
    #[staticmethod]
    fn from_json(json_str: String) -> pyo3::PyResult<Self> {
        serde_json::from_str::<crawlberg::FaviconInfo>(&json_str)
            .map(Into::into)
            .map_err(|error| pyo3::exceptions::PyValueError::new_err(error.to_string()))
    }
}
...
impl FeedInfo {
    ...
    #[staticmethod]
    fn from_json(json_str: String) -> pyo3::PyResult<Self> {
        serde_json::from_str::<crawlberg::FeedInfo>(&json_str)
            .map(Into::into)
            .map_err(|error| pyo3::exceptions::PyValueError::new_err(error.to_string()))
    }
}
...
impl HeadingInfo {
    ...
    #[staticmethod]
    fn from_json(json_str: String) -> pyo3::PyResult<Self> {
        serde_json::from_str::<crawlberg::HeadingInfo>(&json_str)
            .map(Into::into)
            .map_err(|error| pyo3::exceptions::PyValueError::new_err(error.to_string()))
    }
}
...
impl HreflangEntry {
    ...
    #[staticmethod]
    fn from_json(json_str: String) -> pyo3::PyResult<Self> {
        serde_json::from_str::<crawlberg::HreflangEntry>(&json_str)
            .map(Into::into)
            .map_err(|error| pyo3::exceptions::PyValueError::new_err(error.to_string()))
    }
}
...
impl ImageInfo {
    ...
    #[staticmethod]
    fn from_json(json_str: String) -> pyo3::PyResult<Self> {
        serde_json::from_str::<crawlberg::ImageInfo>(&json_str)
            .map(Into::into)
            .map_err(|error| pyo3::exceptions::PyValueError::new_err(error.to_string()))
    }
}
...
impl InteractionResult {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (action_results=Self::default().action_results, final_html=Self::default().final_html, final_url=Self::default().final_url, screenshot_base64=None))]
    #[new]
    pub fn new(
    ...
    #[staticmethod]
    fn from_json(json_str: String) -> pyo3::PyResult<Self> {
        serde_json::from_str::<crawlberg::InteractionResult>(&json_str)
            .map(Into::into)
            .map_err(|error| pyo3::exceptions::PyValueError::new_err(error.to_string()))
    }
}
...
impl JsonLdEntry {
    ...
    #[staticmethod]
    fn from_json(json_str: String) -> pyo3::PyResult<Self> {
        serde_json::from_str::<crawlberg::JsonLdEntry>(&json_str)
            .map(Into::into)
            .map_err(|error| pyo3::exceptions::PyValueError::new_err(error.to_string()))
    }
}
...
impl LinkInfo {
    ...
    #[staticmethod]
    fn from_json(json_str: String) -> pyo3::PyResult<Self> {
        serde_json::from_str::<crawlberg::LinkInfo>(&json_str)
            .map(Into::into)
            .map_err(|error| pyo3::exceptions::PyValueError::new_err(error.to_string()))
    }
}
...
impl MapResult {
    ...
    #[staticmethod]
    fn from_json(json_str: String) -> pyo3::PyResult<Self> {
        serde_json::from_str::<crawlberg::MapResult>(&json_str)
            .map(Into::into)
            .map_err(|error| pyo3::exceptions::PyValueError::new_err(error.to_string()))
    }
}
...
impl MarkdownResult {
    ...
    #[staticmethod]
    fn from_json(json_str: String) -> pyo3::PyResult<Self> {
        serde_json::from_str::<crawlberg::MarkdownResult>(&json_str)
            .map(Into::into)
            .map_err(|error| pyo3::exceptions::PyValueError::new_err(error.to_string()))
    }
}
...
impl PageMetadata {
    ...
    #[staticmethod]
    fn from_json(json_str: String) -> pyo3::PyResult<Self> {
        serde_json::from_str::<crawlberg::PageMetadata>(&json_str)
            .map(Into::into)
            .map_err(|error| pyo3::exceptions::PyValueError::new_err(error.to_string()))
    }
}
...
impl ProxyConfig {
    ...
    #[staticmethod]
    fn from_json(json_str: String) -> pyo3::PyResult<Self> {
        serde_json::from_str::<crawlberg::ProxyConfig>(&json_str)
            .map(Into::into)
            .map_err(|error| pyo3::exceptions::PyValueError::new_err(error.to_string()))
    }
}
...
impl ResponseMeta {
    ...
    #[staticmethod]
    fn from_json(json_str: String) -> pyo3::PyResult<Self> {
        serde_json::from_str::<crawlberg::ResponseMeta>(&json_str)
            .map(Into::into)
            .map_err(|error| pyo3::exceptions::PyValueError::new_err(error.to_string()))
    }
}
...
impl ScrapeResult {
    ...
    #[staticmethod]
    fn from_json(json_str: String) -> pyo3::PyResult<Self> {
        serde_json::from_str::<crawlberg::ScrapeResult>(&json_str)
            .map(Into::into)
            .map_err(|error| pyo3::exceptions::PyValueError::new_err(error.to_string()))
    }
}
...
impl SitemapUrl {
    ...
    #[staticmethod]
    fn from_json(json_str: String) -> pyo3::PyResult<Self> {
        serde_json::from_str::<crawlberg::SitemapUrl>(&json_str)
            .map(Into::into)
            .map_err(|error| pyo3::exceptions::PyValueError::new_err(error.to_string()))
    }
}
...
impl SsrfPolicy {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (deny_private=Self::default().deny_private, allowlist=Self::default().allowlist, max_redirects=Self::default().max_redirects, scheme_allowlist=Self::default().scheme_allowlist))]
    #[new]
    pub fn new(
        deny_private: bool,
    ...
    #[staticmethod]
    fn from_json(json_str: String) -> pyo3::PyResult<Self> {
        serde_json::from_str::<crawlberg::SsrfPolicy>(&json_str)
            .map(Into::into)
            .map_err(|error| pyo3::exceptions::PyValueError::new_err(error.to_string()))
    }
}
...
mod serde_defaults {
    pub fn crawl_config_ssrf() -> super::SsrfPolicy {
        crawlberg::SsrfPolicy::from_env().into()
    }
...
const __ALEF_WIRE_ARTICLE_METADATA: &[__AlefAlias] = &[];

const __ALEF_WIRE_CRAWL_PAGE_RESULT: &[__AlefAlias] = &[
    __AlefAlias {
        rust: "metadata",
        wire: "metadata",
        kind: __AlefKind::Object,
        nested: __ALEF_WIRE_PAGE_METADATA,
    },
    __AlefAlias {
        rust: "links",
        wire: "links",
        kind: __AlefKind::Seq,
        nested: __ALEF_WIRE_LINK_INFO,
    },
    __AlefAlias {
        rust: "images",
        wire: "images",
        kind: __AlefKind::Seq,
        nested: __ALEF_WIRE_IMAGE_INFO,
    },
    __AlefAlias {
        rust: "feeds",
        wire: "feeds",
        kind: __AlefKind::Seq,
        nested: __ALEF_WIRE_FEED_INFO,
    },
    __AlefAlias {
        rust: "json_ld",
        wire: "json_ld",
        kind: __AlefKind::Seq,
        nested: __ALEF_WIRE_JSON_LD_ENTRY,
    },
    __AlefAlias {
        rust: "markdown",
        wire: "markdown",
        kind: __AlefKind::Object,
        nested: __ALEF_WIRE_MARKDOWN_RESULT,
    },
    __AlefAlias {
        rust: "extraction_meta",
        wire: "extraction_meta",
        kind: __AlefKind::Object,
        nested: __ALEF_WIRE_EXTRACTION_META,
    },
    __AlefAlias {
        rust: "downloaded_document",
        wire: "downloaded_document",
        kind: __AlefKind::Object,
        nested: __ALEF_WIRE_DOWNLOADED_DOCUMENT,
    },
];

const __ALEF_WIRE_DOWNLOADED_DOCUMENT: &[__AlefAlias] = &[];

const __ALEF_WIRE_EXTRACTION_META: &[__AlefAlias] = &[];

const __ALEF_WIRE_FAVICON_INFO: &[__AlefAlias] = &[];

const __ALEF_WIRE_FEED_INFO: &[__AlefAlias] = &[];

const __ALEF_WIRE_HEADING_INFO: &[__AlefAlias] = &[];

const __ALEF_WIRE_HREFLANG_ENTRY: &[__AlefAlias] = &[];

const __ALEF_WIRE_IMAGE_INFO: &[__AlefAlias] = &[];

const __ALEF_WIRE_JSON_LD_ENTRY: &[__AlefAlias] = &[];

const __ALEF_WIRE_LINK_INFO: &[__AlefAlias] = &[];

const __ALEF_WIRE_MARKDOWN_RESULT: &[__AlefAlias] = &[];

const __ALEF_WIRE_PAGE_METADATA: &[__AlefAlias] = &[
    __AlefAlias {
        rust: "article",
        wire: "article",
        kind: __AlefKind::Object,
        nested: __ALEF_WIRE_ARTICLE_METADATA,
    },
    __AlefAlias {
        rust: "hreflangs",
        wire: "hreflangs",
        kind: __AlefKind::Seq,
        nested: __ALEF_WIRE_HREFLANG_ENTRY,
    },
    __AlefAlias {
        rust: "favicons",
        wire: "favicons",
        kind: __AlefKind::Seq,
        nested: __ALEF_WIRE_FAVICON_INFO,
    },
    __AlefAlias {
        rust: "headings",
        wire: "headings",
        kind: __AlefKind::Seq,
        nested: __ALEF_WIRE_HEADING_INFO,
    },
];
...
impl ContentFilterKind {
    ...
    fn __new__(value: pyo3::Bound<'_, pyo3::PyAny>) -> pyo3::PyResult<Self> {
        ...
        if let Ok(s) = value.extract::<&str>() {
            let s_lower = s.to_lowercase();
            if matches!(s_lower.as_str(), "bm25") {
                return Ok(Self::Bm25);
            }
        }
        // Try to extract as integer (by discriminant value)
        ...
        let type_name = stringify!(ContentFilterKind);
        Err(pyo3::exceptions::PyValueError::new_err(format!(
            "invalid value for {}: {:#?}. Expected variant name (str) or discriminant (int)",
            type_name, value
        )))
    ...
    fn __str__(&self) -> PyResult<String> {
        serde_json::to_value(self)
            ...
            .map_err(|e| {
                pyo3::exceptions::PyRuntimeError::new_err(format!("Failed to serialize ContentFilterKind: {e}"))
            })
    }
...
pub struct CrawlEvent {
    pub(crate) inner: crawlberg::CrawlEvent,
}
...
impl CrawlEvent {
    ...
    fn new(
        ...
        let inner: crawlberg::CrawlEvent = serde_json::from_str(&json_str)
            .map_err(|e| pyo3::exceptions::PyValueError::new_err(format!("Invalid CrawlEvent: {e}")))?;
        Ok(Self { inner })
    }
    ...
    #[getter]
    fn complete(&self, py: Python<'_>) -> PyResult<Option<pyo3::Py<pyo3::PyAny>>> {
        let json =
            serde_json::to_value(&self.inner).map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))?;
        let tag_field = "type";
        let tag_value = json.get(tag_field).and_then(|v| v.as_str()).unwrap_or("");
    ...
    #[pyo3(name = "page")]
    #[staticmethod]
    pub fn _factory_page(py: Python<'_>, result: &Bound<'_, pyo3::types::PyAny>) -> PyResult<Self> {
        Ok(Self {
            inner: crawlberg::CrawlEvent::Page {
                result: __alef_coerce_dto(py, result, __ALEF_WIRE_CRAWL_PAGE_RESULT)?,
            },
        })
    }
    ...
    pub fn _factory_error(url: String, error: String) -> Self {
        Self {
            inner: crawlberg::CrawlEvent::Error { url, error },
        }
    }

    #[pyo3(name = "complete")]
    #[staticmethod]
    pub fn _factory_complete(pages_crawled: usize) -> Self {
        Self {
            inner: crawlberg::CrawlEvent::Complete { pages_crawled },
        }
    }
}
...
impl<'de> serde::Deserialize<'de> for CrawlEvent {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let inner = crawlberg::CrawlEvent::deserialize(deserializer)?;
        Ok(Self { inner })
    }
}
...
impl CrawlStrategyKind {
    ...
    fn __new__(value: pyo3::Bound<'_, pyo3::PyAny>) -> pyo3::PyResult<Self> {
        ...
        if let Ok(s) = value.extract::<&str>() {
            let s_lower = s.to_lowercase();
            match s_lower.as_str() {
                "bfs" => return Ok(Self::Bfs),
                "dfs" => return Ok(Self::Dfs),
                "bestfirst" => return Ok(Self::BestFirst),
                "best_first" => return Ok(Self::BestFirst),
        ...
        if let Ok(n) = value.extract::<i32>() {
            match n {
                0 => return Ok(Self::Bfs),
                1 => return Ok(Self::Dfs),
                2 => return Ok(Self::BestFirst),
                3 => return Ok(Self::Adaptive),
                _ => {}
            }
        }
        let type_name = stringify!(CrawlStrategyKind);
        Err(pyo3::exceptions::PyValueError::new_err(format!(
            "invalid value for {}: {:#?}. Expected variant name (str) or discriminant (int)",
            type_name, value
        )))
    ...
    fn __str__(&self) -> PyResult<String> {
        serde_json::to_value(self)
            ...
            .map_err(|e| {
                pyo3::exceptions::PyRuntimeError::new_err(format!("Failed to serialize CrawlStrategyKind: {e}"))
            })
    }
...
impl HostMatcher {
    ...
    pub fn _factory_exact(value: String) -> Self {
        Self {
            inner: crawlberg::HostMatcher::Exact { value },
        }
    }
    ...
    pub fn _factory_suffix(value: String) -> Self {
        Self {
            inner: crawlberg::HostMatcher::Suffix { value },
        }
    }
    ...
    pub fn _factory_cidr(value: String) -> Self {
        Self {
            inner: crawlberg::HostMatcher::Cidr { value },
        }
    }
}
...
pub struct PageAction {
    pub(crate) inner: crawlberg::PageAction,
}
...
impl PageAction {
    ...
    fn new(
        ...
        let inner: crawlberg::PageAction = serde_json::from_str(&json_str)
            .map_err(|e| pyo3::exceptions::PyValueError::new_err(format!("Invalid PageAction: {e}")))?;
        Ok(Self { inner })
    }
    ...
    #[getter]
    fn click(&self, py: Python<'_>) -> PyResult<Option<pyo3::Py<pyo3::PyAny>>> {
        let json =
            serde_json::to_value(&self.inner).map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))?;
        let tag_field = "type";
        let tag_value = json.get(tag_field).and_then(|v| v.as_str()).unwrap_or("");
    ...
    #[getter]
    fn type_text(&self, py: Python<'_>) -> PyResult<Option<pyo3::Py<pyo3::PyAny>>> {
        let json =
            serde_json::to_value(&self.inner).map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))?;
        let tag_field = "type";
        let tag_value = json.get(tag_field).and_then(|v| v.as_str()).unwrap_or("");
    ...
    #[getter]
    fn press(&self, py: Python<'_>) -> PyResult<Option<pyo3::Py<pyo3::PyAny>>> {
        let json =
            serde_json::to_value(&self.inner).map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))?;
        let tag_field = "type";
        let tag_value = json.get(tag_field).and_then(|v| v.as_str()).unwrap_or("");
    ...
    #[getter]
    fn scroll(&self, py: Python<'_>) -> PyResult<Option<pyo3::Py<pyo3::PyAny>>> {
        let json =
            serde_json::to_value(&self.inner).map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))?;
        let tag_field = "type";
        let tag_value = json.get(tag_field).and_then(|v| v.as_str()).unwrap_or("");
    ...
    #[getter]
    fn wait(&self, py: Python<'_>) -> PyResult<Option<pyo3::Py<pyo3::PyAny>>> {
        let json =
            serde_json::to_value(&self.inner).map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))?;
        let tag_field = "type";
        let tag_value = json.get(tag_field).and_then(|v| v.as_str()).unwrap_or("");
    ...
    #[getter]
    fn screenshot(&self, py: Python<'_>) -> PyResult<Option<pyo3::Py<pyo3::PyAny>>> {
        let json =
            serde_json::to_value(&self.inner).map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))?;
        let tag_field = "type";
        let tag_value = json.get(tag_field).and_then(|v| v.as_str()).unwrap_or("");
    ...
    #[getter]
    fn execute_js(&self, py: Python<'_>) -> PyResult<Option<pyo3::Py<pyo3::PyAny>>> {
        let json =
            serde_json::to_value(&self.inner).map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))?;
        let tag_field = "type";
        let tag_value = json.get(tag_field).and_then(|v| v.as_str()).unwrap_or("");
        if tag_value != "executeJs" {
            return Ok(None);
        }
        let payload = json;
        let json_str = payload.to_string();
    ...
    #[getter]
    fn scrape(&self, py: Python<'_>) -> PyResult<Option<pyo3::Py<pyo3::PyAny>>> {
        let json =
            serde_json::to_value(&self.inner).map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))?;
        let tag_field = "type";
        let tag_value = json.get(tag_field).and_then(|v| v.as_str()).unwrap_or("");
    ...
    pub fn _factory_click(selector: String) -> Self {
        Self {
            inner: crawlberg::PageAction::Click { selector },
        }
    }
    ...
    pub fn _factory_type_text(selector: String, text: String) -> Self {
        Self {
            inner: crawlberg::PageAction::TypeText { selector, text },
        }
    }
    ...
    pub fn _factory_press(key: String) -> Self {
        Self {
            inner: crawlberg::PageAction::Press { key },
        }
    }

    #[pyo3(name = "scroll")]
    #[pyo3(signature = (direction, selector=None, amount=None))]
    #[staticmethod]
    pub fn _factory_scroll(direction: ScrollDirection, selector: Option<String>, amount: Option<i64>) -> Self {
        Self {
            inner: crawlberg::PageAction::Scroll {
    ...
    #[pyo3(name = "wait")]
    #[pyo3(signature = (milliseconds=None, selector=None))]
    #[staticmethod]
    pub fn _factory_wait(milliseconds: Option<i64>, selector: Option<String>) -> Self {
        Self {
            inner: crawlberg::PageAction::Wait { milliseconds, selector },
        }
    }

    #[pyo3(name = "screenshot")]
    #[pyo3(signature = (full_page=None))]
    #[staticmethod]
    pub fn _factory_screenshot(full_page: Option<bool>) -> Self {
        Self {
            inner: crawlberg::PageAction::Screenshot { full_page },
        }
    }

    #[pyo3(name = "execute_js")]
    #[staticmethod]
    pub fn _factory_execute_js(script: String) -> Self {
        Self {
            inner: crawlberg::PageAction::ExecuteJs { script },
        }
    }
}
...
impl<'de> serde::Deserialize<'de> for PageAction {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let inner = crawlberg::PageAction::deserialize(deserializer)?;
        Ok(Self { inner })
    }
}
...
pub fn create_engine(py: Python<'_>, config: Option<CrawlConfig>) -> PyResult<CrawlEngineHandle> {
    let config_core: Option<crawlberg::CrawlConfig> = config.map(Into::into);

    py.detach(|| crawlberg::create_engine(config_core))
...
pub fn generate_citations(py: Python<'_>, markdown: String) -> CitationResult {
    py.detach(|| crawlberg::generate_citations(&markdown)).into()
}
...
// Error types
pyo3::create_exception!(_crawlberg, CrawlError, pyo3::exceptions::PyException);
pyo3::create_exception!(_crawlberg, NotFoundError, CrawlError);
pyo3::create_exception!(_crawlberg, UnauthorizedError, CrawlError);
pyo3::create_exception!(_crawlberg, ForbiddenError, CrawlError);
pyo3::create_exception!(_crawlberg, WafBlockedError, CrawlError);
pyo3::create_exception!(_crawlberg, CrawlTimeoutError, CrawlError);
pyo3::create_exception!(_crawlberg, RateLimitedError, CrawlError);
pyo3::create_exception!(_crawlberg, ServerError, CrawlError);
pyo3::create_exception!(_crawlberg, BadGatewayError, CrawlError);
pyo3::create_exception!(_crawlberg, GoneError, CrawlError);
pyo3::create_exception!(_crawlberg, CrawlConnectionError, CrawlError);
pyo3::create_exception!(_crawlberg, DnsError, CrawlError);
pyo3::create_exception!(_crawlberg, SslError, CrawlError);
pyo3::create_exception!(_crawlberg, DataLossError, CrawlError);
pyo3::create_exception!(_crawlberg, BrowserError, CrawlError);
pyo3::create_exception!(_crawlberg, BrowserTimeoutError, CrawlError);
pyo3::create_exception!(_crawlberg, InvalidConfigError, CrawlError);
pyo3::create_exception!(_crawlberg, UnsupportedError, CrawlError);
pyo3::create_exception!(_crawlberg, SsrfPolicyViolationError, CrawlError);
pyo3::create_exception!(_crawlberg, OtherError, CrawlError);

/// Convert a `crawlberg::CrawlError` error to a Python exception.
fn crawl_error_to_py_err(e: crawlberg::CrawlError) -> pyo3::PyErr {
    let msg = e.to_string();
    #[allow(unreachable_patterns)]
    match &e {
        crawlberg::CrawlError::NotFound { .. } => NotFoundError::new_err(msg),
        crawlberg::CrawlError::Unauthorized { .. } => UnauthorizedError::new_err(msg),
        crawlberg::CrawlError::Forbidden { .. } => ForbiddenError::new_err(msg),
        crawlberg::CrawlError::WafBlocked { .. } => WafBlockedError::new_err(msg),
        crawlberg::CrawlError::Timeout { .. } => CrawlTimeoutError::new_err(msg),
        crawlberg::CrawlError::RateLimited { .. } => RateLimitedError::new_err(msg),
        crawlberg::CrawlError::ServerError { .. } => ServerError::new_err(msg),
        crawlberg::CrawlError::BadGateway { .. } => BadGatewayError::new_err(msg),
        crawlberg::CrawlError::Gone { .. } => GoneError::new_err(msg),
        crawlberg::CrawlError::Connection { .. } => CrawlConnectionError::new_err(msg),
        crawlberg::CrawlError::Dns { .. } => DnsError::new_err(msg),
        crawlberg::CrawlError::Ssl { .. } => SslError::new_err(msg),
        crawlberg::CrawlError::DataLoss { .. } => DataLossError::new_err(msg),
        crawlberg::CrawlError::BrowserError { .. } => BrowserError::new_err(msg),
        crawlberg::CrawlError::BrowserTimeout { .. } => BrowserTimeoutError::new_err(msg),
        crawlberg::CrawlError::InvalidConfig { .. } => InvalidConfigError::new_err(msg),
        crawlberg::CrawlError::Unsupported { .. } => UnsupportedError::new_err(msg),
        crawlberg::CrawlError::SsrfPolicyViolation { .. } => SsrfPolicyViolationError::new_err(msg),
        crawlberg::CrawlError::Other { .. } => OtherError::new_err(msg),
        _ => CrawlError::new_err(msg),
    }
}

// Error types
pyo3::create_exception!(_crawlberg, SsrfError, pyo3::exceptions::PyException);
pyo3::create_exception!(_crawlberg, DeniedByPolicyError, SsrfError);
pyo3::create_exception!(_crawlberg, NotOnAllowlistError, SsrfError);
pyo3::create_exception!(_crawlberg, InvalidCidrError, SsrfError);
pyo3::create_exception!(_crawlberg, DnsResolutionFailedError, SsrfError);
pyo3::create_exception!(_crawlberg, InvalidUrlError, SsrfError);
pyo3::create_exception!(_crawlberg, DisallowedSchemeError, SsrfError);
pyo3::create_exception!(_crawlberg, TooManyRedirectsError, SsrfError);

/// Convert a `crawlberg::SsrfError` error to a Python exception.
fn ssrf_error_to_py_err(e: crawlberg::SsrfError) -> pyo3::PyErr {
    let msg = e.to_string();
    #[allow(unreachable_patterns)]
    match &e {
        crawlberg::SsrfError::DeniedByPolicy { .. } => DeniedByPolicyError::new_err(msg),
        crawlberg::SsrfError::NotOnAllowlist => NotOnAllowlistError::new_err(msg),
        crawlberg::SsrfError::InvalidCidr(..) => InvalidCidrError::new_err(msg),
        crawlberg::SsrfError::DnsResolutionFailed(..) => DnsResolutionFailedError::new_err(msg),
        crawlberg::SsrfError::InvalidUrl(..) => InvalidUrlError::new_err(msg),
        crawlberg::SsrfError::DisallowedScheme(..) => DisallowedSchemeError::new_err(msg),
        crawlberg::SsrfError::TooManyRedirects => TooManyRedirectsError::new_err(msg),
        _ => SsrfError::new_err(msg),
    }
}
...
#[pymodule]
pub fn _crawlberg(m: &Bound<'_, PyModule>) -> PyResult<()> {
    {
    ...
    m.add_class::<ContentFilterKind>()?;
    m.add_class::<CrawlEvent>()?;
    m.add_class::<CrawlStrategyKind>()?;
    ...
    m.add("DeniedByPolicyError", m.py().get_type::<DeniedByPolicyError>())?;
    m.add("NotOnAllowlistError", m.py().get_type::<NotOnAllowlistError>())?;
    m.add("InvalidCidrError", m.py().get_type::<InvalidCidrError>())?;
    m.add(
        "DnsResolutionFailedError",
        m.py().get_type::<DnsResolutionFailedError>(),
    )?;
    m.add("InvalidUrlError", m.py().get_type::<InvalidUrlError>())?;
    m.add("DisallowedSchemeError", m.py().get_type::<DisallowedSchemeError>())?;
    m.add("TooManyRedirectsError", m.py().get_type::<TooManyRedirectsError>())?;
    m.add("SsrfError", m.py().get_type::<SsrfError>())?;
    Ok(())
}
