...
public class MetadataTest {
  ...
  void testMetadataArticleTimes() throws Exception {
    ...
    assertEquals(
        200,
        result.statusCode()); // skipped: field 'article.published_time' not
                              // available on result type        // skipped:
                              // field 'article.modified_time' not available on
                              // result type        // skipped: field
                              // 'article.author' not available on result type
                              // // skipped: field 'article.section' not
                              // available on result type        // skipped:
                              // field 'article.tags.length' not available on
                              // result type
  }
  ...
  void testMetadataFavicons() throws Exception {
    ...
    var result = Crawlberg.scrape(engine, url);
    assertEquals(
        200, result.statusCode()); // skipped: field 'favicons.length' not
                                   // available on result type        //
                                   // skipped: field 'favicons[].apple_touch'
  ...
  void testMetadataHeadings() throws Exception {
    ...
    assertEquals(
        200,
        result.statusCode()); // skipped: field 'headings.h1.length' not
                              // available on result type        // skipped:
                              // field 'headings.h1[0].text' not available on
                              // result type        // skipped: field
                              // 'headings.length' not available on result type
  }
  ...
  void testMetadataHreflang() throws Exception {
    ...
    assertEquals(
        200,
        result.statusCode()); // skipped: field 'hreflang.length' not available
                              // on result type        // skipped: field
                              // 'hreflang[].lang' not available on result type
  }
  ...
  void testMetadataKeywordsAuthor() throws Exception {
    ...
    assertEquals("Comprehensive Metadata Test Page",
                 java.util.Optional.ofNullable(result.metadata().title())
                     .map(java.util.Objects::toString)
                     .orElse("")
                     .trim());
    assertFalse(java.util.Optional.ofNullable(result.metadata().canonicalUrl())
                    .isEmpty(),
                "expected non-empty value");
    assertFalse(
        java.util.Optional.ofNullable(result.metadata().keywords()).isEmpty(),
        "expected non-empty value");
    assertTrue(java.util.Optional.ofNullable(result.metadata().keywords())
                   .map(java.util.Objects::toString)
                   .orElse("")
                   .contains("rust"),
               "expected to contain: "
                   + "rust");
    assertEquals("Jane Developer",
  ...
  void testMetadataOgVideoAudio() throws Exception {
    ...
    assertEquals("https://example.com/video.mp4",
                 java.util.Optional.ofNullable(result.metadata().ogVideo())
                     ...
                     .orElse("")
                     .trim());
    assertEquals("https://example.com/audio.mp3",
                 java.util.Optional.ofNullable(result.metadata().ogAudio())
                     .map(java.util.Objects::toString)
                     .orElse("")
                     .trim()); // skipped: field 'og.locale_alternate.length'
                               // not available on result type
  }
  ...
  void testMetadataResponseHeaders() throws Exception {
    ...
    assertEquals(
        200,
        result.statusCode()); // skipped: field 'response_headers.etag' not
                              // available on result type        // skipped:
                              // field 'response_headers.last_modified' not
                              // available on result type        // skipped:
                              // field 'response_headers.server' not available
                              // on result type        // skipped: field
                              // 'response_headers.content_language' not
                              // available on result type
  }
  ...
  void testMetadataWordCount() throws Exception {
    ...
    var result = Crawlberg.scrape(engine, url);
    assertEquals(200, result.statusCode());
    assertTrue(java.util.Optional.ofNullable(result.metadata().wordCount())
