...
public class MarkdownTest {
  ...
  void testCitationsBalancedParens() throws Exception {
    ...
    assertFalse(result.markdown().content().isEmpty(),
                "expected non-empty value");
    assertTrue(result.markdown().content().contains("("),
               "expected to contain: "
                   + "(");
  }
  ...
  void testMarkdownBasicConversion() throws Exception {
    ...
    assertFalse(result.markdown().content().isEmpty(),
                "expected non-empty value");
    assertTrue(result.markdown().content().contains("Hello World"),
               "expected to contain: "
                   + "Hello World");
  }
  ...
  void testMarkdownHeadingsAndParagraphs() throws Exception {
    ...
    assertFalse(result.markdown().content().isEmpty(),
                "expected non-empty value");
    assertTrue(result.markdown().content().contains("Main Title"),
               "expected to contain: "
                   + "Main Title");
  }
  ...
  void testMarkdownLinksConverted() throws Exception {
    ...
    assertFalse(result.markdown().content().isEmpty(),
                "expected non-empty value");
    assertTrue(result.markdown().content().contains("Example"),
               "expected to contain: "
                   + "Example");
  }
