...
public class ScrapeTest {
  ...
  void testScrapeAssetDedup() throws Exception {
    ...
    var engineConfig =
        MAPPER.readValue("{\"download_assets\":true}", CrawlConfig.class);
    ...
    assertFalse(result.assets().get(0).contentHash().isEmpty(),
  ...
  void testScrapeAssetMaxSize() throws Exception {
    ...
    var engineConfig = MAPPER.readValue(
        "{\"download_assets\":true,\"max_asset_size\":150}", CrawlConfig.class);
    var engine = Crawlberg.createEngine(engineConfig);
    String url = System.getProperty(
  ...
  void testScrapeBasicHtmlPage() throws Exception {
    ...
    var engineConfig = MAPPER.readValue(
        "{\"max_depth\":0,\"respect_robots_txt\":false}", CrawlConfig.class);
    var engine = Crawlberg.createEngine(engineConfig);
    String url =
        System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) +
    ...
    assertEquals("Example Domain",
                 java.util.Optional.ofNullable(result.metadata().title())
                     ...
                     .orElse("")
                     .trim());
    assertTrue(java.util.Optional.ofNullable(result.metadata().description())
                   .map(java.util.Objects::toString)
                   .orElse("")
    ...
    assertTrue(result.links().get(0).linkType().getValue().contains("external"),
               "expected to contain: "
                   + "external");
  ...
  void testScrapeComplexLinks() throws Exception {
    ...
    assertFalse(result.links().get(0).url().isEmpty(),
                "expected non-empty value");
  }
  ...
  void testScrapeDublinCore() throws Exception {
    ...
    assertFalse(
        ...
        "expected non-empty value");
    assertEquals("Effects of Climate Change on Marine Biodiversity",
                 java.util.Optional.ofNullable(result.metadata().dcTitle())
                     .map(java.util.Objects::toString)
                     .orElse("")
                     .trim());
    assertEquals("Dr. Jane Smith",
  ...
  void testScrapeImageSources() throws Exception {
    ...
    assertEquals("https://example.com/images/og-hero.jpg",
  ...
  void testScrapeJsonLd() throws Exception {
    ...
    assertEquals("Best Chocolate Cake",
  ...
  void testScrapeOgMetadata() throws Exception {
    ...
    assertEquals("article",
                 java.util.Optional.ofNullable(result.metadata().ogType())
                     ...
                     .orElse("")
                     .trim());
    assertEquals("https://example.com/images/article-hero.jpg",
                 java.util.Optional.ofNullable(result.metadata().ogImage())
                     .map(java.util.Objects::toString)
                     .orElse("")
                     .trim());
    assertFalse(java.util.Optional.ofNullable(result.metadata().ogDescription())
                    .isEmpty(),
                "expected non-empty value");
    assertEquals("Article Title - Example Blog",
                 java.util.Optional.ofNullable(result.metadata().title())
                     .map(java.util.Objects::toString)
                     .orElse("")
                     .trim());
  ...
  void testScrapeTwitterCard() throws Exception {
    ...
    var result = Crawlberg.scrape(engine, url);
    assertEquals(200, result.statusCode());
    assertFalse(java.util.Optional.ofNullable(result.metadata().twitterCard())
                    .isEmpty(),
                "expected non-empty value");
    assertEquals("summary_large_image",
                 java.util.Optional.ofNullable(result.metadata().twitterCard())
                     .map(java.util.Objects::toString)
                     .orElse("")
                     .trim());
    assertEquals("New Product Launch",
