...
public class ScrapeTests {
  ...
  public async Task Test_ScrapeAssetDedup() {
    ...
    Assert.False(
        string.IsNullOrEmpty(result.Assets[0].ContentHash?.ToString()));
  }
  ...
  public async Task Test_ScrapeAssetTypeFilter() {
    ...
    Assert.Contains("image",
                    result.Assets[0].AssetCategory.ToString().ToLower());
  }
  ...
  public async Task Test_ScrapeBasicHtmlPage() {
    ...
    Assert.Contains("illustrative examples",
                    result.Metadata.Description.ToString().ToLower());
    Assert.False(
        string.IsNullOrEmpty(result.Metadata.CanonicalUrl?.ToString()));
  ...
  public async Task Test_ScrapeOgMetadata() {
    ...
    Assert.Equal("https://example.com/images/article-hero.jpg",
                 result.Metadata.OgImage!.Trim());
    Assert.False(
        string.IsNullOrEmpty(result.Metadata.OgDescription?.ToString()));
