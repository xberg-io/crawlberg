...
public class MetadataTests {
  ...
  public async Task Test_MetadataKeywordsAuthor() {
    ...
    var result = await CrawlbergConverter.ScrapeAsync(engine, url);
    Assert.True(result.StatusCode == 200);
    Assert.Equal("Comprehensive Metadata Test Page",
  ...
  public async Task Test_MetadataOgVideoAudio() {
    ...
    var result = await CrawlbergConverter.ScrapeAsync(engine, url);
    Assert.True(result.StatusCode == 200);
    Assert.Equal("https://example.com/video.mp4",
                 result.Metadata.OgVideo!.Trim());
    Assert.Equal("https://example.com/audio.mp3",
                 result.Metadata.OgAudio!.Trim());
  ...
  public async Task Test_MetadataResponseHeaders() {
    ...
    // type        // skipped: field 'response_headers.server' not available on
    // result type        // skipped: field 'response_headers.content_language'
