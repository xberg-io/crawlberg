...
func Test_ScrapeBasicHtmlPage(t *testing.T) {
	...
	if strings.TrimSpace(string(metadataTitle)) != `Example Domain` {
...
func Test_ScrapeDublinCore(t *testing.T) {
	...
	if strings.TrimSpace(string(metadataDcTitle)) != `Effects of Climate Change on Marine Biodiversity` {
		t.Errorf("equals mismatch: got %v", metadataDcTitle)
	}
	if strings.TrimSpace(string(metadataDcCreator)) != `Dr. Jane Smith` {
...
func Test_ScrapeImageSources(t *testing.T) {
	...
	if strings.TrimSpace(string(metadataOgImage)) != `https://example.com/images/og-hero.jpg` {
...
func Test_ScrapeJsonLd(t *testing.T) {
	...
	if len(result.JSONLd) > 0 {
		if strings.TrimSpace(string(result.JSONLd[0].SchemaType)) != `Recipe` {
			t.Errorf("equals mismatch: got %v", result.JSONLd[0].SchemaType)
		}
	}
	if strings.TrimSpace(string(jsonLdName)) != `Best Chocolate Cake` {
...
func Test_ScrapeOgMetadata(t *testing.T) {
	...
	if strings.TrimSpace(string(metadataOgTitle)) != `Article Title` {
		t.Errorf("equals mismatch: got %v", metadataOgTitle)
	}
	if strings.TrimSpace(string(metadataOgType)) != `article` {
		t.Errorf("equals mismatch: got %v", metadataOgType)
	}
	if strings.TrimSpace(string(metadataOgImage)) != `https://example.com/images/article-hero.jpg` {
		t.Errorf("equals mismatch: got %v", metadataOgImage)
	}
	if result.Metadata.OgDescription == nil {
		t.Errorf("expected non-empty value")
	}
	if strings.TrimSpace(string(metadataTitle)) != `Article Title - Example Blog` {
		t.Errorf("equals mismatch: got %v", metadataTitle)
	}
}
...
func Test_ScrapeTwitterCard(t *testing.T) {
	...
	if strings.TrimSpace(string(metadataTwitterCard)) != `summary_large_image` {
		t.Errorf("equals mismatch: got %v", metadataTwitterCard)
	}
	if strings.TrimSpace(string(metadataTwitterTitle)) != `New Product Launch` {
