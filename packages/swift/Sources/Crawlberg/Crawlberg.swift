...
// alef:hash:8bcf104b4bbff796e2f37d050c10ccfcf8fcb55e769556c2b245faf1bf1656f1
...
public struct SsrfPolicy: Codable, Sendable, Hashable {
    ...
    public init(denyPrivate: Bool = true, allowlist: [HostMatcher], maxRedirects: UInt8 = 5) {
...
internal extension SsrfPolicy {
    ...
    func intoRust() throws -> RustBridge.SsrfPolicy {
        ...
        return RustBridge.SsrfPolicy(self.denyPrivate, __allowlist, self.maxRedirects)
    }
}
