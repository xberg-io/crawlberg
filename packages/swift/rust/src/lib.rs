...
impl PageMetadata {
    ...
    pub fn hreflangs(&self) -> String {
        serde_json::to_string(&self.0.hreflangs).expect("serializable optional vec")
    }
    pub fn favicons(&self) -> String {
        serde_json::to_string(&self.0.favicons).expect("serializable optional vec")
    }
    pub fn headings(&self) -> String {
        serde_json::to_string(&self.0.headings).expect("serializable optional vec")
    }
