...
// alef:hash:f7faecdb9f8cc586de85054daaddce36287a8659860edbd08c8c2db710bb1633
...
#[used]
static __ALEF_KEEP_FFI_LINKED: unsafe extern "C" fn() -> *const ::std::ffi::c_char = crawlberg_ffi::cberg_version;
...
mod ffi {
    ...
    extern "Rust" {
        ...
        fn timeout(&self) -> u64;
        #[swift_bridge(swift_name = "overallTimeout")]
        ...
        #[swift_bridge(swift_name = "chromePath")]
        fn chrome_path(&self) -> Option<String>;
        #[swift_bridge(swift_name = "chromeArgs")]
    ...
    extern "Rust" {
        ...
        #[swift_bridge(swift_name = "crawlStrategy")]
        fn crawl_strategy(&self) -> String;
        #[swift_bridge(swift_name = "contentFilter")]
        fn content_filter(&self) -> Option<String>;
        #[swift_bridge(swift_name = "bm25Query")]
        fn bm25_query(&self) -> Option<String>;
        #[swift_bridge(swift_name = "bm25Threshold")]
        ...
        #[swift_bridge(swift_name = "pathPatternsMatchQuery")]
        fn path_patterns_match_query(&self) -> bool;
        #[swift_bridge(swift_name = "dedupIncludeQuery")]
        fn dedup_include_query(&self) -> bool;
        #[swift_bridge(swift_name = "stripTrackingParams")]
        fn strip_tracking_params(&self) -> bool;
        #[swift_bridge(swift_name = "trackingParams")]
        ...
        #[swift_bridge(swift_name = "retryInitialDelayMs")]
        fn retry_initial_delay_ms(&self) -> u64;
        #[swift_bridge(swift_name = "retryMaxDelayMs")]
        fn retry_max_delay_ms(&self) -> u64;
        #[swift_bridge(swift_name = "rateLimitJitterRatio")]
    ...
    extern "Rust" {
        #[swift_bridge(swift_name = "crawlConfigValidateFromJson")]
        fn crawl_config_validate_from_json(json: String) -> Result<String, String>;
    }
    ...
    extern "Rust" {
        #[swift_bridge(swift_name = "crawlResultUniqueNormalizedUrlsFromJson")]
        fn crawl_result_unique_normalized_urls_from_json(json: String) -> Result<String, String>;
    }
    ...
    extern "Rust" {
        ...
        #[swift_bridge(swift_name = "contentPath")]
        fn content_path(&self) -> Option<String>;
        #[swift_bridge(swift_name = "contentBase64")]
    ...
    extern "Rust" {
        ...
        #[swift_bridge(swift_name = "finalUrl")]
        fn final_url(&self) -> String;
        #[swift_bridge(swift_name = "screenshotBase64")]
    ...
    extern "Rust" {
        ...
        fn og_locale_alternates(&self) -> String;
        ...
        fn hreflangs(&self) -> String;
        fn favicons(&self) -> String;
    ...
    extern "Rust" {
        ...
        #[swift_bridge(swift_name = "schemeAllowlist")]
    ...
    extern "Rust" {
        ...
        fn crawl_engine_handle_noop(client: &CrawlEngineHandle);
    ...
    extern "Rust" {
        ...
        #[swift_bridge(swift_name = "contentFilterKindFromJson")]
        fn content_filter_kind_from_json(json: String) -> Result<ContentFilterKind, String>;
        #[swift_bridge(swift_name = "crawlEventFromJson")]
        fn crawl_event_from_json(json: String) -> Result<CrawlEvent, String>;
        #[swift_bridge(swift_name = "crawlStrategyKindFromJson")]
        fn crawl_strategy_kind_from_json(json: String) -> Result<CrawlStrategyKind, String>;
        ...
        #[swift_bridge(swift_name = "hostMatcherFromJson")]
        fn host_matcher_from_json(json: String) -> Result<HostMatcher, String>;
    ...
    extern "Rust" {
        ...
        fn __alef_phantom_vec_content_filter_kind() -> Vec<ContentFilterKind>;
        fn __alef_phantom_vec_crawl_strategy_kind() -> Vec<CrawlStrategyKind>;
...
#[doc(hidden)]
pub fn __alef_phantom_vec_content_filter_kind() -> Vec<ContentFilterKind> {
    Vec::new()
}
#[cfg(not(target_arch = "wasm32"))]
#[doc(hidden)]
...
#[doc(hidden)]
pub fn __alef_phantom_vec_crawl_strategy_kind() -> Vec<CrawlStrategyKind> {
    Vec::new()
}
#[doc(hidden)]
...
impl BrowserConfig {
    pub fn new(
        ...
        __target.overall_timeout = std::time::Duration::from_millis(overall_timeout);
        __target.shutdown_timeout = std::time::Duration::from_millis(shutdown_timeout);
        ...
        if let Some(s) = chrome_path {
            ...
            let __v = ::serde_json::from_str::<::serde_json::Value>(&s).unwrap_or(::serde_json::Value::String(s));
            if let Ok(t) = ::serde_json::from_value(__v) {
                __target.chrome_path = Some(t);
            }
        }
        if let Ok(__v) = ::serde_json::to_value(chrome_args) {
            if let Ok(t) = ::serde_json::from_value(__v) {
                __target.chrome_args = t;
            }
        }
    ...
    pub fn overall_timeout(&self) -> u64 {
        self.0.overall_timeout.as_millis() as u64
    }
    pub fn shutdown_timeout(&self) -> u64 {
        self.0.shutdown_timeout.as_millis() as u64
    }
    ...
    pub fn chrome_path(&self) -> Option<String> {
        self.0.chrome_path.as_ref().and_then(|v| serde_json::to_string(v).ok())
    }
    pub fn chrome_args(&self) -> Vec<String> {
        ::serde_json::to_value(&self.0.chrome_args)
            .ok()
            .and_then(|j| ::serde_json::from_value(j).ok())
            .unwrap_or_default()
    }
...
impl CrawlConfig {
    ...
    pub fn crawl_strategy(&self) -> String {
        CrawlStrategyKind::from(self.0.crawl_strategy.clone()).to_string()
    }
    pub fn content_filter(&self) -> Option<String> {
        self.0
            .content_filter
            .clone()
            .map(|w| ContentFilterKind::from(w).to_string())
    }
    pub fn bm25_query(&self) -> Option<String> {
        self.0.bm25_query.clone()
    }
    pub fn bm25_threshold(&self) -> Option<f64> {
        self.0.bm25_threshold.as_ref().and_then(|v| {
            ::serde_json::to_value(v)
                .ok()
                .and_then(|j| ::serde_json::from_value(j).ok())
        })
    ...
    pub fn path_patterns_match_query(&self) -> bool {
        ::serde_json::to_value(&self.0.path_patterns_match_query)
            .ok()
            .and_then(|j| ::serde_json::from_value(j).ok())
            .unwrap_or_default()
    }
    pub fn dedup_include_query(&self) -> bool {
        ::serde_json::to_value(&self.0.dedup_include_query)
            .ok()
            .and_then(|j| ::serde_json::from_value(j).ok())
            .unwrap_or_default()
    }
    pub fn strip_tracking_params(&self) -> bool {
        ::serde_json::to_value(&self.0.strip_tracking_params)
            .ok()
            .and_then(|j| ::serde_json::from_value(j).ok())
            .unwrap_or_default()
    }
    pub fn tracking_params(&self) -> Vec<String> {
        ::serde_json::to_value(&self.0.tracking_params)
            .ok()
            .and_then(|j| ::serde_json::from_value(j).ok())
            .unwrap_or_default()
    }
    ...
    pub fn retry_initial_delay_ms(&self) -> u64 {
        ::serde_json::to_value(&self.0.retry_initial_delay_ms)
            .ok()
            .and_then(|j| ::serde_json::from_value(j).ok())
            .unwrap_or_default()
    }
    pub fn retry_max_delay_ms(&self) -> u64 {
        ::serde_json::to_value(&self.0.retry_max_delay_ms)
            .ok()
            .and_then(|j| ::serde_json::from_value(j).ok())
            .unwrap_or_default()
    }
    pub fn rate_limit_jitter_ratio(&self) -> f64 {
        ::serde_json::to_value(&self.0.rate_limit_jitter_ratio)
            .ok()
            .and_then(|j| ::serde_json::from_value(j).ok())
            .unwrap_or_default()
    }
...
pub fn crawl_config_validate_from_json(json: String) -> Result<String, String> {
    let __self: crawlberg::CrawlConfig =
        serde_json::from_str(&json).map_err(|e| format!("Failed to deserialize CrawlConfig: {}", e))?;
...
pub fn crawl_result_unique_normalized_urls_from_json(json: String) -> Result<String, String> {
    let __self: crawlberg::CrawlResult =
        serde_json::from_str(&json).map_err(|e| format!("Failed to deserialize CrawlResult: {}", e))?;
    let __result = __self.unique_normalized_urls();
...
impl DownloadedDocument {
    ...
    pub fn truncated(&self) -> bool {
        ::serde_json::to_value(&self.0.truncated)
            .ok()
            .and_then(|j| ::serde_json::from_value(j).ok())
            .unwrap_or_default()
    }
    pub fn content_path(&self) -> Option<String> {
        self.0.content_path.clone()
    }
    pub fn content_base64(&self) -> Option<String> {
        self.0.content_base64.clone()
    }
}
...
impl InteractionResult {
    pub fn new(
        ...
        if let Some(s) = screenshot_base64 {
            // Try JSON parse first (handles enum/object values); on parse failure
            // treat the raw input as a JSON string scalar so plain `String` /
            // string-like enum fields don't end up empty for inputs that aren't
            // valid JSON tokens (e.g. `tts-1`).
            let __v = ::serde_json::from_str::<::serde_json::Value>(&s).unwrap_or(::serde_json::Value::String(s));
            if let Ok(t) = ::serde_json::from_value(__v) {
                __target.screenshot_base64 = Some(t);
            }
        }
    ...
    pub fn screenshot_base64(&self) -> Option<String> {
        self.0.screenshot_base64.clone()
    }
}
...
impl PageMetadata {
    ...
    pub fn og_locale_alternates(&self) -> String {
        serde_json::to_string(&self.0.og_locale_alternates).expect("serializable og_locale_alternates")
    }
    ...
    pub fn hreflangs(&self) -> String {
        serde_json::to_string(&self.0.hreflangs).expect("serializable hreflangs")
    }
    pub fn favicons(&self) -> String {
        serde_json::to_string(&self.0.favicons).expect("serializable favicons")
    }
    pub fn headings(&self) -> String {
        serde_json::to_string(&self.0.headings).expect("serializable headings")
    }
...
impl SsrfPolicy {
    pub fn new(
        ...
        if let Ok(__v) = ::serde_json::to_value(scheme_allowlist) {
            if let Ok(t) = ::serde_json::from_value(__v) {
                __target.scheme_allowlist = t;
            }
        }
        SsrfPolicy(__target)
    }
    ...
    pub fn scheme_allowlist(&self) -> Vec<String> {
        ::serde_json::to_value(&self.0.scheme_allowlist)
            .ok()
            .and_then(|j| ::serde_json::from_value(j).ok())
            .unwrap_or_default()
    }
...
pub fn crawl_engine_handle_noop(client: &CrawlEngineHandle) {
...
#[allow(dead_code)]
fn __alef_asset_category_from_swift_string(value: &str) -> Result<crawlberg::AssetCategory, String> {
    match value {
        "document" => Ok(crawlberg::AssetCategory::Document),
        "image" => Ok(crawlberg::AssetCategory::Image),
        "audio" => Ok(crawlberg::AssetCategory::Audio),
        "video" => Ok(crawlberg::AssetCategory::Video),
        "font" => Ok(crawlberg::AssetCategory::Font),
        "stylesheet" => Ok(crawlberg::AssetCategory::Stylesheet),
        "script" => Ok(crawlberg::AssetCategory::Script),
        "archive" => Ok(crawlberg::AssetCategory::Archive),
        "data" => Ok(crawlberg::AssetCategory::Data),
        "other" => Ok(crawlberg::AssetCategory::Other),
        _ => Err(format!("unknown AssetCategory variant: {:?}", value)),
    }
}
...
#[allow(dead_code)]
fn __alef_browser_backend_from_swift_string(value: &str) -> Result<crawlberg::BrowserBackend, String> {
    match value {
        "chromiumoxide" => Ok(crawlberg::BrowserBackend::Chromiumoxide),
        "native" => Ok(crawlberg::BrowserBackend::Native),
        _ => Err(format!("unknown BrowserBackend variant: {:?}", value)),
    }
}
...
#[allow(dead_code)]
fn __alef_browser_mode_from_swift_string(value: &str) -> Result<crawlberg::BrowserMode, String> {
    match value {
        "auto" => Ok(crawlberg::BrowserMode::Auto),
        "always" => Ok(crawlberg::BrowserMode::Always),
        "never" => Ok(crawlberg::BrowserMode::Never),
        "stealth" => Ok(crawlberg::BrowserMode::Stealth),
        _ => Err(format!("unknown BrowserMode variant: {:?}", value)),
    }
}
...
#[allow(dead_code)]
fn __alef_browser_wait_from_swift_string(value: &str) -> Result<crawlberg::BrowserWait, String> {
    match value {
        "network_idle" => Ok(crawlberg::BrowserWait::NetworkIdle),
        "selector" => Ok(crawlberg::BrowserWait::Selector),
        "fixed" => Ok(crawlberg::BrowserWait::Fixed),
        _ => Err(format!("unknown BrowserWait variant: {:?}", value)),
    }
}
...
impl ContentFilterKind {
    pub fn to_string(&self) -> String {
        match self {
            Self::Bm25 => "bm25".to_string(),
        }
    }
}
#[allow(dead_code)]
fn __alef_content_filter_kind_from_swift_string(value: &str) -> Result<crawlberg::ContentFilterKind, String> {
    match value {
        "bm25" => Ok(crawlberg::ContentFilterKind::Bm25),
        _ => Err(format!("unknown ContentFilterKind variant: {:?}", value)),
    }
}
...
impl CrawlStrategyKind {
    pub fn to_string(&self) -> String {
        match self {
            Self::Bfs => "bfs".to_string(),
            Self::Dfs => "dfs".to_string(),
            Self::BestFirst => "best_first".to_string(),
            Self::Adaptive => "adaptive".to_string(),
        }
    }
}
#[allow(dead_code)]
fn __alef_crawl_strategy_kind_from_swift_string(value: &str) -> Result<crawlberg::CrawlStrategyKind, String> {
    match value {
        "bfs" => Ok(crawlberg::CrawlStrategyKind::Bfs),
        "dfs" => Ok(crawlberg::CrawlStrategyKind::Dfs),
        "best_first" => Ok(crawlberg::CrawlStrategyKind::BestFirst),
        "adaptive" => Ok(crawlberg::CrawlStrategyKind::Adaptive),
        _ => Err(format!("unknown CrawlStrategyKind variant: {:?}", value)),
    }
}
...
#[allow(dead_code)]
fn __alef_document_content_encoding_from_swift_string(
    value: &str,
) -> Result<crawlberg::DocumentContentEncoding, String> {
    match value {
        "base64" => Ok(crawlberg::DocumentContentEncoding::Base64),
        _ => Err(format!("unknown DocumentContentEncoding variant: {:?}", value)),
    }
}
...
#[allow(dead_code)]
fn __alef_feed_type_from_swift_string(value: &str) -> Result<crawlberg::FeedType, String> {
    match value {
        "rss" => Ok(crawlberg::FeedType::Rss),
        "atom" => Ok(crawlberg::FeedType::Atom),
        "json_feed" => Ok(crawlberg::FeedType::JsonFeed),
        _ => Err(format!("unknown FeedType variant: {:?}", value)),
    }
}
...
#[allow(dead_code)]
fn __alef_image_source_from_swift_string(value: &str) -> Result<crawlberg::ImageSource, String> {
    match value {
        "img" => Ok(crawlberg::ImageSource::Img),
        "picture_source" => Ok(crawlberg::ImageSource::PictureSource),
        "og:image" => Ok(crawlberg::ImageSource::OgImage),
        "twitter:image" => Ok(crawlberg::ImageSource::TwitterImage),
        _ => Err(format!("unknown ImageSource variant: {:?}", value)),
    }
}
...
#[allow(dead_code)]
fn __alef_link_type_from_swift_string(value: &str) -> Result<crawlberg::LinkType, String> {
    match value {
        "internal" => Ok(crawlberg::LinkType::Internal),
        "external" => Ok(crawlberg::LinkType::External),
        "anchor" => Ok(crawlberg::LinkType::Anchor),
        "document" => Ok(crawlberg::LinkType::Document),
...
#[allow(dead_code)]
fn __alef_scroll_direction_from_swift_string(value: &str) -> Result<crawlberg::ScrollDirection, String> {
    match value {
        "up" => Ok(crawlberg::ScrollDirection::Up),
        "down" => Ok(crawlberg::ScrollDirection::Down),
        _ => Err(format!("unknown ScrollDirection variant: {:?}", value)),
    }
}

pub fn batch_crawl(engine: CrawlEngineHandle, urls: Vec<String>) -> Result<BatchCrawlResults, String> {
    let __alef_task = crate::__alef_tokio_runtime().spawn(async move {
    ...
    crate::__alef_tokio_runtime()
        .block_on(__alef_task)
        .unwrap_or_else(|__alef_join_error| Err(format!("alef: spawned async task failed: {__alef_join_error}")))
}
...
pub fn content_filter_kind_from_json(json: String) -> Result<ContentFilterKind, String> {
    serde_json::from_str::<crawlberg::ContentFilterKind>(&json)
        .map(ContentFilterKind::from)
        .map_err(|e| e.to_string())
}
...
pub fn crawl_strategy_kind_from_json(json: String) -> Result<CrawlStrategyKind, String> {
    serde_json::from_str::<crawlberg::CrawlStrategyKind>(&json)
        .map(CrawlStrategyKind::from)
        .map_err(|e| e.to_string())
}
...
pub fn host_matcher_from_json(json: String) -> Result<HostMatcher, String> {
    serde_json::from_str::<crawlberg::HostMatcher>(&json)
        .map(HostMatcher::from)
        .map_err(|e| e.to_string())
}
