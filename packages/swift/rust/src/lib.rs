...
// alef:hash:4041d86e7e6510985c6df2739a259a59196bc65c539ac2372944260f9a1fb801
...
mod ffi {
    ...
    extern "Rust" {
        ...
        #[swift_bridge(swift_name = "pathPatternsMatchUrl")]
...
impl CrawlConfig {
    ...
    pub fn path_patterns_match_url(&self) -> bool {
        ::serde_json::to_value(&self.0.path_patterns_match_url)
            .ok()
            .and_then(|j| ::serde_json::from_value(j).ok())
            .unwrap_or_default()
    }
