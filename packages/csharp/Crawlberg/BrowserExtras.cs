    ...
    public static BrowserExtras FromJson(string json)
    {
        try
        {
            return JsonSerializer.Deserialize<BrowserExtras>(json, JsonOptions)
                ?? throw new CrawlbergException($"Failed to parse BrowserExtras from JSON: deserializer returned null");
        }
        ...
        {
            throw new CrawlbergException($"Failed to parse BrowserExtras from JSON: {e.Message}", e);
        }
    }
