...
// alef:hash:0194719d9e327f562df93c20790c970ec58af94efed46a5e7f4b59f6dca56093
...
public sealed record ScrapeResult
{
    ...
    public PageMetadata Metadata { get; init; } = new PageMetadata();
    ...
    public string? ScreenshotBase64 { get; init; } = null;
    ...
    public BrowserExtras? Browser { get; init; } = null;
    ...
    public static ScrapeResult FromJson(string json)
    {
        try
        {
            return JsonSerializer.Deserialize<ScrapeResult>(json, JsonOptions)
                ?? throw new CrawlbergException($"Failed to parse ScrapeResult from JSON: deserializer returned null");
        }
        ...
        {
            throw new CrawlbergException($"Failed to parse ScrapeResult from JSON: {e.Message}", e);
        }
    }
