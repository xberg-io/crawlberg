...
// alef:hash:9999686923ecafaab8baad7ae7a170fea6923326cf6f55b3052d35b5c1209c5f
    ...
    public static CrawlStreamRequest FromJson(string json)
    {
        try
        {
            return JsonSerializer.Deserialize<CrawlStreamRequest>(json, JsonOptions)
                ?? throw new CrawlbergException($"Failed to parse CrawlStreamRequest from JSON: deserializer returned null");
        }
        ...
        {
            throw new CrawlbergException($"Failed to parse CrawlStreamRequest from JSON: {e.Message}", e);
        }
    }
