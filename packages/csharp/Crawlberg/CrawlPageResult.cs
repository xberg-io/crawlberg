...
// alef:hash:dc7ed60ab90f92aef09abef1cd95a6087d84ed72a4939a59a5b3b587ac5b55bd
    ...
    try {
      return JsonSerializer.Deserialize<CrawlPageResult>(json, JsonOptions) ??
             throw new CrawlbergException(
                 $"Failed to parse CrawlPageResult from JSON: deserializer returned null");
    } catch (CrawlbergException) {
      throw;
    } catch (Exception e) {
      throw new CrawlbergException(
          $"Failed to parse CrawlPageResult from JSON: {e.Message}", e);
    }
  }
