...
// alef:hash:6d4b3ea76abb24242407f152dd9dfec6152f36c18d18d583110cc0b776d55853
...
public sealed record DownloadedDocument
{
    ...
    public bool Truncated { get; init; } = false;
    ...
    public static DownloadedDocument FromJson(string json)
    {
        try
        {
            return JsonSerializer.Deserialize<DownloadedDocument>(json, JsonOptions)
                ?? throw new CrawlbergException($"Failed to parse DownloadedDocument from JSON: deserializer returned null");
        }
        ...
        {
            throw new CrawlbergException($"Failed to parse DownloadedDocument from JSON: {e.Message}", e);
        }
    }
