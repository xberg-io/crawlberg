...
// alef:hash:a3acf80f2fe7fbd947c23d4bf8a87a11f5cb2932b64ef458f0620bc80f0db272
...
public sealed class CrawlEventJsonConverter : JsonConverter<CrawlEvent>
{
    public override CrawlEvent Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        {
            "page" =>
                JsonSerializer.Deserialize<CrawlEvent.Page>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),
            "error" =>
                JsonSerializer.Deserialize<CrawlEvent.Error>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),
            "complete" =>
