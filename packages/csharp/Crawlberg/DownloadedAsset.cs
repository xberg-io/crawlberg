...
// alef:hash:677c4974097b1695821df99f997397b4e09bbb3973d394371a0ee971459224a7
...
public sealed record DownloadedAsset
{
    ...
    public AssetCategory AssetCategory { get; init; } = AssetCategory.Image;
    ...
    public static DownloadedAsset FromJson(string json)
    {
        try
        {
            return JsonSerializer.Deserialize<DownloadedAsset>(json, JsonOptions)
                ?? throw new CrawlbergException($"Failed to parse DownloadedAsset from JSON: deserializer returned null");
        }
        ...
        {
            throw new CrawlbergException($"Failed to parse DownloadedAsset from JSON: {e.Message}", e);
        }
    }
