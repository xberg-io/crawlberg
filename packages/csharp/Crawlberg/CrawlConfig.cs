...
// alef:hash:82e8c837e010d3075967edfd78b836e9b9b296dfa5613745cec2395f0c5ef18b
...
public sealed record CrawlConfig
{
    ...
    /// </summary>
    [JsonPropertyName("path_patterns_match_query")]
    public bool PathPatternsMatchQuery { get; init; } = false;
    ...
    /// </summary>
    [JsonPropertyName("path_patterns_match_url")]
    public bool PathPatternsMatchUrl { get; init; } = false;
    ...
    /// </summary>
    [JsonPropertyName("dedup_include_query")]
    public bool DedupIncludeQuery { get; init; } = false;
    ...
    /// </summary>
    [JsonPropertyName("strip_tracking_params")]
    public bool StripTrackingParams { get; init; } = false;
    ...
    /// enabled.
    /// </summary>
    [JsonPropertyName("tracking_params")]
    public List<string> TrackingParams { get; init; } = ["utm_*", "fbclid", "gclid", "ref"];
    ...
    /// </summary>
    [JsonPropertyName("retry_initial_delay_ms")]
    public ulong RetryInitialDelayMs { get; init; } = 100;

    /// <summary>
    /// Upper bound, in milliseconds, on the exponential retry backoff. Defaults to 60s.
    /// </summary>
    [JsonPropertyName("retry_max_delay_ms")]
    public ulong RetryMaxDelayMs { get; init; } = 60000;
    ...
    /// </summary>
    [JsonPropertyName("rate_limit_jitter_ratio")]
    public double RateLimitJitterRatio { get; init; } = 0.0;
    ...
    public static CrawlConfig FromJson(string json)
    {
        try
        {
            return JsonSerializer.Deserialize<CrawlConfig>(json, JsonOptions)
                ?? throw new CrawlbergException($"Failed to parse CrawlConfig from JSON: deserializer returned null");
        }
        ...
        {
            throw new CrawlbergException($"Failed to parse CrawlConfig from JSON: {e.Message}", e);
        }
    }
    ...
    public static CrawlConfig Default()
    {
        ...
        return JsonSerializer.Deserialize<CrawlConfig>(json ?? "null", JsonOptions)!;
    }
}
