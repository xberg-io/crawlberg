...
public sealed class PageActionJsonConverter : JsonConverter<PageAction>
{
    ...
    public override void Write(Utf8JsonWriter writer, PageAction value, JsonSerializerOptions options)
    {
        ...
        {            case PageAction.Click v_click:
                tag = "click";                inner = v_click;                break;            case PageAction.TypeText v_typetext:
                tag = "type";                inner = v_typetext;                break;            case PageAction.Press v_press:
                tag = "press";                inner = v_press;                break;            case PageAction.Scroll v_scroll:
                tag = "scroll";                inner = v_scroll;                break;            case PageAction.Wait v_wait:
                tag = "wait";                inner = v_wait;                break;            case PageAction.Screenshot v_screenshot:
                tag = "screenshot";                inner = v_screenshot;                break;            case PageAction.ExecuteJs v_executejs:
                tag = "executeJs";                inner = v_executejs;                break;            case PageAction.Scrape _:
                tag = "scrape";
                inner = null;
                break;            default:
