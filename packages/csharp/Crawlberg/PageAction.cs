...
// alef:hash:4d90296f9ed49b4f0c799623bff949ce8be116736763a81ccfba11424ca97eb2
...
public sealed class PageActionJsonConverter : JsonConverter<PageAction>
{
    public override PageAction Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        {
            "click" =>
                JsonSerializer.Deserialize<PageAction.Click>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),
            "type" =>
                JsonSerializer.Deserialize<PageAction.TypeText>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),
            "press" =>
                JsonSerializer.Deserialize<PageAction.Press>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),
            "scroll" =>
                JsonSerializer.Deserialize<PageAction.Scroll>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),
            "wait" =>
                JsonSerializer.Deserialize<PageAction.Wait>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),
            "screenshot" =>
                JsonSerializer.Deserialize<PageAction.Screenshot>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),
            "executeJs" =>
                JsonSerializer.Deserialize<PageAction.ExecuteJs>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),
            "scrape" =>
                new PageAction.Scrape(),
