...
// alef:hash:71c3391720deb0ced0a62e3a2a2913417d4c1f2c22dd44e0d7fc10ffd1d53ccf
...
public sealed record ContentConfig
{
    ...
    public static ContentConfig FromJson(string json)
    {
        try
        {
            return JsonSerializer.Deserialize<ContentConfig>(json, JsonOptions)
                ?? throw new CrawlbergException($"Failed to parse ContentConfig from JSON: deserializer returned null");
        }
        ...
        {
            throw new CrawlbergException($"Failed to parse ContentConfig from JSON: {e.Message}", e);
        }
    }
    ...
    public static ContentConfig Default()
    {
        ...
        return JsonSerializer.Deserialize<ContentConfig>(json ?? "null", JsonOptions)!;
    }
}
