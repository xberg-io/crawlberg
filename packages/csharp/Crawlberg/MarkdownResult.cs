...
// alef:hash:b86420a0dcfb46c9e73a84fd3cf233d8896e972eb91ba03de7258902fed9191a
...
public sealed record MarkdownResult
{
    ...
    public List<JsonElement> Tables { get; init; } = [];
    ...
    public static MarkdownResult FromJson(string json)
    {
        try
        {
            return JsonSerializer.Deserialize<MarkdownResult>(json, JsonOptions)
                ?? throw new CrawlbergException($"Failed to parse MarkdownResult from JSON: deserializer returned null");
        }
        ...
        {
            throw new CrawlbergException($"Failed to parse MarkdownResult from JSON: {e.Message}", e);
        }
    }
