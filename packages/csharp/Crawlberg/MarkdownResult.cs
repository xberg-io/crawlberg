...
// alef:hash:11e3570b677b83f334274e138bf943894891f4f6957ec9497addb4c99dc42cbc
...
public sealed record MarkdownResult {
  ...
  public List<JsonElement> Tables {
    get; init;
  } = [];
  ...
  /// <summary>
  /// Whether citation conversion was applied and produced at least one
  /// reference.
  ///
    ...
    try {
      return JsonSerializer.Deserialize<MarkdownResult>(json, JsonOptions) ??
             throw new CrawlbergException(
                 $"Failed to parse MarkdownResult from JSON: deserializer returned null");
    } catch (CrawlbergException) {
      throw;
    } catch (Exception e) {
      throw new CrawlbergException(
          $"Failed to parse MarkdownResult from JSON: {e.Message}", e);
    }
  }
