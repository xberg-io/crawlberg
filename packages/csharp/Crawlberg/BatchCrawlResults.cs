...
public sealed record BatchCrawlResults
{
    ...
    public static BatchCrawlResults FromJson(string json)
    {
        try
        {
            ...
            ?? throw new CrawlbergException($"Failed to parse BatchCrawlResults from JSON: deserializer returned null");
        }
        ...
        {
            throw new CrawlbergException($"Failed to parse BatchCrawlResults from JSON: {e.Message}", e);
        }
    }
