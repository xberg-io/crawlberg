...
public record
CrawlResult(@JsonProperty("pages") List<CrawlPageResult> pages,
  ...
  public static final class Builder {
    ...
    @JsonProperty("redirect_count") private long redirectCount;
    ...
    public CrawlResult build() {
      return new CrawlResult(pages, finalUrl, redirectCount, wasSkipped, error,
                             cookies, stayedOnDomain, browserUsed);
    }
  }
  // CPD-ON
}
