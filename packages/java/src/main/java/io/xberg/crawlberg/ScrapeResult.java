...
public record ScrapeResult(
  ...
  public static final class Builder {
    ...
    @JsonProperty("final_url") private String finalUrl;
    ...
    @JsonProperty("is_allowed") private boolean isAllowed;
    @JsonProperty("crawl_delay") @Nullable private Long crawlDelay;
    @JsonProperty("noindex_detected") private boolean noindexDetected;
    @JsonProperty("nofollow_detected") private boolean nofollowDetected;
    @JsonProperty("x_robots_tag") @Nullable private String xRobotsTag;
    ...
    @JsonProperty("auth_header_sent") private boolean authHeaderSent;
    @JsonProperty("response_meta") @Nullable private ResponseMeta responseMeta;
    private List<DownloadedAsset> assets = List.of();
    @JsonProperty("js_render_hint") private boolean jsRenderHint;
    ...
    public ScrapeResult build() {
      return new ScrapeResult(
          statusCode, finalUrl, contentType, html, bodySize, metadata, links,
          images, feeds, jsonLd, isAllowed, crawlDelay, noindexDetected,
          nofollowDetected, xRobotsTag, isPdf, wasSkipped, detectedCharset,
          authHeaderSent, responseMeta, assets, jsRenderHint, browserUsed,
          markdown, extractedData, extractionMeta, screenshotBase64,
          downloadedDocument, browser);
    }
  }
  // CPD-ON
}
