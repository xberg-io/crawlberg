...
// alef:hash:36df2fe8365fc491868bde98690f2f1e127a083920d05cd828c8d6f850d16c2a
...
public record CrawlPageResult(
    ...
    @JsonProperty("html") String html, @JsonProperty("body_size") long bodySize,
    ...
    @Nullable @JsonProperty("downloaded_document")
    DownloadedDocument downloadedDocument,
    @JsonProperty("browser_used") boolean browserUsed,
    @Nullable @JsonProperty("final_url") String finalUrl,
    @Nullable @JsonProperty("redirect_count") Long redirectCount,
    @Nullable @JsonProperty("noindex_detected") Boolean noindexDetected,
    @Nullable @JsonProperty("nofollow_detected") Boolean nofollowDetected) {
  ...
  public static final class Builder {
    ...
    private String url;
    @JsonProperty("normalized_url") private String normalizedUrl;
    @JsonProperty("status_code") private short statusCode;
    @JsonProperty("content_type") private String contentType;
    private String html;
    @JsonProperty("body_size") private long bodySize;
    private PageMetadata metadata;
    private List<LinkInfo> links = List.of();
    private List<ImageInfo> images = List.of();
    private List<FeedInfo> feeds = List.of();
    @JsonProperty("json_ld") private List<JsonLdEntry> jsonLd = List.of();
    private long depth;
    @JsonProperty("stayed_on_domain") private boolean stayedOnDomain;
    @JsonProperty("was_skipped") private boolean wasSkipped;
    @JsonProperty("is_pdf") private boolean isPdf;
    @JsonProperty("detected_charset") @Nullable private String detectedCharset;
    @Nullable private MarkdownResult markdown;
    @JsonProperty("extracted_data") @Nullable private Object extractedData;
    ...
    @JsonProperty("browser_used") private boolean browserUsed;
    @JsonProperty("final_url") @Nullable private String finalUrl;
    @JsonProperty("redirect_count") @Nullable private Long redirectCount;
    @JsonProperty("noindex_detected") @Nullable private Boolean noindexDetected;
    ...
    @JsonProperty("downloaded_document")
    public Builder withDownloadedDocument(final
                                          @Nullable DownloadedDocument value) {
    ...
    public Builder withFinalUrl(final @Nullable String value) {
      this.finalUrl = value;
      return this;
    }
    ...
    public Builder withRedirectCount(final @Nullable Long value) {
    ...
    public Builder withNoindexDetected(final @Nullable Boolean value) {
    ...
    @JsonProperty("nofollow_detected")
    public Builder withNofollowDetected(final @Nullable Boolean value) {
    ...
    public CrawlPageResult build() {
      return new CrawlPageResult(
          url, normalizedUrl, statusCode, contentType, html, bodySize, metadata,
          links, images, feeds, jsonLd, depth, stayedOnDomain, wasSkipped,
          isPdf, detectedCharset, markdown, extractedData, extractionMeta,
          downloadedDocument, browserUsed, finalUrl, redirectCount,
          noindexDetected, nofollowDetected);
    }
  }
  // CPD-ON
}
