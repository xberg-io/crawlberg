...
public record ExtractionMeta(
  ...
  public static final class Builder {
    ...
    @JsonProperty("prompt_tokens") @Nullable private Long promptTokens;
    @JsonProperty("completion_tokens") @Nullable private Long completionTokens;
    @Nullable private String model;
    @JsonProperty("chunks_processed") private long chunksProcessed;
    ...
    public ExtractionMeta build() {
      return new ExtractionMeta(cost, promptTokens, completionTokens, model,
                                chunksProcessed);
    }
  }
  // CPD-ON
