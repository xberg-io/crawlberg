...
public record FeedInfo(@JsonProperty("url") String url,
  ...
  public static final class Builder {
    ...
    @JsonProperty("feed_type") private FeedType feedType;
    ...
    public FeedInfo build() { return new FeedInfo(url, title, feedType); }
  }
  // CPD-ON
}
