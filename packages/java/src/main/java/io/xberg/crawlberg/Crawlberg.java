...
public final class Crawlberg {
  ...
  public static java.util.stream.Stream<CrawlEvent>
  crawlStream(final CrawlEngineHandle engine, final CrawlStreamRequest req)
      throws CrawlbergRsException {
    return engine.crawlStream(req);
  }

  public static java.util.stream.Stream<CrawlEvent>
  batchCrawlStream(final CrawlEngineHandle engine,
