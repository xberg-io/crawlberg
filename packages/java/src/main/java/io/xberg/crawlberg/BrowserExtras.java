 ...
 *
 * Available on {@code ScrapeResult.browser} when {@code BrowserBackend.Native}
 * handled the request.
 */
...
public record BrowserExtras(
  ...
  public static final class Builder {
    ...
    @JsonProperty("eval_result") @Nullable private Object evalResult;
    @JsonProperty("network_events")
    @Nullable
    private List<ResponseMeta> networkEvents;
    @Nullable private List<CookieInfo> cookies;
