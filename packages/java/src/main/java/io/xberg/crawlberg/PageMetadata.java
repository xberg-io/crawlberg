...
/**
 * Metadata extracted from an HTML page's {@code &lt;meta&gt;} tags and {@code
 * &lt;title&gt;} element.
 */
...
public record PageMetadata(
    ...
    @Nullable @JsonProperty("og_locale_alternates")
    List<String> ogLocaleAlternates,
  ...
  public static final class Builder {
    ...
    @JsonProperty("theme_color") @Nullable private String themeColor;
    @Nullable private String generator;
    @Nullable private String robots;
    @JsonProperty("html_lang") @Nullable private String htmlLang;
    @JsonProperty("html_dir") @Nullable private String htmlDir;
    @JsonProperty("og_title") @Nullable private String ogTitle;
    @JsonProperty("og_type") @Nullable private String ogType;
    @JsonProperty("og_image") @Nullable private String ogImage;
    @JsonProperty("og_description") @Nullable private String ogDescription;
    @JsonProperty("og_url") @Nullable private String ogUrl;
    @JsonProperty("og_site_name") @Nullable private String ogSiteName;
    @JsonProperty("og_locale") @Nullable private String ogLocale;
    @JsonProperty("og_video") @Nullable private String ogVideo;
    @JsonProperty("og_audio") @Nullable private String ogAudio;
    @JsonProperty("og_locale_alternates")
    @Nullable
    private List<String> ogLocaleAlternates;
    @JsonProperty("twitter_card") @Nullable private String twitterCard;
    @JsonProperty("twitter_title") @Nullable private String twitterTitle;
    @JsonProperty("twitter_description")
    @Nullable
    private String twitterDescription;
    @JsonProperty("twitter_image") @Nullable private String twitterImage;
    @JsonProperty("twitter_site") @Nullable private String twitterSite;
    @JsonProperty("twitter_creator") @Nullable private String twitterCreator;
    @JsonProperty("dc_title") @Nullable private String dcTitle;
    @JsonProperty("dc_creator") @Nullable private String dcCreator;
    @JsonProperty("dc_subject") @Nullable private String dcSubject;
    @JsonProperty("dc_description") @Nullable private String dcDescription;
    @JsonProperty("dc_publisher") @Nullable private String dcPublisher;
    @JsonProperty("dc_date") @Nullable private String dcDate;
    @JsonProperty("dc_type") @Nullable private String dcType;
    @JsonProperty("dc_format") @Nullable private String dcFormat;
    @JsonProperty("dc_identifier") @Nullable private String dcIdentifier;
    @JsonProperty("dc_language") @Nullable private String dcLanguage;
    @JsonProperty("dc_rights") @Nullable private String dcRights;
    ...
    @JsonProperty("word_count") @Nullable private Long wordCount;
    ...
    public PageMetadata build() {
      return new PageMetadata(
          title, description, canonicalUrl, keywords, author, viewport,
          themeColor, generator, robots, htmlLang, htmlDir, ogTitle, ogType,
          ogImage, ogDescription, ogUrl, ogSiteName, ogLocale, ogVideo, ogAudio,
          ogLocaleAlternates, twitterCard, twitterTitle, twitterDescription,
          twitterImage, twitterSite, twitterCreator, dcTitle, dcCreator,
          dcSubject, dcDescription, dcPublisher, dcDate, dcType, dcFormat,
          dcIdentifier, dcLanguage, dcRights, article, hreflangs, favicons,
          headings, wordCount);
    }
  }
  // CPD-ON
