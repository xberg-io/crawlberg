...
public record
ArticleMetadata(@Nullable @JsonProperty("published_time") String publishedTime,
  ...
  public static final class Builder {
    ...
    @JsonProperty("published_time") @Nullable private String publishedTime;
    @JsonProperty("modified_time") @Nullable private String modifiedTime;
    ...
    public ArticleMetadata build() {
      return new ArticleMetadata(publishedTime, modifiedTime, author, section,
                                 tags);
    }
  }
  // CPD-ON
