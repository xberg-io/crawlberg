...
public record
DownloadedAsset(@JsonProperty("url") String url,
  ...
  public static final class Builder {
    ...
    private long size;
    @JsonProperty("asset_category") private AssetCategory assetCategory;
    @JsonProperty("html_tag") @Nullable private String htmlTag;
    ...
    public DownloadedAsset build() {
      return new DownloadedAsset(url, contentHash, mimeType, size,
                                 assetCategory, htmlTag);
    }
  }
  // CPD-ON
}
