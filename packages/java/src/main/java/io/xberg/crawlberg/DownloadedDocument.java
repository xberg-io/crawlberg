...
// alef:hash:40b7c664ef289c160b1e9a1250983ac32ddfdb34fc1e0575ba490c4bb31c4bd4
...
public record DownloadedDocument(
  ...
  public static final class Builder {
    ...
    @JsonProperty("content_hash") private String contentHash;
    @Nullable private Map<String, String> headers = Map.of();
    @Nullable private Boolean truncated;
    @JsonProperty("content_path") @Nullable private String contentPath;
    @JsonProperty("content_base64") @Nullable private String contentBase64;
    ...
    /**
     * Constructs a DownloadedDocument instance from the builder's current
     * state.
     */
    public DownloadedDocument build() {
      return new DownloadedDocument(url, mimeType, size, filename, contentHash,
                                    headers, truncated, contentPath,
                                    contentBase64);
    }
  }
  // CPD-ON
