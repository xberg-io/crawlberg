...
// alef:hash:2e23048b1fbfa10b2aa0299d728dd2b62cceec2f0e3e9597e99a4dd4fc9c2b38
...
impl CrawlConfig {
    fn new(args: &[magnus::Value]) -> Result<Self, magnus::Error> {
        ...
        Ok(Self {
            ...
            path_patterns_match_url: match kwargs.get(ruby.to_symbol("path_patterns_match_url")) {
                Some(v) => bool::try_convert(v).map_err(|e| {
                    magnus::Error::new(
                        unsafe { magnus::Ruby::get_unchecked() }.exception_type_error(),
                        format!("invalid value for `path_patterns_match_url`: {}", e),
                    )
                })?,
                None => false,
            },
    ...
    fn path_patterns_match_url(&self) -> bool {
...
fn ruby_init(ruby: &Ruby) -> Result<(), Error> {
    ...
    class.define_method(
        ...
        method!(CrawlConfig::path_patterns_match_url, 0),
    )?;
