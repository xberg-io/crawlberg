...
// alef:hash:175065d88523e4b3c983ed4673038ba17d802016cbe1a3664c606037b73913bb
...
impl BrowserConfig {
    fn new(args: &[magnus::Value]) -> Result<Self, magnus::Error> {
        ...
        Ok(Self {
            ...
            overall_timeout: match kwargs.get(ruby.to_symbol("overall_timeout")) {
                Some(v) => u64::try_convert(v).map_err(|e| {
                    magnus::Error::new(
                        unsafe { magnus::Ruby::get_unchecked() }.exception_type_error(),
                        format!("invalid value for `overall_timeout`: {}", e),
                    )
                })?,
                None => 60000,
            },
            ...
            chrome_path: match kwargs.get(ruby.to_symbol("chrome_path")).filter(|v| !v.is_nil()) {
                Some(v) => Some(String::try_convert(v).map_err(|e| {
                    magnus::Error::new(
                        unsafe { magnus::Ruby::get_unchecked() }.exception_type_error(),
                        format!("invalid value for `chrome_path`: {}", e),
                    )
                })?),
                None => None,
            },
            chrome_args: match kwargs.get(ruby.to_symbol("chrome_args")) {
                Some(v) => <Vec<String>>::try_convert(v).map_err(|e| {
                    magnus::Error::new(
                        unsafe { magnus::Ruby::get_unchecked() }.exception_type_error(),
                        format!("invalid value for `chrome_args`: {}", e),
                    )
                })?,
                None => Default::default(),
            },
    ...
    fn chrome_path(&self) -> Option<String> {
...
impl CrawlConfig {
    fn new(args: &[magnus::Value]) -> Result<Self, magnus::Error> {
        ...
        Ok(Self {
            ...
            path_patterns_match_query: match kwargs.get(ruby.to_symbol("path_patterns_match_query")) {
                Some(v) => bool::try_convert(v).map_err(|e| {
                    magnus::Error::new(
                        unsafe { magnus::Ruby::get_unchecked() }.exception_type_error(),
                        format!("invalid value for `path_patterns_match_query`: {}", e),
                    )
                })?,
                None => false,
            },
            dedup_include_query: match kwargs.get(ruby.to_symbol("dedup_include_query")) {
                Some(v) => bool::try_convert(v).map_err(|e| {
                    magnus::Error::new(
                        unsafe { magnus::Ruby::get_unchecked() }.exception_type_error(),
                        format!("invalid value for `dedup_include_query`: {}", e),
                    )
                })?,
                None => false,
            },
            strip_tracking_params: match kwargs.get(ruby.to_symbol("strip_tracking_params")) {
                Some(v) => bool::try_convert(v).map_err(|e| {
                    magnus::Error::new(
                        unsafe { magnus::Ruby::get_unchecked() }.exception_type_error(),
                        format!("invalid value for `strip_tracking_params`: {}", e),
                    )
                })?,
                None => false,
            },
            tracking_params: match kwargs.get(ruby.to_symbol("tracking_params")) {
                Some(v) => <Vec<String>>::try_convert(v).map_err(|e| {
                    magnus::Error::new(
                        unsafe { magnus::Ruby::get_unchecked() }.exception_type_error(),
                        format!("invalid value for `tracking_params`: {}", e),
                    )
                })?,
                None => vec![
                    "utm_*".to_string(),
            ...
            retry_initial_delay_ms: match kwargs.get(ruby.to_symbol("retry_initial_delay_ms")) {
                Some(v) => u64::try_convert(v).map_err(|e| {
                    magnus::Error::new(
                        unsafe { magnus::Ruby::get_unchecked() }.exception_type_error(),
                        format!("invalid value for `retry_initial_delay_ms`: {}", e),
                    )
                })?,
                None => 100,
            },
            retry_max_delay_ms: match kwargs.get(ruby.to_symbol("retry_max_delay_ms")) {
                Some(v) => u64::try_convert(v).map_err(|e| {
                    magnus::Error::new(
                        unsafe { magnus::Ruby::get_unchecked() }.exception_type_error(),
                        format!("invalid value for `retry_max_delay_ms`: {}", e),
                    )
                })?,
                None => 60000,
            },
            rate_limit_jitter_ratio: match kwargs.get(ruby.to_symbol("rate_limit_jitter_ratio")) {
                Some(v) => f64::try_convert(v).map_err(|e| {
                    magnus::Error::new(
                        unsafe { magnus::Ruby::get_unchecked() }.exception_type_error(),
                        format!("invalid value for `rate_limit_jitter_ratio`: {}", e),
                    )
                })?,
                None => 0.0,
            },
    ...
    fn path_patterns_match_query(&self) -> bool {
        self.path_patterns_match_query
    }

    fn dedup_include_query(&self) -> bool {
        self.dedup_include_query
    }

    fn strip_tracking_params(&self) -> bool {
        self.strip_tracking_params
    }

    fn tracking_params(&self) -> Vec<String> {
    ...
    fn retry_initial_delay_ms(&self) -> u64 {
    ...
    fn rate_limit_jitter_ratio(&self) -> f64 {
...
impl<'de> serde::Deserialize<'de> for CrawlPageResult {
    fn deserialize<D>(deserializer: D) -> ::core::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
...
impl From<BrowserConfig> for crawlberg::BrowserConfig {
    fn from(val: BrowserConfig) -> Self {
        Self {
            ...
            overall_timeout: std::time::Duration::from_millis(val.overall_timeout),
            shutdown_timeout: std::time::Duration::from_millis(val.shutdown_timeout),
            wait: val.wait.into(),
...
impl From<crawlberg::BrowserConfig> for BrowserConfig {
    fn from(val: crawlberg::BrowserConfig) -> Self {
        Self {
            ...
            overall_timeout: val.overall_timeout.as_millis() as u64,
            shutdown_timeout: val.shutdown_timeout.as_millis() as u64,
            wait: val.wait.into(),
...
fn ruby_init(ruby: &Ruby) -> Result<(), Error> {
    ...
    class.define_method("overall_timeout", method!(BrowserConfig::overall_timeout, 0))?;

    class.define_method("shutdown_timeout", method!(BrowserConfig::shutdown_timeout, 0))?;
    ...
    class.define_method("chrome_path", method!(BrowserConfig::chrome_path, 0))?;

    class.define_method("chrome_args", method!(BrowserConfig::chrome_args, 0))?;
    ...
    class.define_method("extract_metadata", method!(ContentConfig::extract_metadata, 0))?;
    ...
    class.define_method(
        ...
        method!(CrawlConfig::path_patterns_match_query, 0),
    )?;

    class.define_method("dedup_include_query", method!(CrawlConfig::dedup_include_query, 0))?;

    class.define_method("strip_tracking_params", method!(CrawlConfig::strip_tracking_params, 0))?;

    class.define_method("tracking_params", method!(CrawlConfig::tracking_params, 0))?;
    ...
    class.define_method(
        ...
        method!(CrawlConfig::retry_initial_delay_ms, 0),
    )?;

    class.define_method("retry_max_delay_ms", method!(CrawlConfig::retry_max_delay_ms, 0))?;

    class.define_method(
        "rate_limit_jitter_ratio",
        method!(CrawlConfig::rate_limit_jitter_ratio, 0),
    )?;
    ...
    class.define_method("final_url", method!(CrawlPageResult::final_url, 0))?;

    class.define_method("redirect_count", method!(CrawlPageResult::redirect_count, 0))?;

    class.define_method("noindex_detected", method!(CrawlPageResult::noindex_detected, 0))?;

    class.define_method("nofollow_detected", method!(CrawlPageResult::nofollow_detected, 0))?;
