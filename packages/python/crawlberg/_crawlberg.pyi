...
# alef:hash:672f65b92be7ee768280be754a8932571fb3b326196f9c416bd614aa9dc29f4b
...
class JsonLdEntry:
    ...
    name: str | None
    raw: str
    def __init__(self, schema_type: str = ..., name: str | None = None, raw: str = ...) -> None: ...
    @staticmethod
...
class CrawlEngineHandle:
    def crawl_stream(self, req: CrawlStreamRequest) -> AsyncIterator[CrawlEvent]: ...
    def batch_crawl_stream(self, req: BatchCrawlStreamRequest) -> AsyncIterator[CrawlEvent]: ...
...
class CrawlEvent:
    type: str
    @staticmethod
    def page(result: options.CrawlPageResult | dict[str, Any]) -> CrawlEvent: ...
    @staticmethod
    def error(url: str, error: str) -> CrawlEvent: ...
    @staticmethod
    def complete(pages_crawled: int) -> CrawlEvent: ...
    def __init__(self, value: dict[str, Any] | str | None = None, **kwargs: Any) -> None: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
...
class PageAction:
    type: str
    @staticmethod
    def click(selector: str) -> PageAction: ...
    @staticmethod
    def type_text(selector: str, text: str) -> PageAction: ...
    @staticmethod
    def press(key: str) -> PageAction: ...
    @staticmethod
    def scroll(direction: ScrollDirection, selector: str | None = None, amount: int | None = None) -> PageAction: ...
    @staticmethod
    def wait(milliseconds: int | None = None, selector: str | None = None) -> PageAction: ...
    @staticmethod
    def screenshot(full_page: bool | None = None) -> PageAction: ...
    @staticmethod
    def execute_js(script: str) -> PageAction: ...
    def __init__(self, value: dict[str, Any] | str | None = None, **kwargs: Any) -> None: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
...
class InvalidCidrError(SsrfError): ...
