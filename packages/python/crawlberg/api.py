...
# alef:hash:c88e89635e1ee83949feafac64985eeea8ce7853e15a3704ff2dc113a8fc9fc4
...
def _to_rust_crawl_config(value: CrawlConfig | dict[str, Any] | str | None) -> _rust.CrawlConfig | None:
    ...
    return _rust.CrawlConfig(
        ...
        **({"content_filter": _coerce_enum(_rust.ContentFilterKind, value.content_filter)} if value.content_filter is not None else {}),
