...
pub const CrawlEventStream = struct {
    ...
    pub fn next(self: *CrawlEventStream) (CrawlError||error{OutOfMemory})!?CrawlEvent {
        const _chunk = c.cberg_crawl_engine_handle_crawl_stream_next(self._handle);
        if (_chunk == null) {
    ...
    pub fn deinit(self: *CrawlEventStream) void {
        c.cberg_crawl_engine_handle_crawl_stream_free(self._handle);
    }
};
...
pub const CrawlEngineHandle = struct {
    ...
    pub fn crawl_stream(self: *CrawlEngineHandle, req: []const u8) (CrawlError||error{OutOfMemory})!CrawlEventStream {
        ...
        const _stream_handle = c.cberg_crawl_engine_handle_crawl_stream_start(@as(*c.CBERGCrawlEngineHandle, @ptrCast(self._handle)), req_handle);
    ...
    pub fn batch_crawl_stream(self: *CrawlEngineHandle, req: []const u8) (CrawlError||error{OutOfMemory})!CrawlEventStream {
        ...
        const _stream_handle = c.cberg_crawl_engine_handle_batch_crawl_stream_start(@as(*c.CBERGCrawlEngineHandle, @ptrCast(self._handle)), req_handle);
        if (_stream_handle == null) { return _first_error(CrawlError); }
        return CrawlEventStream{ ._handle = _stream_handle };
    }
    ...
    pub fn free(self: *CrawlEngineHandle) void {
        c.cberg_crawl_engine_handle_free(@as(*c.CBERGCrawlEngineHandle, @ptrCast(self._handle)));
    }
};
