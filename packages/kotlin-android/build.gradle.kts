...
// alef:hash:c8005527cf71c8b48440f98ea31ab522aca242e189772bd4e4c84fe890336227
...
android {
    namespace = "io.xberg.crawlberg.android"
    compileSdk = 36
...
tasks.register("buildHostJni", Exec::class) {
    if (project.properties["alef.skipHostJni"] != "true") {
        ...
        val jniManifest = configuredManifest?.let(::file) ?: generateSequence(projectDir) { it.parentFile }
            .map { it.resolve("crates/crawlberg-jni/Cargo.toml") }
            .firstOrNull { it.isFile }
            ?: throw GradleException(
                "Cannot locate crates/crawlberg-jni/Cargo.toml from $projectDir; " +
...
tasks.register("copyHostJni", Copy::class) {
    if (project.properties["alef.skipHostJni"] != "true") {
        ...
        val jniManifest = configuredManifest?.let(::file) ?: generateSequence(projectDir) { it.parentFile }
            .map { it.resolve("crates/crawlberg-jni/Cargo.toml") }
            .firstOrNull { it.isFile }
            ?: throw GradleException("Cannot locate crates/crawlberg-jni/Cargo.toml from $projectDir")
...
tasks.register("validateJniLibsForRelease") {
    doFirst {
        ...
        if (releaseAssemble) {
            ...
            // lib*_ffi.so instead of libcberg_jni.so) passes the emptiness
            // check above but fails at runtime with UnsatisfiedLinkError, because
            // System.loadLibrary("cberg_jni") needs the JNI entry points.
            val expectedJniLib = "libcberg_jni.so"
            ...
            if (abisMissingJniLib.isNotEmpty()) {
                throw GradleException(
                    ...
                    "export the JNI symbols System.loadLibrary(\"cberg_jni\") requires and " +
...
mavenPublishing {
    ...
    pom {
        ...
        scm {
            url.set("https://github.com/xberg-io/crawlberg")
            connection.set("scm:git:git://github.com/xberg-io/crawlberg.git")
            developerConnection.set("scm:git:ssh://git@github.com:xberg-io/crawlberg.git")
        }
    }
}
