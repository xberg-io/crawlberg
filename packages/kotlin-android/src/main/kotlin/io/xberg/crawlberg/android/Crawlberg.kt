...
// alef:hash:c914c6b72541a35ab55a701aebbeff98546c9dd0ec389b5c709140fbd3b3a489
@file:Suppress(
...
object Crawlberg {
    ...
    fun interact(engine: CrawlEngineHandle, url: String, actions: List<PageAction>): InteractionResult {
        val resultJson = CrawlbergBridge.nativeInteract(engine.handle, url, mapper.writeValueAsString(actions))
