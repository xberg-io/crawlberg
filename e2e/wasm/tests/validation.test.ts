...
describe("validation", () => {
	...
	it("validation_browser_endpoint_invalid: Browser endpoint must be a valid ws:// or wss:// URL, not http://", async () => {
		await expect(async () => {
			...
			engineConfig.browser = (() => { const _u0 = WasmBrowserConfig.default(); _u0.endpoint = "http://not-websocket:3000"; _u0.mode = "always"; return _u0; })();
    ...
    expect((result.metadata.title ?? "").trim()).toBe("Allowlisted");
	}, 30000);
