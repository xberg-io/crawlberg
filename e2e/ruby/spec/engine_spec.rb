...
# alef:hash:8e72ac63e07a1160e12e994e2d45ffb464ef4eb8bef0abaad39039a39c705949
...
RSpec.describe 'engine' do
  ...
  it 'engine_stream_basic: CrawlEngine with defaults streams events like the free function' do
    ...
    skip 'alef rendered no runnable expectation for fixture `engine_stream_basic`: all 3 declared assertion(s) were skipped (see the markers above)'
  end
end
