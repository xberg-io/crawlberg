...
RSpec.describe "links" do
  it "links_anchor_fragment: Identifies fragment-only links as anchor type" do
    ...
    url = ENV.fetch("MOCK_SERVER_LINKS_ANCHOR_FRAGMENT", nil) ||
      "#{ENV.fetch("MOCK_SERVER_URL")}/fixtures/links_anchor_fragment"
  ...
  it "links_document_types: Detects PDF, DOCX, XLSX links as document type" do
    engine = Crawlberg.create_engine(nil)
    url = ENV.fetch("MOCK_SERVER_LINKS_DOCUMENT_TYPES", nil) ||
      "#{ENV.fetch("MOCK_SERVER_URL")}/fixtures/links_document_types"
    result = Crawlberg.scrape(engine, url)
