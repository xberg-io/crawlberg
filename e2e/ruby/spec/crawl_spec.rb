...
# alef:hash:1436e1eaeb738fedb85df9e80a9cb4d50c3fe50a814e73ab3d398864e2ac1888
...
RSpec.describe 'crawl' do
  ...
  it 'crawl_max_links_per_page: max_links_per_page caps the number of links enqueued from a single page' do
    engine_config = { 'max_links_per_page' => 2, 'max_pages' => 10, 'respect_robots_txt' => false }
    engine = Crawlberg.create_engine(engine_config.to_json)
    url = ENV.fetch('MOCK_SERVER_CRAWL_MAX_LINKS_PER_PAGE', nil) || "#{ENV.fetch('MOCK_SERVER_URL')}/fixtures/crawl_max_links_per_page"
    result = Crawlberg.crawl(engine, url)
    expect(result.pages.length).to be <= 3
