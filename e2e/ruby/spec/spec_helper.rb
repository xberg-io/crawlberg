...
# alef:hash:4446ad189a3e01299e770cd1cf584cc80e3bbed918b4f414f097327399afeda6
...
RSpec.configure do |config|
  config.before(:suite) do
    existing_url = ENV.fetch('MOCK_SERVER_URL', nil)
    if existing_url && !existing_url.empty?
      ...
      begin
        mock_servers_json = ENV.fetch('MOCK_SERVERS', nil)
