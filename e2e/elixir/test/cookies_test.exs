...
# alef:hash:87510469f16a433a25daf907f510a09c0d963bcafd273eec1c3a8c805ec826db
...
defmodule E2e.CookiesTest do
  ...
  describe "cookies_persistence" do
    test "cookies_persistence" do
      ...
      url =
        System.get_env("MOCK_SERVER_COOKIES_PERSISTENCE") || (System.get_env("MOCK_SERVER_URL") || "") <> "/fixtures/cookies_persistence"
  ...
  describe "cookies_set_cookie_response" do
    test "cookies_set_cookie_response" do
      ...
      url =
        System.get_env("MOCK_SERVER_COOKIES_SET_COOKIE_RESPONSE") ||
          (System.get_env("MOCK_SERVER_URL") || "") <> "/fixtures/cookies_set_cookie_response"
