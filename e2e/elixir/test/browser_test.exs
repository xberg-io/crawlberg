...
# alef:hash:bfcedd76017f4559f4c80de3acf4b1a98b9fe665885789f5513729f90c4929e8
...
defmodule E2e.BrowserTest do
  ...
  describe "browser_crawl_mode_always" do
    test "browser_crawl_mode_always" do
      ...
      url =
        System.get_env("MOCK_SERVER_BROWSER_CRAWL_MODE_ALWAYS") ||
          (System.get_env("MOCK_SERVER_URL") || "") <> "/fixtures/browser_crawl_mode_always"
  ...
  describe "browser_crawl_waf_fallback" do
    test "browser_crawl_waf_fallback" do
      ...
      url =
        System.get_env("MOCK_SERVER_BROWSER_CRAWL_WAF_FALLBACK") ||
          (System.get_env("MOCK_SERVER_URL") || "") <> "/fixtures/browser_crawl_waf_fallback"
