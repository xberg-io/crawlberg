...
# alef:hash:60de6e78b97cf85490e6328f4feecd60b807e2321f7e47d23784548a4d20543f
...
defmodule E2e.MapTest do
  ...
  describe "map_exclude_patterns" do
    test "map_exclude_patterns" do
      ...
      url =
        System.get_env("MOCK_SERVER_MAP_EXCLUDE_PATTERNS") || (System.get_env("MOCK_SERVER_URL") || "") <> "/fixtures/map_exclude_patterns"
  ...
  describe "map_include_subdomains" do
    test "map_include_subdomains" do
      ...
      url =
        System.get_env("MOCK_SERVER_MAP_INCLUDE_SUBDOMAINS") ||
          (System.get_env("MOCK_SERVER_URL") || "") <> "/fixtures/map_include_subdomains"
  ...
  describe "map_limit_pagination" do
    test "map_limit_pagination" do
      ...
      url =
        System.get_env("MOCK_SERVER_MAP_LIMIT_PAGINATION") || (System.get_env("MOCK_SERVER_URL") || "") <> "/fixtures/map_limit_pagination"
