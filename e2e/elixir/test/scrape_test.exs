...
# alef:hash:d084321e7f2d872fe4958cb7fc25f8f81fa9a2d772ba37b87bb50b99d5268a94
...
defmodule E2e.ScrapeTest do
  ...
  describe "scrape_basic_html_page" do
    test "scrape_basic_html_page" do
      ...
      assert result.metadata.og_title in [nil, "", [], %{}]
    end
  end
  ...
  describe "scrape_malformed_html" do
    test "scrape_malformed_html" do
      ...
      assert result.status_code == 200
      assert result.html not in [nil, "", [], %{}]
      assert String.contains?(to_string(result.metadata.title), "Malformed Page")
      assert result.metadata.description in [nil, "", [], %{}]
    end
  end
