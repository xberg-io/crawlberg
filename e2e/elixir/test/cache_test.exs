...
defmodule E2e.CacheTest do
  ...
  describe "cache_etag_conditional" do
    test "cache_etag_conditional" do
      ...
      url =
        System.get_env("MOCK_SERVER_CACHE_ETAG_CONDITIONAL") ||
          (System.get_env("MOCK_SERVER_URL") || "") <> "/fixtures/cache_etag_conditional"
  ...
  describe "cache_last_modified" do
    test "cache_last_modified" do
      ...
      url =
        System.get_env("MOCK_SERVER_CACHE_LAST_MODIFIED") || (System.get_env("MOCK_SERVER_URL") || "") <> "/fixtures/cache_last_modified"
  ...
  describe "cache_miss_fresh_fetch" do
    test "cache_miss_fresh_fetch" do
      ...
      url =
        System.get_env("MOCK_SERVER_CACHE_MISS_FRESH_FETCH") ||
          (System.get_env("MOCK_SERVER_URL") || "") <> "/fixtures/cache_miss_fresh_fetch"
