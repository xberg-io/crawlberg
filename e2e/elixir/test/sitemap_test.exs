...
# alef:hash:0c37f2c7acf58840a486d72a6303dc026121643df2537cee59c4641e04a51d70
...
defmodule E2e.SitemapTest do
  ...
  describe "sitemap_from_robots_txt" do
    test "sitemap_from_robots_txt" do
      ...
      url =
        System.get_env("MOCK_SERVER_SITEMAP_FROM_ROBOTS_TXT") ||
          (System.get_env("MOCK_SERVER_URL") || "") <> "/fixtures/sitemap_from_robots_txt"
