...
# alef:hash:e80375f1ddb5a3d1587d6aee8d4e647bf55e88f546f3a110f5e1c65b62db8a9d
...
defmodule E2e.StealthTest do
  ...
  describe "stealth_ua_rotation_round_robin" do
    test "stealth_ua_rotation_round_robin" do
      engine_config =
        "{\"max_depth\":1,\"max_pages\":3,\"user_agents\":[\"Mozilla/5.0 (Windows NT 10.0; Win64; x64) TestAgent-1\",\"Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15) TestAgent-2\"]}"

      {:ok, engine} = Crawlberg.create_engine(engine_config)

      url =
        System.get_env("MOCK_SERVER_STEALTH_UA_ROTATION_ROUND_ROBIN") ||
          (System.get_env("MOCK_SERVER_URL") || "") <> "/fixtures/stealth_ua_rotation_round_robin"
