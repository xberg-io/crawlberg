...
# alef:hash:67821b3d115807ab2021e7f7add544642876d51b16049f15ca164e3d5161cb9b
...
defmodule E2e.RedirectTest do
  ...
  describe "redirect_301_permanent" do
    test "redirect_301_permanent" do
      ...
      url =
        System.get_env("MOCK_SERVER_REDIRECT_301_PERMANENT") ||
          (System.get_env("MOCK_SERVER_URL") || "") <> "/fixtures/redirect_301_permanent"
  ...
  describe "redirect_303_see_other" do
    test "redirect_303_see_other" do
      ...
      url =
        System.get_env("MOCK_SERVER_REDIRECT_303_SEE_OTHER") ||
          (System.get_env("MOCK_SERVER_URL") || "") <> "/fixtures/redirect_303_see_other"
  ...
  describe "redirect_307_temporary" do
    test "redirect_307_temporary" do
      ...
      url =
        System.get_env("MOCK_SERVER_REDIRECT_307_TEMPORARY") ||
          (System.get_env("MOCK_SERVER_URL") || "") <> "/fixtures/redirect_307_temporary"
  ...
  describe "redirect_308_permanent" do
    test "redirect_308_permanent" do
      ...
      url =
        System.get_env("MOCK_SERVER_REDIRECT_308_PERMANENT") ||
          (System.get_env("MOCK_SERVER_URL") || "") <> "/fixtures/redirect_308_permanent"
  ...
  describe "redirect_cross_domain" do
    test "redirect_cross_domain" do
      ...
      url =
        System.get_env("MOCK_SERVER_REDIRECT_CROSS_DOMAIN") ||
          (System.get_env("MOCK_SERVER_URL") || "") <> "/fixtures/redirect_cross_domain"
  ...
  describe "redirect_loop" do
    test "redirect_loop" do
      ...
      {:ok, result} = Crawlberg.crawl(engine, url)
      assert result.redirect_count == 1
      assert Enum.at(result.pages, 0).status_code == 302
    end
  end
  ...
  describe "redirect_max_exceeded" do
    test "redirect_max_exceeded" do
      ...
      url =
        System.get_env("MOCK_SERVER_REDIRECT_MAX_EXCEEDED") ||
          (System.get_env("MOCK_SERVER_URL") || "") <> "/fixtures/redirect_max_exceeded"

      {:ok, result} = Crawlberg.crawl(engine, url)
      assert result.redirect_count == 2
      assert Enum.at(result.pages, 0).status_code == 301
    end
  end
  ...
  describe "redirect_refresh_header" do
    test "redirect_refresh_header" do
      ...
      url =
        System.get_env("MOCK_SERVER_REDIRECT_REFRESH_HEADER") ||
          (System.get_env("MOCK_SERVER_URL") || "") <> "/fixtures/redirect_refresh_header"
  ...
  describe "redirect_to_404" do
    test "redirect_to_404" do
      ...
      assert result.redirect_count == 1
      assert String.contains?(to_string(result.error), "404")
    end
  end
end
