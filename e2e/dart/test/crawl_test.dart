...
// alef:hash:cd5a27dc07102b1583e677606ef79882b81da2521098c43449a557142cf9f984
...
void main() {
  ...
  test('Crawls subdomains when allow_subdomains is enabled', () async {
    final engineConfig = await createCrawlConfigFromJson(
      json:
          r'{"allow_subdomains":true,"max_depth":1,"respect_robots_txt":false,"stay_on_domain":true}',
    );
    final engine = await CrawlbergBridge.createEngine(config: engineConfig);
