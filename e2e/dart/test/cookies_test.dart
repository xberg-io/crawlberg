...
void main() {
  ...
  test('Isolates cookies per domain during crawl', () async {
    ...
    expect(result.cookies.where((item) {
            final texts = <String>[];
            ...
            return texts.any((t) => t.toLowerCase().contains(('domain_cookie').toString().toLowerCase()));
          }).isEmpty, isFalse);
  });
  ...
  test('Maintains cookies across multiple crawl requests', () async {
    ...
    expect(result.cookies.where((item) {
            ...
            final v_path = item.path;
            if (v_path != null) texts.add(v_path.toString());
            return texts.any((t) => t.toLowerCase().contains(('session').toString().toLowerCase()));
          }).isEmpty, isFalse);
  });
  ...
  test('Respects Set-Cookie header from server responses', () async {
    ...
    expect(result.cookies.where((item) {
            ...
            final v_path = item.path;
            if (v_path != null) texts.add(v_path.toString());
            return texts.any((t) => t.toLowerCase().contains(('tracking').toString().toLowerCase()));
          }).isEmpty, isFalse);
  });
