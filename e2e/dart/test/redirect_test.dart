...
// alef:hash:30dc8cf5e748ae0c8169bde84c1429239465086b1374b7a9a860ea6032149083
...
void main() {
  ...
  test('Detects redirect loop (A -> B -> A) and stops following without reaching a final page', () async {
    final engineConfig = await createCrawlConfigFromJson(
      json: r'{"respect_robots_txt":false}',
    );
    final engine = await CrawlbergBridge.createEngine(config: engineConfig);
