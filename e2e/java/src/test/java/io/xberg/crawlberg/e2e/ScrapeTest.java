...
// alef:hash:c51f8e3aefb60da64d7dcee1e0ecf8b2d65512039fafb8ecd3601fa2f6983d6b
...
public class ScrapeTest {
    ...
    void testScrapeMalformedHtml() throws Exception {
        ...
        assertEquals(200, result.statusCode());
        assertFalse(result.html().isEmpty(), "expected non-empty value");
        assertTrue(java.util.Optional.ofNullable(result.metadata().title()).map(java.util.Objects::toString).orElse("").contains("Malformed Page"), "expected to contain: " + "Malformed Page");
        assertTrue(java.util.Optional.ofNullable(result.metadata().description()).isEmpty(), "expected empty value");
