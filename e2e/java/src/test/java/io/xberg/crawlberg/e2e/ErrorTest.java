...
// alef:hash:b6b106287f3b45336850f47a39d74044dd40ec56f2d439e118408e0937507759
...
public class ErrorTest {
    ...
    void testErrorEmptyBatchUrls() throws Exception {
        ...
        assertTrue(thrown.getMessage() != null && thrown.getMessage().contains("urls") || thrown.getClass().getSimpleName().contains("urls"), "expected error to match: urls");
