...
// alef:hash:da038b0110f92984c120ed0c358945f5f8cc1136a3e21c5d72191ce7b87021f0
...
public class CrawlTest {
    ...
    @Test
    void testCrawlMaxLinksPerPage() throws Exception {
        ...
        var engine = Crawlberg.createEngine(engineConfig);
        String url = System.getProperty("mockServer.crawl_max_links_per_page", System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) + "/fixtures/crawl_max_links_per_page");
        var result = Crawlberg.crawl(engine, url);
        assertTrue(result.pages().size() <= 3, "expected <= 3");
    ...
    void testCrawlSubdomainInclusion() throws Exception {
        ...
        var engineConfig = MAPPER.readValue("{\"allow_subdomains\":true,\"max_depth\":1,\"respect_robots_txt\":false,\"stay_on_domain\":true}", CrawlConfig.class);
        var engine = Crawlberg.createEngine(engineConfig);
