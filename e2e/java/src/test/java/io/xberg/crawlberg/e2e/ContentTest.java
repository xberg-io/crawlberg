...
assertEquals(204, result.statusCode());assertTrue(result.html().isEmpty(), "expected empty value");
    ...
    void testContentCharsetIso8859() throws Exception {
        ...
        var result = Crawlberg.scrape(engine, url);
assertEquals("iso-8859-1", java.util.Optional.ofNullable(result.detectedCharset()).map(java.util.Objects::toString).orElse("").trim());
...
assertEquals(200, result.statusCode());
    ...
    void testContentGzipCompressed() throws Exception {
        ...
        var result = Crawlberg.scrape(engine, url);
assertFalse(result.html().isEmpty(), "expected non-empty value");assertEquals(200, result.statusCode());
...
assertTrue(result.bodySize() < 1025, "expected < 1025");
    ...
    void testContentNonAsciiBodyLimit() throws Exception {
        ...
        var result = Crawlberg.scrape(engine, url);
assertEquals(200, result.statusCode());assertEquals(0, result.bodySize());
...
assertFalse(result.html().isEmpty(), "expected non-empty value");
    ...
    void testContentUtf8Bom() throws Exception {
        ...
        var result = Crawlberg.scrape(engine, url);
assertEquals("utf-8", java.util.Optional.ofNullable(result.detectedCharset()).map(java.util.Objects::toString).orElse("").trim());assertFalse(result.html().isEmpty(), "expected non-empty value");
