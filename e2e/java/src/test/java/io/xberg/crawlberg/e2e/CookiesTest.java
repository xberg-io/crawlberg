...
// alef:hash:deb3f125c2d22d623ec38bbc6c26ff8223d9e286ec2201b68e7666531662d21e
...
public class CookiesTest {
    ...
    void testCookiesPerDomain() throws Exception {
        ...
        assertTrue(result.cookies().toString().toLowerCase().contains(String.valueOf("domain_cookie").toLowerCase()), "expected to contain: " + "domain_cookie");
