...
// alef:hash:c341f8c2614bae2106ce2f981b0317c15019713400665a60c231d1886072463e
...
public class RedirectTest {
    ...
    void testRedirectLoop() throws Exception {
        ...
        var result = Crawlberg.crawl(engine, url);
        assertEquals(1, result.redirectCount());
        assertEquals(302, result.pages().get(0).statusCode());
    ...
    void testRedirectMaxExceeded() throws Exception {
        ...
        var result = Crawlberg.crawl(engine, url);
        assertEquals(2, result.redirectCount());
        assertEquals(301, result.pages().get(0).statusCode());
    ...
    void testRedirectTo404() throws Exception {
        ...
        assertEquals(1, result.redirectCount());
        assertTrue(java.util.Optional.ofNullable(result.error()).map(java.util.Objects::toString).orElse("").contains("404"), "expected to contain: " + "404");
