...
// alef:hash:63a4fcd9dcfc3ce33889db6bdf169b3c8af863f8fbc293a64bd30bd75069e9d0
...
public class RedirectTest {
    ...
    void testRedirectLoop() throws Exception {
        ...
        org.junit.jupiter.api.Assertions.fail("alef resolved no assertion for fixture `redirect_loop`: 1 assertion(s) name a field path the availability oracle rejected");
    ...
    void testRedirectMaxExceeded() throws Exception {
        ...
        var result = Crawlberg.crawl(engine, url);
        // skipped: field 'is_error' not available on result type
        org.junit.jupiter.api.Assertions.fail("alef resolved no assertion for fixture `redirect_max_exceeded`: 1 assertion(s) name a field path the availability oracle rejected");
