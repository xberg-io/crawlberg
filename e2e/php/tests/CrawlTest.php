...
// alef:hash:f767f2022783e1f1493868300b215a0678e76e16060a71065b35cb4fb7df87a3
...
final class CrawlTest extends TestCase
{
    ...
    public function test_crawl_max_links_per_page(): void
    {
        $engine_config = CrawlConfig::from_json(json_encode(["maxLinksPerPage" => 2, "maxPages" => 10, "respectRobotsTxt" => false]));
        $engine = Crawlberg::createEngine($engine_config);
        $url = getenv('MOCK_SERVER_CRAWL_MAX_LINKS_PER_PAGE') ?: getenv('MOCK_SERVER_URL') . '/fixtures/crawl_max_links_per_page';
        $result = Crawlberg::crawl($engine, $url);
