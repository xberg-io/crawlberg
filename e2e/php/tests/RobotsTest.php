...
final class RobotsTest extends TestCase
{
    ...
    public function test_robots_allow_override(): void
    {
        $engine_config = CrawlConfig::from_json(json_encode(['respectRobotsTxt' => true]));
        $engine = Crawlberg::createEngine($engine_config);
        $url = getenv('MOCK_SERVER_ROBOTS_ALLOW_OVERRIDE')
        ?: getenv('MOCK_SERVER_URL') . '/fixtures/robots_allow_override';
        $result = Crawlberg::scrape($engine, $url);
    ...
    public function test_robots_comments_handling(): void
    {
        ...
        $engine = Crawlberg::createEngine($engine_config);
        $url = getenv('MOCK_SERVER_ROBOTS_COMMENTS_HANDLING')
        ?: getenv('MOCK_SERVER_URL') . '/fixtures/robots_comments_handling';
        $result = Crawlberg::scrape($engine, $url);
    ...
    public function test_robots_disallow_path(): void
    {
        $engine_config = CrawlConfig::from_json(json_encode(['respectRobotsTxt' => true]));
        $engine = Crawlberg::createEngine($engine_config);
        $url = getenv('MOCK_SERVER_ROBOTS_DISALLOW_PATH')
        ?: getenv('MOCK_SERVER_URL') . '/fixtures/robots_disallow_path';
        $result = Crawlberg::scrape($engine, $url);
    ...
    public function test_robots_meta_nofollow(): void
    {
        $engine_config = CrawlConfig::from_json(json_encode(['respectRobotsTxt' => true]));
        $engine = Crawlberg::createEngine($engine_config);
        $url = getenv('MOCK_SERVER_ROBOTS_META_NOFOLLOW')
        ?: getenv('MOCK_SERVER_URL') . '/fixtures/robots_meta_nofollow';
        $result = Crawlberg::scrape($engine, $url);
    ...
    public function test_robots_multiple_user_agents(): void
    {
        ...
        $engine = Crawlberg::createEngine($engine_config);
        $url = getenv('MOCK_SERVER_ROBOTS_MULTIPLE_USER_AGENTS')
        ?: getenv('MOCK_SERVER_URL') . '/fixtures/robots_multiple_user_agents';
        $result = Crawlberg::scrape($engine, $url);
    ...
    public function test_robots_sitemap_directive(): void
    {
        $engine_config = CrawlConfig::from_json(json_encode(['respectRobotsTxt' => true]));
        $engine = Crawlberg::createEngine($engine_config);
        $url = getenv('MOCK_SERVER_ROBOTS_SITEMAP_DIRECTIVE')
        ?: getenv('MOCK_SERVER_URL') . '/fixtures/robots_sitemap_directive';
        $result = Crawlberg::scrape($engine, $url);
    ...
    public function test_robots_user_agent_specific(): void
    {
        $engine_config = CrawlConfig::from_json(json_encode([
            'respectRobotsTxt' => true,
            'userAgent' => 'CrawlbergBot',
        ]));
        $engine = Crawlberg::createEngine($engine_config);
        $url = getenv('MOCK_SERVER_ROBOTS_USER_AGENT_SPECIFIC')
        ?: getenv('MOCK_SERVER_URL') . '/fixtures/robots_user_agent_specific';
        $result = Crawlberg::scrape($engine, $url);
    ...
    public function test_robots_wildcard_paths(): void
    {
        $engine_config = CrawlConfig::from_json(json_encode(['respectRobotsTxt' => true]));
        $engine = Crawlberg::createEngine($engine_config);
        $url = getenv('MOCK_SERVER_ROBOTS_WILDCARD_PATHS')
        ?: getenv('MOCK_SERVER_URL') . '/fixtures/robots_wildcard_paths';
        $result = Crawlberg::scrape($engine, $url);
