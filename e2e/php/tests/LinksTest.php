...
final class LinksTest extends TestCase
{
    ...
    public function test_links_anchor_fragment(): void
    {
        ...
        $url = getenv('MOCK_SERVER_LINKS_ANCHOR_FRAGMENT')
        ?: getenv('MOCK_SERVER_URL') . '/fixtures/links_anchor_fragment';
    ...
    {
        $engine = Crawlberg::createEngine(null);
        $url = getenv('MOCK_SERVER_LINKS_DOCUMENT_TYPES')
        ?: getenv('MOCK_SERVER_URL') . '/fixtures/links_document_types';
        $result = Crawlberg::scrape($engine, $url);
