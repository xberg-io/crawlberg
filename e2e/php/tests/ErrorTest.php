...
// alef:hash:e61f6edf8ce2205147f02b87e91223cbaa00b4a60b1e6f2d5bb20e98c4c3877a
...
final class ErrorTest extends TestCase
{
    ...
    public function test_error_401_unauthorized(): void
    {
        try {
            ...
            $this->assertTrue(preg_match('/unauthorized/', $e->getMessage()) === 1 || preg_match('/unauthorized/', get_class($e)) === 1, 'expected exception message or class name to match unauthorized');
        }
    ...
    public function test_error_403_forbidden(): void
    {
        try {
            ...
            $this->assertTrue(preg_match('/forbidden/', $e->getMessage()) === 1 || preg_match('/forbidden/', get_class($e)) === 1, 'expected exception message or class name to match forbidden');
        }
    ...
    public function test_error_404_page(): void
    {
        try {
            ...
            $this->assertTrue(preg_match('/not_found/', $e->getMessage()) === 1 || preg_match('/not_found/', get_class($e)) === 1, 'expected exception message or class name to match not_found');
        }
    ...
    public function test_error_408_request_timeout(): void
    {
        try {
            ...
            $this->assertTrue(preg_match('/timeout/', $e->getMessage()) === 1 || preg_match('/timeout/', get_class($e)) === 1, 'expected exception message or class name to match timeout');
        }
    ...
    public function test_error_410_gone(): void
    {
        try {
            ...
            $this->assertTrue(preg_match('/gone/', $e->getMessage()) === 1 || preg_match('/gone/', get_class($e)) === 1, 'expected exception message or class name to match gone');
        }
    ...
    public function test_error_500_server(): void
    {
        try {
            ...
            $this->assertTrue(preg_match('/server_error/', $e->getMessage()) === 1 || preg_match('/server_error/', get_class($e)) === 1, 'expected exception message or class name to match server_error');
        }
    ...
    public function test_error_502_bad_gateway(): void
    {
        try {
            ...
            $this->assertTrue(preg_match('/bad_gateway/', $e->getMessage()) === 1 || preg_match('/bad_gateway/', get_class($e)) === 1, 'expected exception message or class name to match bad_gateway');
        }
    ...
    public function test_error_browser_launch_failure(): void
    {
        try {
            ...
            $this->assertTrue(preg_match('/browser/', $e->getMessage()) === 1 || preg_match('/browser/', get_class($e)) === 1, 'expected exception message or class name to match browser');
        }
    ...
    public function test_error_browser_page_timeout(): void
    {
        try {
            ...
            $this->assertTrue(preg_match('/browser_timeout/', $e->getMessage()) === 1 || preg_match('/browser_timeout/', get_class($e)) === 1, 'expected exception message or class name to match browser_timeout');
        }
    ...
    public function test_error_connection_refused(): void
    {
        try {
            ...
            $this->assertTrue(preg_match('/connection/', $e->getMessage()) === 1 || preg_match('/connection/', get_class($e)) === 1, 'expected exception message or class name to match connection');
        }
    ...
    public function test_error_data_loss_truncated(): void
    {
        try {
            ...
            $this->assertTrue(preg_match('/data_loss:/', $e->getMessage()) === 1 || preg_match('/data_loss:/', get_class($e)) === 1, 'expected exception message or class name to match data_loss:');
        }
    ...
    public function test_error_dns_resolution(): void
    {
        try {
            ...
            $this->assertTrue(preg_match('/dns/', $e->getMessage()) === 1 || preg_match('/dns/', get_class($e)) === 1, 'expected exception message or class name to match dns');
        }
    ...
    public function test_error_rate_limited(): void
    {
        try {
            ...
            $this->assertTrue(preg_match('/rate_limited/', $e->getMessage()) === 1 || preg_match('/rate_limited/', get_class($e)) === 1, 'expected exception message or class name to match rate_limited');
        }
    ...
    public function test_error_ssl_invalid_cert(): void
    {
        try {
            ...
            $this->assertTrue(preg_match('/ssl/', $e->getMessage()) === 1 || preg_match('/ssl/', get_class($e)) === 1, 'expected exception message or class name to match ssl');
        }
    ...
    public function test_error_unsupported_scheme(): void
    {
        try {
            ...
            $this->assertTrue(preg_match('/disallowed scheme: gopher/', $e->getMessage()) === 1 || preg_match('/disallowed scheme: gopher/', get_class($e)) === 1, 'expected exception message or class name to match disallowed scheme: gopher');
        }
    ...
    public function test_error_waf_blocked(): void
    {
        try {
            ...
            $this->assertTrue(preg_match('/waf/', $e->getMessage()) === 1 || preg_match('/waf/', get_class($e)) === 1, 'expected exception message or class name to match waf');
        }
