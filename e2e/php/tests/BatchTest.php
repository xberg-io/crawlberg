...
// alef:hash:fe26cdadcf9f866727c3db72ba681b37b7166891d3af13760ab0124303ce1208
...
final class BatchTest extends TestCase
{
    ...
    public function test_batch_scrape_empty_urls_error(): void
    {
        ...
        $this->assertTrue(preg_match('/urls/', $caughtException->getMessage()) === 1 || preg_match('/urls/', get_class($caughtException)) === 1, 'expected exception message or class name to match urls');
