...
final class BatchTest extends TestCase
{
    ...
    public function test_batch_crawl_basic(): void
    {
        ...
        $urls_base = getenv('MOCK_SERVER_BATCH_CRAWL_BASIC')
        ?: getenv('MOCK_SERVER_URL') . '/fixtures/batch_crawl_basic';
    ...
    public function test_batch_crawl_partial_failure(): void
    {
        $engine_config = CrawlConfig::from_json(json_encode(['maxDepth' => 1, 'respectRobotsTxt' => false]));
        $engine = Crawlberg::createEngine($engine_config);
        $urls_base = getenv('MOCK_SERVER_BATCH_CRAWL_PARTIAL_FAILURE')
        ?: getenv('MOCK_SERVER_URL') . '/fixtures/batch_crawl_partial_failure';
    ...
    public function test_batch_crawl_with_config(): void
    {
        $engine_config = CrawlConfig::from_json(json_encode(['maxDepth' => 1, 'respectRobotsTxt' => false]));
        $engine = Crawlberg::createEngine($engine_config);
        $urls_base = getenv('MOCK_SERVER_BATCH_CRAWL_WITH_CONFIG')
        ?: getenv('MOCK_SERVER_URL') . '/fixtures/batch_crawl_with_config';
        $urls = array_map(fn($p) => str_starts_with($p, 'http') ? $p : $urls_base . $p, ['/seed1', '/seed2']);
        $result = Crawlberg::batchCrawl($engine, $urls);
    ...
    public function test_batch_scrape_empty_urls_error(): void
    {
        ...
        $urls_base = getenv('MOCK_SERVER_BATCH_SCRAPE_EMPTY_URLS_ERROR')
        ?: getenv('MOCK_SERVER_URL') . '/fixtures/batch_scrape_empty_urls_error';
    ...
    public function test_batch_scrape_with_config(): void
    {
        ...
        $engine = Crawlberg::createEngine($engine_config);
        $urls_base = getenv('MOCK_SERVER_BATCH_SCRAPE_WITH_CONFIG')
        ?: getenv('MOCK_SERVER_URL') . '/fixtures/batch_scrape_with_config';
    ...
    {
        $engine = Crawlberg::createEngine(null);
        $urls_base = getenv('MOCK_SERVER_SCRAPE_BATCH_BASIC')
        ?: getenv('MOCK_SERVER_URL') . '/fixtures/scrape_batch_basic';
    ...
    {
        $engine = Crawlberg::createEngine(null);
        $urls_base = getenv('MOCK_SERVER_SCRAPE_BATCH_PARTIAL_FAILURE')
        ?: getenv('MOCK_SERVER_URL') . '/fixtures/scrape_batch_partial_failure';
    ...
    {
        $engine = Crawlberg::createEngine(null);
        $urls_base = getenv('MOCK_SERVER_SCRAPE_BATCH_PROGRESS')
        ?: getenv('MOCK_SERVER_URL') . '/fixtures/scrape_batch_progress';
