...
final class MapTest extends TestCase
{
    ...
    public function test_map_exclude_patterns(): void
    {
        ...
        $engine = Crawlberg::createEngine($engine_config);
        $url = getenv('MOCK_SERVER_MAP_EXCLUDE_PATTERNS')
        ?: getenv('MOCK_SERVER_URL') . '/fixtures/map_exclude_patterns';
        $result = Crawlberg::mapUrls($engine, $url);
    ...
    public function test_map_include_subdomains(): void
    {
        ...
        $engine = Crawlberg::createEngine($engine_config);
        $url = getenv('MOCK_SERVER_MAP_INCLUDE_SUBDOMAINS')
        ?: getenv('MOCK_SERVER_URL') . '/fixtures/map_include_subdomains';
        $result = Crawlberg::mapUrls($engine, $url);
    ...
    public function test_map_limit_pagination(): void
    {
        ...
        $engine = Crawlberg::createEngine($engine_config);
        $url = getenv('MOCK_SERVER_MAP_LIMIT_PAGINATION')
        ?: getenv('MOCK_SERVER_URL') . '/fixtures/map_limit_pagination';
        $result = Crawlberg::mapUrls($engine, $url);
