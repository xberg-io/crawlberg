...
final class RateLimitTest extends TestCase
{
    ...
    public function test_rate_limit_basic_delay(): void
    {
        ...
        $engine = Crawlberg::createEngine($engine_config);
        $url = getenv('MOCK_SERVER_RATE_LIMIT_BASIC_DELAY')
        ?: getenv('MOCK_SERVER_URL') . '/fixtures/rate_limit_basic_delay';
    ...
    public function test_rate_limit_per_domain(): void
    {
        ...
        $engine = Crawlberg::createEngine($engine_config);
        $url = getenv('MOCK_SERVER_RATE_LIMIT_PER_DOMAIN')
        ?: getenv('MOCK_SERVER_URL') . '/fixtures/rate_limit_per_domain';
        $result = Crawlberg::crawl($engine, $url);
    ...
    public function test_rate_limit_robots_crawl_delay(): void
    {
        ...
        $engine = Crawlberg::createEngine($engine_config);
        $url = getenv('MOCK_SERVER_RATE_LIMIT_ROBOTS_CRAWL_DELAY')
        ?: getenv('MOCK_SERVER_URL') . '/fixtures/rate_limit_robots_crawl_delay';
        $result = Crawlberg::crawl($engine, $url);
    ...
    public function test_rate_limit_zero_no_delay(): void
    {
        $engine_config = CrawlConfig::from_json(json_encode(['maxDepth' => 1]));
        $engine = Crawlberg::createEngine($engine_config);
        $url = getenv('MOCK_SERVER_RATE_LIMIT_ZERO_NO_DELAY')
        ?: getenv('MOCK_SERVER_URL') . '/fixtures/rate_limit_zero_no_delay';
        $this->expectNotToPerformAssertions();
        $result = Crawlberg::crawl($engine, $url);
