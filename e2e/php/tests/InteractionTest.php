...
// alef:hash:3397c491c6de39036c9cc21d425a61aac6c1a1cfb0f74c80c11c466461ec351d
...
final class InteractionTest extends TestCase
{
    ...
    public function test_interact_max_actions_exceeded(): void
    {
        ...
        $this->assertTrue(preg_match('/actions/', $caughtException->getMessage()) === 1 || preg_match('/actions/', get_class($caughtException)) === 1, 'expected exception message or class name to match actions');
