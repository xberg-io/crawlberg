...
final class InteractionTest extends TestCase
{
    ...
    public function test_interact_action_sequence(): void
    {
        ...
        $result = Crawlberg::interact($engine, $url, [
            PageAction::from_json('{"selector":"#open","type":"click"}'),
            PageAction::from_json('{"selector":"#field","text":"test_data","type":"type"}'),
            PageAction::from_json('{"selector":"#submit","type":"click"}'),
        ]);
    ...
    public function test_interact_execute_js(): void
    {
        ...
        $result = Crawlberg::interact($engine, $url, [PageAction::from_json(
            '{"script":"document.title","type":"executeJs"}',
        )]);
    ...
    public function test_interact_invalid_selector(): void
    {
        ...
        $result = Crawlberg::interact($engine, $url, [PageAction::from_json(
            '{"selector":"#nonexistent","type":"click"}',
        )]);
    ...
    public function test_interact_max_actions_exceeded(): void
    {
        ...
        Crawlberg::interact($engine, $url, [
            PageAction::from_json('{"selector":"#btn","type":"click"}'),
            PageAction::from_json('{"selector":"#btn","type":"click"}'),
            PageAction::from_json('{"selector":"#btn","type":"click"}'),
            PageAction::from_json('{"selector":"#btn","type":"click"}'),
            PageAction::from_json('{"selector":"#btn","type":"click"}'),
    ...
    public function test_interact_press_key(): void
    {
        ...
        $result = Crawlberg::interact($engine, $url, [
            PageAction::from_json('{"selector":"#searchbox","type":"click"}'),
            PageAction::from_json('{"selector":"#searchbox","text":"test","type":"type"}'),
            PageAction::from_json('{"key":"Enter","type":"press"}'),
        ]);
    ...
    public function test_interact_screenshot(): void
    {
        ...
        $result = Crawlberg::interact($engine, $url, [PageAction::from_json(
            '{"full_page":false,"type":"screenshot"}',
        )]);
