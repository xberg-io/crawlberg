...
final class EncodingTest extends TestCase
{
    ...
    public function test_encoding_double_encoded(): void
    {
        ...
        $url = getenv('MOCK_SERVER_ENCODING_DOUBLE_ENCODED')
        ?: getenv('MOCK_SERVER_URL') . '/fixtures/encoding_double_encoded';
    ...
    {
        $engine = Crawlberg::createEngine(null);
        $url = getenv('MOCK_SERVER_ENCODING_PERCENT_ENCODED_PATH')
        ?: getenv('MOCK_SERVER_URL') . '/fixtures/encoding_percent_encoded_path';
        $result = Crawlberg::scrape($engine, $url);
