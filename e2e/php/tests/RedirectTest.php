...
final class RedirectTest extends TestCase
{
    ...
    public function test_redirect_301_permanent(): void
    {
        ...
        $url = getenv('MOCK_SERVER_REDIRECT_301_PERMANENT')
        ?: getenv('MOCK_SERVER_URL') . '/fixtures/redirect_301_permanent';
    ...
    public function test_redirect_303_see_other(): void
    {
        $engine_config = CrawlConfig::from_json(json_encode(['respectRobotsTxt' => false]));
        $engine = Crawlberg::createEngine($engine_config);
        $url = getenv('MOCK_SERVER_REDIRECT_303_SEE_OTHER')
        ?: getenv('MOCK_SERVER_URL') . '/fixtures/redirect_303_see_other';
        $result = Crawlberg::crawl($engine, $url);
    ...
    public function test_redirect_307_temporary(): void
    {
        $engine_config = CrawlConfig::from_json(json_encode(['respectRobotsTxt' => false]));
        $engine = Crawlberg::createEngine($engine_config);
        $url = getenv('MOCK_SERVER_REDIRECT_307_TEMPORARY')
        ?: getenv('MOCK_SERVER_URL') . '/fixtures/redirect_307_temporary';
        $result = Crawlberg::crawl($engine, $url);
    ...
    public function test_redirect_308_permanent(): void
    {
        $engine_config = CrawlConfig::from_json(json_encode(['respectRobotsTxt' => false]));
        $engine = Crawlberg::createEngine($engine_config);
        $url = getenv('MOCK_SERVER_REDIRECT_308_PERMANENT')
        ?: getenv('MOCK_SERVER_URL') . '/fixtures/redirect_308_permanent';
        $result = Crawlberg::crawl($engine, $url);
    ...
    public function test_redirect_cross_domain(): void
    {
        $engine_config = CrawlConfig::from_json(json_encode(['respectRobotsTxt' => false]));
        $engine = Crawlberg::createEngine($engine_config);
        $url = getenv('MOCK_SERVER_REDIRECT_CROSS_DOMAIN')
        ?: getenv('MOCK_SERVER_URL') . '/fixtures/redirect_cross_domain';
        $result = Crawlberg::crawl($engine, $url);
    ...
    public function test_redirect_max_exceeded(): void
    {
        ...
        $engine = Crawlberg::createEngine($engine_config);
        $url = getenv('MOCK_SERVER_REDIRECT_MAX_EXCEEDED')
        ?: getenv('MOCK_SERVER_URL') . '/fixtures/redirect_max_exceeded';
        $this->expectNotToPerformAssertions();
        $result = Crawlberg::crawl($engine, $url);
    ...
    public function test_redirect_refresh_header(): void
    {
        $engine_config = CrawlConfig::from_json(json_encode(['respectRobotsTxt' => false]));
        $engine = Crawlberg::createEngine($engine_config);
        $url = getenv('MOCK_SERVER_REDIRECT_REFRESH_HEADER')
        ?: getenv('MOCK_SERVER_URL') . '/fixtures/redirect_refresh_header';
        $result = Crawlberg::crawl($engine, $url);
