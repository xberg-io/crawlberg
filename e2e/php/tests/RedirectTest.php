...
// alef:hash:0b5fba57f97d3e5f119380d3113fc26a81e75b78abe93021e0ccd60bc02adf27
...
final class RedirectTest extends TestCase
{
    ...
    public function test_redirect_loop(): void
    {
        ...
        $this->fail('alef resolved no assertion for fixture `redirect_loop`: 1 assertion(s) name a field path the availability oracle rejected');
    ...
    public function test_redirect_max_exceeded(): void
    {
        ...
        // skipped: field 'is_error' not available on result type
        $this->fail('alef resolved no assertion for fixture `redirect_max_exceeded`: 1 assertion(s) name a field path the availability oracle rejected');
