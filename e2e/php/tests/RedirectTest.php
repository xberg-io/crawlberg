...
// alef:hash:40fb0cafd478bf511b4654cb0e71295a991c7741e5ca4eafce78150c1a9ef101
...
final class RedirectTest extends TestCase
{
    ...
    public function test_redirect_loop(): void
    {
        ...
        $this->assertEquals(1, $result->redirectCount);
        $this->assertEquals(302, $result->getPages()[0]->statusCode);
    ...
    public function test_redirect_max_exceeded(): void
    {
        ...
        $this->assertEquals(2, $result->redirectCount);
        $this->assertEquals(301, $result->getPages()[0]->statusCode);
    ...
    public function test_redirect_to_404(): void
    {
        ...
        $this->assertEquals(1, $result->redirectCount);
        $this->assertStringContainsString("404", ($result->error ?? null));
