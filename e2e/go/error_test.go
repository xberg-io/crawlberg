...
// alef:hash:95852a6b8ed18584922724fa0d9c94076d699924f8f65e4697964b67b302a21d
...
func Test_ErrorEmptyBatchUrls(t *testing.T) {
	...
	if err != nil {
		if !strings.Contains(err.Error(), `urls`) && !strings.Contains(fmt.Sprintf("%T", err), `urls`) {
			t.Errorf("expected error to match %s, got message=%q type=%T", `urls`, err.Error(), err)
		}
	}
}
