...
// alef:hash:152cb67ef02fe8d2960c09db10a66df744f481175828b470bc3799891b44339e
...
func Test_RedirectLoop(t *testing.T) {
	...
	if result.Pages[0].StatusCode != 302 {
...
func Test_RedirectMaxExceeded(t *testing.T) {
	...
	if result.Pages[0].StatusCode != 301 {
		t.Errorf("equals mismatch: got %v", result.Pages[0].StatusCode)
	}
}
...
func Test_RedirectTo404(t *testing.T) {
	...
	if !strings.Contains(string(error), `404`) {
		t.Errorf("expected to contain %s, got %v", `404`, error)
	}
}
