...
// alef:hash:e05153809c5df019b8180d9d8df382dc833d970f45f22ff68e0eb39942e45c08
...
func Test_CookiesPerDomain(t *testing.T) {
	...
	if !strings.Contains(jsonString(t, result.Cookies), `domain_cookie`) {
...
func Test_CookiesPersistence(t *testing.T) {
	...
	if !strings.Contains(jsonString(t, result.Cookies), `session`) {
...
func Test_CookiesSetCookieResponse(t *testing.T) {
	...
	if !strings.Contains(jsonString(t, result.Cookies), `tracking`) {
