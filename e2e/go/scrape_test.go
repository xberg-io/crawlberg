...
// alef:hash:9ce9257a328781e1e670509adbda251b6f788828f4b1206cd9ab641cf92cfd16
...
func Test_ScrapeMalformedHtml(t *testing.T) {
	...
	if !strings.Contains(string(metadataTitle), `Malformed Page`) {
		t.Errorf("expected to contain %s, got %v", `Malformed Page`, metadataTitle)
	}
	if result.Metadata.Description != nil {
		t.Errorf("expected empty value, got %v", result.Metadata.Description)
	}
}
