...
// alef:hash:024d39af4c1d684d3c4fd97da6309650e4adb98aea9a872e0e4ed031183fb179
...
func Test_BrowserConfigAutoNoFeature(t *testing.T) {
	...
	if result.JsRenderHint != true {
		t.Errorf("equals mismatch: got %v", result.JsRenderHint)
	}
	if result.BrowserUsed != false {
		t.Errorf("equals mismatch: got %v", result.BrowserUsed)
	}
}
...
func Test_BrowserCrawlModeAlways(t *testing.T) {
	...
	url := os.Getenv("MOCK_SERVER_BROWSER_CRAWL_MODE_ALWAYS")
	if url == "" {
...
func Test_BrowserCrawlWafFallback(t *testing.T) {
	...
	url := os.Getenv("MOCK_SERVER_BROWSER_CRAWL_WAF_FALLBACK")
	if url == "" {
