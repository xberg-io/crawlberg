 ...
 * alef:hash:e5ab1dff4b2afddd1e4f6af023eac5636da7855d39f12296e4a259fa4c22fe35
...
void test_scrape_json_ld(void) {
    ...
    assert(json_ld_type != NULL && strcmp(json_ld_type, "Recipe") == 0 && "equals assertion failed");
    assert(json_ld_name != NULL && strcmp(json_ld_name, "Best Chocolate Cake") == 0 && "equals assertion failed");
