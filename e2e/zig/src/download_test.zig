...
// alef:hash:4d5056efa664632bfbbad67414b4edc5f525eefe8d8e74ca42b4af2379fb3766
...
test "download_basic_pdf" {
    ...
    try testing.expectEqualStrings("application/pdf", std.mem.trim(u8, (result.object.get("downloaded_document") orelse .null).object.get("mime_type").?.string, " \n\r\t"));
}
