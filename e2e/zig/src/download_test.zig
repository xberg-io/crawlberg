...
// alef:hash:3fe4b1d72f324ee9f516adf50fe45a633660a08ed347783637b796addc2dbf86
...
test "download_basic_pdf" {
    ...
    try testing.expectEqualStrings("application/pdf", (result.object.get("downloaded_document") orelse std.json.Value{ .null = {} }).object.get("mime_type").?.string);
}
