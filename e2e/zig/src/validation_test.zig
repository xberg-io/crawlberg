...
// alef:hash:2d2da1a3fce42885fcc6224c4e54227a6de1155b6381a16e11db14da2947ed12
...
test "validation_ssrf_ipv4_mapped_ipv6_denied" {
    ...
    if (crawlberg.scrape("{\"ssrf\":{\"deny_private\":true},\"ssrf_deny_private_explicit\":true}", "http://[::ffff:127.0.0.1]/")) |_| {
        ...
        const _err_name = @errorName(_err);
        const _err_message: []const u8 = crawlberg._last_error() orelse "";
        try testing.expect(std.mem.indexOf(u8, _err_message, "ssrf_policy_violation") != null or std.mem.indexOf(u8, _err_name, "ssrf_policy_violation") != null);
    }
}
