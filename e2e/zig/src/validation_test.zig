...
// alef:hash:f6de327e50f48b48bae6e9edb4eb2c91b56d8774cecc668c74f85c85eb141ce0
...
test "validation_ssrf_allowlisted_loopback" {
    ...
    try testing.expectEqualStrings("Allowlisted", result.object.get("metadata").?.object.get("title").?.string);
}
