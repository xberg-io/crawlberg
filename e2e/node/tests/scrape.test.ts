...
// alef:hash:5ba52b1c10ad23a597b17a88d108565d8bb6959ac8cf0fdcffe1a12cd81702cf
...
describe("scrape", () => {
    ...
    expect(result.metadata?.title ?? "").toContain("Malformed Page");
    expect((result.metadata?.description ?? "").length).toBe(0);
