...
// alef:hash:05420525f977e81f97ba96db2b33b1c53fa0ecf2a5e7c1a1c00ad65cc1f91c51
...
namespace Crawlberg
{
    ...
    Assert.True(result.Assets.Count == 1);
            Assert.True(result.Assets?.Any(ee95b160 => Convert.ToString(ee95b160.AssetCategory)!.Contains("image")) == true, "element of 'assets[].category': image");
    ...
    Assert.True(result.Links.Count > 0, "expected > 0");
            Assert.True(result.Links?.Any(ebf0942ab => Convert.ToString(ebf0942ab.LinkType)!.Contains("external")) == true, "element of 'links[].link_type': external");
