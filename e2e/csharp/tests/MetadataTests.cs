...
// alef:hash:ac06d5ee34b1a69a063b26f2e98a1c7cb6cf035e6dddbcdfcd9e6b010a309329
...
namespace Crawlberg
{
    ...
    public class MetadataTests
    {
        ...
        public async Task Test_MetadataArticleTimes()
        {
            ...
            Assert.Equal("2024-01-15T10:00:00Z", result.Metadata.Article!.PublishedTime);
        ...
        public async Task Test_MetadataFavicons()
        {
            ...
            Assert.True(result.Metadata.Favicons?.Any(e53736157 => Convert.ToString(e53736157.Rel)!.Contains("apple-touch-icon")) == true, "element of 'favicons[].rel': apple-touch-icon");
        ...
        public async Task Test_MetadataHreflang()
        {
            ...
            Assert.True(result.Metadata.Hreflangs?.Any(e7d2e929c => Convert.ToString(e7d2e929c.Lang)!.Contains("en")) == true, "element of 'hreflang[].lang': en");
        ...
        public async Task Test_MetadataKeywordsAuthor()
        {
            ...
            Assert.True(((object?)result.Metadata.Keywords) switch
            {
                null => false,
                string text => text.Length > 0,
                System.Collections.ICollection items => items.Count > 0,
            ...
            Assert.True(((object?)result.Metadata.Viewport) switch
            {
                null => false,
                string text => text.Length > 0,
                System.Collections.ICollection items => items.Count > 0,
        ...
        public async Task Test_MetadataResponseHeaders()
        {
            ...
            Assert.Contains("01 Jan 2025", result.ResponseMeta!.LastModified.ToString());
