...
// alef:hash:e1071ac8d7d123e578e6a8d037bf28dcc761d9d76761f0454fc7659f0d09ab10
...
namespace Crawlberg
{
    ...
    public class LinksTests
    {
        ...
        public async Task Test_LinksDocumentTypes()
        {
            ...
            var result = await CrawlbergConverter.ScrapeAsync(engine, url);
            Assert.True(result.Links?.Any(ebf0942ab => ebf0942ab.LinkType is { } && System.Text.Json.JsonSerializer.Serialize(ebf0942ab.LinkType, new System.Text.Json.JsonSerializerOptions { Encoder = System.Text.Encodings.Web.JavaScriptEncoder.UnsafeRelaxedJsonEscaping }).Trim('"').Contains("document")) == true, "element of 'links[].link_type': document");
