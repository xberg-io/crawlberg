...
// alef:hash:048a15bf355b7797e14d4e08b46f0cc69ab0d2e68da0a24b58f5419b4287403f
...
namespace Crawlberg
{
    ...
    public class StreamTests
    {
        ...
        [Fact(Skip = "alef rendered no runnable expectation for fixture `batch_crawl_stream_events`: all 3 declared assertion(s) were skipped (see the markers above)")]
        ...
        [Fact(Skip = "alef rendered no runnable expectation for fixture `batch_crawl_stream_partial_failure`: all 3 declared assertion(s) were skipped (see the markers above)")]
        ...
        [Fact(Skip = "alef rendered no runnable expectation for fixture `crawl_stream_events`: all 3 declared assertion(s) were skipped (see the markers above)")]
        ...
        [Fact(Skip = "alef rendered no runnable expectation for fixture `stream_depth_crawl`: all 3 declared assertion(s) were skipped (see the markers above)")]
        ...
        [Fact(Skip = "alef rendered no runnable expectation for fixture `stream_error_event_mid_crawl`: all 3 declared assertion(s) were skipped (see the markers above)")]
        ...
        [Fact(Skip = "alef rendered no runnable expectation for fixture `stream_event_ordering`: all 3 declared assertion(s) were skipped (see the markers above)")]
        ...
        [Fact(Skip = "alef rendered no runnable expectation for fixture `stream_large_crawl`: all 3 declared assertion(s) were skipped (see the markers above)")]
        ...
        [Fact(Skip = "alef rendered no runnable expectation for fixture `stream_with_error_event`: all 3 declared assertion(s) were skipped (see the markers above)")]
