...
// alef:hash:70bf0fb1e40571f0205f3e22191a5d93e59357d004a942a9cf2ebff0c2a3db90
...
namespace Crawlberg
{
    ...
    public class CookiesTests
    {
        ...
        public async Task Test_CookiesPerDomain()
        {
            ...
            Assert.Contains("domain_cookie", JsonSerializer.Serialize(result.Cookies));
        ...
        public async Task Test_CookiesPersistence()
        {
            ...
            var result = await CrawlbergConverter.CrawlAsync(engine, url);
            Assert.Contains("session", JsonSerializer.Serialize(result.Cookies));
        ...
        public async Task Test_CookiesSetCookieResponse()
        {
            ...
            var result = await CrawlbergConverter.CrawlAsync(engine, url);
            Assert.Contains("tracking", JsonSerializer.Serialize(result.Cookies));
