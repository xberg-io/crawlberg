...
async def test_concurrent_depth_two_fan_out() -> None:
    ...
    engine = create_engine(engine_config)
    url = os.environ.get('MOCK_SERVER_CONCURRENT_DEPTH_TWO_FAN_OUT') or os.environ['MOCK_SERVER_URL'] + '/fixtures/concurrent_depth_two_fan_out'
...
async def test_concurrent_max_pages_exact() -> None:
    ...
    engine = create_engine(engine_config)
    url = os.environ.get('MOCK_SERVER_CONCURRENT_MAX_PAGES_EXACT') or os.environ['MOCK_SERVER_URL'] + '/fixtures/concurrent_max_pages_exact'
...
async def test_concurrent_partial_errors() -> None:
    ...
    engine_config = CrawlConfig(max_concurrent=3, max_depth=1)
    engine = create_engine(engine_config)
    url = os.environ.get('MOCK_SERVER_CONCURRENT_PARTIAL_ERRORS') or os.environ['MOCK_SERVER_URL'] + '/fixtures/concurrent_partial_errors'
...
async def test_concurrent_respects_max_pages() -> None:
    ...
    engine = create_engine(engine_config)
    url = os.environ.get('MOCK_SERVER_CONCURRENT_RESPECTS_MAX_PAGES') or os.environ['MOCK_SERVER_URL'] + '/fixtures/concurrent_respects_max_pages'
