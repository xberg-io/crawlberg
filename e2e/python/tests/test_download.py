...
# alef:hash:7a112963672b807c3f577fe3b6e9c979c005d78678a57eae4180e8951f9a124a
...
async def test_download_basic_pdf() -> None:
    ...
    assert (result["downloaded_document"].mime_type if result["downloaded_document"] else None) == "application/pdf"
