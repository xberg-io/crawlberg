...
# alef:hash:9588e26c28067f4c1daa92a07ac4bebc78a4dd95f4528ee09b0f15bf5e946d5f
...
async def test_validation_ssrf_ipv4_mapped_ipv6_denied() -> None:
    ...
    with pytest.raises(Exception) as exc_info:  # noqa: B017
        ...
        await scrape(engine, url)
    assert "ssrf_policy_violation" in str(exc_info.value) or "ssrf_policy_violation" in type(exc_info.value).__name__  # noqa: S101
