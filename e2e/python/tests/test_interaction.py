...
# alef:hash:7cf566937e893e84710bbee70607d02641ad194f265c74415fa46ef5c5c4c737
...
async def test_interact_execute_js() -> None:
    ...
    result = await interact(engine, url, actions)
    assert result.action_results[0].success is True  # noqa: S101
    assert _alef_e2e_text(result.action_results[0].action_type).lower() == "executeJs".lower()  # noqa: S101
    assert result.action_results[0].data is not None  # noqa: S101
    assert "JS Test Page".lower() in str(result.action_results[0].data).lower()  # noqa: S101
...
async def test_interact_invalid_selector() -> None:
    ...
    assert "find click target".lower() in str(result.action_results[0].error).lower()  # noqa: S101
...
async def test_interact_press_key() -> None:
    ...
    result = await interact(engine, url, actions)
    assert result.action_results[2].success is True  # noqa: S101
    assert result.action_results[2].action_type == "press"  # noqa: S101
    assert result.action_results[2].action_index == 2  # noqa: S101
...
async def test_interact_scrape_default() -> None:
    ...
    result = await interact(engine, url, actions)
    assert result.action_results[0].success is True  # noqa: S101
    assert _alef_e2e_text(result.action_results[0].action_type).lower() == "scrape".lower()  # noqa: S101
...
async def test_interact_screenshot() -> None:
    ...
    result = await interact(engine, url, actions)
    assert result.action_results[0].success is True  # noqa: S101
    assert _alef_e2e_text(result.action_results[0].action_type).lower() == "screenshot".lower()  # noqa: S101
    assert result.action_results[0].data is not None and (
        not hasattr(result.action_results[0].data, "__len__") or len(result.action_results[0].data) > 0
    )  # noqa: S101
...
async def test_interact_scroll_down() -> None:
    ...
    result = await interact(engine, url, actions)
    assert result.action_results[0].success is True  # noqa: S101
    assert _alef_e2e_text(result.action_results[0].action_type).lower() == "scroll".lower()  # noqa: S101
    assert result.action_results[0].action_index == 0  # noqa: S101
...
async def test_interact_type_input() -> None:
    ...
    result = await interact(engine, url, actions)
    assert result.action_results[0].success is True  # noqa: S101
    assert _alef_e2e_text(result.action_results[0].action_type).lower() == "type".lower()  # noqa: S101
    assert result.action_results[0].action_index == 0  # noqa: S101
...
async def test_interact_wait_selector() -> None:
    ...
    result = await interact(engine, url, actions)
    assert result.action_results[0].success is True  # noqa: S101
    assert _alef_e2e_text(result.action_results[0].action_type).lower() == "wait".lower()  # noqa: S101
    assert result.action_results[0].action_index == 0  # noqa: S101
