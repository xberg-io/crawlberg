...
# alef:hash:df723f62940be368eeed1661c3f05a873b78743b515b1a599deff44b64f6f876
...
async def test_interact_action_sequence() -> None:
    ...
    assert result.action_results[0].action_index == 0
    assert _alef_e2e_text(result.action_results[0].action_type).lower() == "click".lower()
    assert result.action_results[0].success is True
    assert result.action_results[1].action_index == 1
    assert result.action_results[1].action_type == "type"
    assert result.action_results[1].success is True
    assert result.action_results[2].action_index == 2
    assert result.action_results[2].action_type == "click"
    assert result.action_results[2].success is True
...
async def test_interact_execute_js() -> None:
    ...
    result = await interact(engine, url, actions)
    assert result.action_results[0].success is True
    assert _alef_e2e_text(result.action_results[0].action_type).lower() == "executeJs".lower()
    assert result.action_results[0].data is not None
    assert "JS Test Page".lower() in str(result.action_results[0].data).lower()
...
async def test_interact_invalid_selector() -> None:
    ...
    assert "find click target".lower() in str(result.action_results[0].error).lower()
...
async def test_interact_max_actions_exceeded() -> None:
    ...
    assert "actions" in str(exc_info.value) or "actions" in type(exc_info.value).__name__
...
async def test_interact_press_key() -> None:
    ...
    result = await interact(engine, url, actions)
    assert result.action_results[2].success is True
    assert result.action_results[2].action_type == "press"
    assert result.action_results[2].action_index == 2
...
async def test_interact_scrape_default() -> None:
    ...
    result = await interact(engine, url, actions)
    assert result.action_results[0].success is True
    assert _alef_e2e_text(result.action_results[0].action_type).lower() == "scrape".lower()
    assert result.action_results[0].data is not None and (
        not hasattr(result.action_results[0].data, "__len__") or len(result.action_results[0].data) > 0
    )
...
async def test_interact_screenshot() -> None:
    ...
    result = await interact(engine, url, actions)
    assert result.action_results[0].success is True
    assert _alef_e2e_text(result.action_results[0].action_type).lower() == "screenshot".lower()
    assert result.action_results[0].data is not None and (
        not hasattr(result.action_results[0].data, "__len__") or len(result.action_results[0].data) > 0
    )
...
async def test_interact_scroll_down() -> None:
    ...
    result = await interact(engine, url, actions)
    assert result.action_results[0].success is True
    assert _alef_e2e_text(result.action_results[0].action_type).lower() == "scroll".lower()
    assert result.action_results[0].action_index == 0
...
async def test_interact_type_input() -> None:
    ...
    result = await interact(engine, url, actions)
    assert result.action_results[0].success is True
    assert _alef_e2e_text(result.action_results[0].action_type).lower() == "type".lower()
    assert result.action_results[0].action_index == 0
...
async def test_interact_wait_selector() -> None:
    ...
    result = await interact(engine, url, actions)
    assert result.action_results[0].success is True
    assert _alef_e2e_text(result.action_results[0].action_type).lower() == "wait".lower()
    assert result.action_results[0].action_index == 0
