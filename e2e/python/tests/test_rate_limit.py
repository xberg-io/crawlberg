...
async def test_rate_limit_basic_delay() -> None:
    ...
    engine = create_engine(engine_config)
    url = os.environ.get('MOCK_SERVER_RATE_LIMIT_BASIC_DELAY') or os.environ['MOCK_SERVER_URL'] + '/fixtures/rate_limit_basic_delay'
...
async def test_rate_limit_per_domain() -> None:
    ...
    engine = create_engine(engine_config)
    url = os.environ.get('MOCK_SERVER_RATE_LIMIT_PER_DOMAIN') or os.environ['MOCK_SERVER_URL'] + '/fixtures/rate_limit_per_domain'
...
async def test_rate_limit_robots_crawl_delay() -> None:
    ...
    engine = create_engine(engine_config)
    url = os.environ.get('MOCK_SERVER_RATE_LIMIT_ROBOTS_CRAWL_DELAY') or os.environ['MOCK_SERVER_URL'] + '/fixtures/rate_limit_robots_crawl_delay'
...
async def test_rate_limit_zero_no_delay() -> None:
    ...
    engine_config = CrawlConfig(max_depth=1)
    engine = create_engine(engine_config)
    url = os.environ.get('MOCK_SERVER_RATE_LIMIT_ZERO_NO_DELAY') or os.environ['MOCK_SERVER_URL'] + '/fixtures/rate_limit_zero_no_delay'
