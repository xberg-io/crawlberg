...
async def test_scrape_asset_dedup() -> None:
    ...
    url = os.environ.get('MOCK_SERVER_SCRAPE_ASSET_DEDUP') or os.environ['MOCK_SERVER_URL'] + '/fixtures/scrape_asset_dedup'
...
async def test_scrape_asset_max_size() -> None:
    ...
    engine = create_engine(engine_config)
    url = os.environ.get('MOCK_SERVER_SCRAPE_ASSET_MAX_SIZE') or os.environ['MOCK_SERVER_URL'] + '/fixtures/scrape_asset_max_size'
...
async def test_scrape_asset_type_filter() -> None:
    ...
    engine = create_engine(engine_config)
    url = os.environ.get('MOCK_SERVER_SCRAPE_ASSET_TYPE_FILTER') or os.environ['MOCK_SERVER_URL'] + '/fixtures/scrape_asset_type_filter'
...
async def test_scrape_download_assets() -> None:
    ...
    engine_config = CrawlConfig(download_assets=True)
    engine = create_engine(engine_config)
    url = os.environ.get('MOCK_SERVER_SCRAPE_DOWNLOAD_ASSETS') or os.environ['MOCK_SERVER_URL'] + '/fixtures/scrape_download_assets'
