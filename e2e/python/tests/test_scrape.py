...
# alef:hash:b83c22892e27fb1a02441af404d88c2b5b4776fdf9496b28c9418e89c8a34066
...
async def test_scrape_json_ld() -> None:
    ...
    assert result.json_ld[0].schema_type == "Recipe"
...
async def test_scrape_malformed_html() -> None:
    ...
    assert "Malformed Page" in result.metadata.title
    assert not result.metadata.description
