...
# alef:hash:7c9ed4e2792192f4184de03e5f28c25d57766e65826520e5537ee71a9ceaab51
...
async def test_batch_crawl_stream_partial_failure() -> None:
    ...
    async for chunk in result:
        chunks.append(chunk)
    # skipped: streaming field 'stream.has_page_event': no python accessor
    # skipped: streaming field 'stream.has_error_event': no python accessor
    # skipped: streaming field 'stream.has_complete_event': no python accessor
    assert chunks is not None  # noqa: S101
