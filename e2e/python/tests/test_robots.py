...
async def test_robots_allow_all() -> None:
    ...
    url = os.environ.get('MOCK_SERVER_ROBOTS_ALLOW_ALL') or os.environ['MOCK_SERVER_URL'] + '/fixtures/robots_allow_all'
...
async def test_robots_allow_override() -> None:
    ...
    engine_config = CrawlConfig(respect_robots_txt=True)
    engine = create_engine(engine_config)
    url = os.environ.get('MOCK_SERVER_ROBOTS_ALLOW_OVERRIDE') or os.environ['MOCK_SERVER_URL'] + '/fixtures/robots_allow_override'
...
async def test_robots_comments_handling() -> None:
    ...
    engine = create_engine(engine_config)
    url = os.environ.get('MOCK_SERVER_ROBOTS_COMMENTS_HANDLING') or os.environ['MOCK_SERVER_URL'] + '/fixtures/robots_comments_handling'
...
async def test_robots_crawl_delay() -> None:
    ...
    engine_config = CrawlConfig(respect_robots_txt=True, user_agent="crawlberg")
    engine = create_engine(engine_config)
    url = os.environ.get('MOCK_SERVER_ROBOTS_CRAWL_DELAY') or os.environ['MOCK_SERVER_URL'] + '/fixtures/robots_crawl_delay'
...
async def test_robots_disallow_path() -> None:
    ...
    engine_config = CrawlConfig(respect_robots_txt=True)
    engine = create_engine(engine_config)
    url = os.environ.get('MOCK_SERVER_ROBOTS_DISALLOW_PATH') or os.environ['MOCK_SERVER_URL'] + '/fixtures/robots_disallow_path'
...
async def test_robots_meta_nofollow() -> None:
    ...
    engine_config = CrawlConfig(respect_robots_txt=True)
    engine = create_engine(engine_config)
    url = os.environ.get('MOCK_SERVER_ROBOTS_META_NOFOLLOW') or os.environ['MOCK_SERVER_URL'] + '/fixtures/robots_meta_nofollow'
...
async def test_robots_meta_noindex() -> None:
    ...
    engine_config = CrawlConfig(respect_robots_txt=True)
    engine = create_engine(engine_config)
    url = os.environ.get('MOCK_SERVER_ROBOTS_META_NOINDEX') or os.environ['MOCK_SERVER_URL'] + '/fixtures/robots_meta_noindex'
...
async def test_robots_missing_404() -> None:
    ...
    engine_config = CrawlConfig(respect_robots_txt=True)
    engine = create_engine(engine_config)
    url = os.environ.get('MOCK_SERVER_ROBOTS_MISSING_404') or os.environ['MOCK_SERVER_URL'] + '/fixtures/robots_missing_404'
...
async def test_robots_multiple_user_agents() -> None:
    ...
    engine = create_engine(engine_config)
    url = os.environ.get('MOCK_SERVER_ROBOTS_MULTIPLE_USER_AGENTS') or os.environ['MOCK_SERVER_URL'] + '/fixtures/robots_multiple_user_agents'
...
async def test_robots_request_rate() -> None:
    ...
    engine_config = CrawlConfig(respect_robots_txt=True, user_agent="crawlberg")
    engine = create_engine(engine_config)
    url = os.environ.get('MOCK_SERVER_ROBOTS_REQUEST_RATE') or os.environ['MOCK_SERVER_URL'] + '/fixtures/robots_request_rate'
...
async def test_robots_sitemap_directive() -> None:
    ...
    engine_config = CrawlConfig(respect_robots_txt=True)
    engine = create_engine(engine_config)
    url = os.environ.get('MOCK_SERVER_ROBOTS_SITEMAP_DIRECTIVE') or os.environ['MOCK_SERVER_URL'] + '/fixtures/robots_sitemap_directive'
...
async def test_robots_user_agent_specific() -> None:
    ...
    engine = create_engine(engine_config)
    url = os.environ.get('MOCK_SERVER_ROBOTS_USER_AGENT_SPECIFIC') or os.environ['MOCK_SERVER_URL'] + '/fixtures/robots_user_agent_specific'
...
async def test_robots_wildcard_paths() -> None:
    ...
    engine_config = CrawlConfig(respect_robots_txt=True)
    engine = create_engine(engine_config)
    url = os.environ.get('MOCK_SERVER_ROBOTS_WILDCARD_PATHS') or os.environ['MOCK_SERVER_URL'] + '/fixtures/robots_wildcard_paths'
...
async def test_robots_x_robots_tag() -> None:
    ...
    engine_config = CrawlConfig(respect_robots_txt=True)
    engine = create_engine(engine_config)
    url = os.environ.get('MOCK_SERVER_ROBOTS_X_ROBOTS_TAG') or os.environ['MOCK_SERVER_URL'] + '/fixtures/robots_x_robots_tag'
