...
async def test_cache_etag_conditional() -> None:
    ...
    url = os.environ.get('MOCK_SERVER_CACHE_ETAG_CONDITIONAL') or os.environ['MOCK_SERVER_URL'] + '/fixtures/cache_etag_conditional'
...
async def test_cache_last_modified() -> None:
    ...
    engine_config = CrawlConfig(max_depth=1)
    engine = create_engine(engine_config)
    url = os.environ.get('MOCK_SERVER_CACHE_LAST_MODIFIED') or os.environ['MOCK_SERVER_URL'] + '/fixtures/cache_last_modified'
...
async def test_cache_miss_fresh_fetch() -> None:
    ...
    engine_config = CrawlConfig(max_depth=1)
    engine = create_engine(engine_config)
    url = os.environ.get('MOCK_SERVER_CACHE_MISS_FRESH_FETCH') or os.environ['MOCK_SERVER_URL'] + '/fixtures/cache_miss_fresh_fetch'
