...
# alef:hash:237ef7a2dcaa2cb7ac2cdbdc5c26566e4dc39d69cd894af7b7262b1e41cd41be
...
def _make_request(method: str, path: str, **kwargs: object) -> object:
    ...
    if data is not None:
        ...
        req = urllib.request.Request(url, data=body, headers=headers, method=method.upper())  # noqa: S310
    else:
        headers = dict(kwargs.pop("headers", {}))
        req = urllib.request.Request(url, headers=headers, method=method.upper())  # noqa: S310
    try:
