...
# alef:hash:adcf43fb37b66c891b88198ce106eacb8d582266cc5ea2176cd86f0650aa85e8
...
test_robots_crawl_disallow_blocks_child() {
  ...
  local output
  output=$(crawlberg crawl "${MOCK_SERVER_ROBOTS_CRAWL_DISALLOW_BLOCKS_CHILD:-${MOCK_SERVER_URL}/fixtures/robots_crawl_disallow_blocks_child}" --config '{"max_depth":1,"respect_robots_txt":true}' --format json --browser-mode never)
...
test_robots_crawl_unreachable_5xx() {
  ...
  local output
  output=$(crawlberg crawl "${MOCK_SERVER_ROBOTS_CRAWL_UNREACHABLE_5XX:-${MOCK_SERVER_URL}/fixtures/robots_crawl_unreachable_5xx}" --config '{"max_depth":1,"respect_robots_txt":true}' --format json --browser-mode never)
  ...
  assert_contains "$val_error" 'robots_unreachable' 'error'
}
...
test_robots_unreachable_5xx() {
  ...
  local output
  output=$(crawlberg scrape "${MOCK_SERVER_ROBOTS_UNREACHABLE_5XX:-${MOCK_SERVER_URL}/fixtures/robots_unreachable_5xx}" --config '{"respect_robots_txt":true}' --format json --browser-mode never)
...
run_tests_robots() {
  ...
  run_test test_robots_crawl_disallow_blocks_child
  run_test test_robots_crawl_unreachable_5xx
  ...
  run_test test_robots_unreachable_5xx
