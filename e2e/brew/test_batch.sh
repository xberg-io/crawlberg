...
# alef:hash:da87d70dff30316b85e41e642154d49b2afc95bbc8c218d185bed9784f7df33f
...
test_batch_scrape_empty_urls_error() {
  ...
  if output=$(crawlberg batch-scrape --config '{}' --format json --browser-mode never 2>&1); then
