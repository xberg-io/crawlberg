...
# alef:hash:ddef61f673273deff956e7c7b0c04fea17382261c3aad75dc856dbf802ee6b46
...
test_error_unsupported_scheme() {
  ...
  if crawlberg scrape 'gopher://invalid.example.com/' --config '{}' --format json --browser-mode never >/dev/null 2>&1; then
    echo 'FAIL [error]: expected command to fail but it succeeded' >&2
    return 1
  fi
  # skipped: assertion type 'error' has no accessor for error field <none> in this backend
