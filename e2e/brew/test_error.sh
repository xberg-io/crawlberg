...
# alef:hash:beed8fa6051d22f48aa073c427773481ed1a1a646b3ffe65986d8a5c5dcfca65
...
test_error_empty_batch_urls() {
  ...
  if ! grep -qF 'urls' <<<"$output"; then
    echo 'FAIL [error]: expected output to contain ''urls' >&2
    return 1
  fi
}
