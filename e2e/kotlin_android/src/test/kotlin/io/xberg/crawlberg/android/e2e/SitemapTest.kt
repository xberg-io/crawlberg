...
// alef:hash:aa02f0ecf6b39be0932d79fb524e26086c5e86fb0b4cb8e77e12ef290e54f562
...
class SitemapTest {
    ...
    @Test
    fun testSitemapBasic(): Unit = runBlocking {
    ...
    @Test
    fun testSitemapCompressedGzip(): Unit = runBlocking {
    ...
    @Test
    fun testSitemapEmpty(): Unit = runBlocking {
    ...
    @Test
    fun testSitemapFromRobotsTxt(): Unit = runBlocking {
    ...
    @Test
    fun testSitemapIndex(): Unit = runBlocking {
    ...
    @Test
    fun testSitemapLastmodFilter(): Unit = runBlocking {
    ...
    @Test
    fun testSitemapOnlyMode(): Unit = runBlocking {
    ...
    @Test
    fun testSitemapXhtmlLinks(): Unit = runBlocking {
