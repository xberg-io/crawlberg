...
The plugin version tracks the crawlberg core release (`Cargo.toml`). See [CHANGELOG.md](../CHANGELOG.md) for release notes.
...
- **Marketplace**: this repo — `/plugin marketplace add xberg-io/crawlberg`
